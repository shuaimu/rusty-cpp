...
namespace minmax {
    ...
    template<typename I, typename K, typename F, typename L>
    MinMaxResult<rusty::detail::associated_item_t<I>> minmax_impl(I it, F key_for, L lt) {
        auto [min, max, min_key, max_key] = rusty::detail::deref_if_pointer_like([&]() { auto&& _m = it.next(); if (_m.is_none()) { return MinMaxResult<rusty::detail::associated_item_t<I>>{MinMaxResult_NoElements<rusty::detail::associated_item_t<I>>{}}; } if (_m.is_some()) { auto&& _mv1 = _m.unwrap(); auto&& x = rusty::detail::deref_if_pointer(_mv1); return [&]() { auto&& _m = it.next(); if (_m.is_none()) { return MinMaxResult<rusty::detail::associated_item_t<I>>{MinMaxResult_OneElement<rusty::detail::associated_item_t<I>>{std::move(x)}}; } if (_m.is_some()) { auto&& _mv1 = _m.unwrap(); auto&& y = rusty::detail::deref_if_pointer(_mv1); return [&]() { auto xk = key_for(x);
auto yk = key_for(y);
return (!lt(y, x, yk, xk) ? std::make_tuple(std::move(x), std::move(y), std::move(xk), std::move(yk)) : std::make_tuple(std::move(y), std::move(x), std::move(yk), std::move(xk))); }(); } rusty::intrinsics::unreachable(); }(); } rusty::intrinsics::unreachable(); }());
        while (true) {
            auto&& _m = it.next();
...
return [&]() { auto&& _m = b.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { auto&& _mv1 = _m.unwrap(); auto&& x = rusty::detail::deref_if_pointer(_mv1); return [&]() { rusty::detail::deref_if_pointer_like(a_cur) = rusty::Some(a.next());
return x; }(); } rusty::intrinsics::unreachable(); }(); }(); } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
...
namespace multipeek_impl {
    ...
    struct MultiPeek {
        ...
        auto peek() {
            auto ret = (this->index < rusty::len(this->buf) ? rusty::SomeRef(this->buf[this->index]) : [&]() { auto&& _m = this->iter.next(); if (_m.is_some()) { auto&& _mv0 = _m.unwrap(); auto&& x = rusty::detail::deref_if_pointer(_mv0); return [&]() { this->buf.push_back(std::move(x));
return rusty::SomeRef(this->buf[this->index]); }(); } if (_m.is_none()) { return rusty::Option<const rusty::detail::associated_item_t<I>&>(rusty::None); } rusty::intrinsics::unreachable(); }());
...
namespace ziptuple {
    ...
    struct Zip {
        ...
        auto next() {
            ...
            auto A_shadow2 = [&]() { auto&& _m = A_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
        ...
        auto next() {
            ...
            auto A_shadow2 = [&]() { auto&& _m = A_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
            auto B_shadow2 = [&]() { auto&& _m = B_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
        ...
        auto next() {
            ...
            auto A_shadow2 = [&]() { auto&& _m = A_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
            auto B_shadow2 = [&]() { auto&& _m = B_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
            auto C_shadow2 = [&]() { auto&& _m = C_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
        ...
        auto next() {
            ...
            auto B_shadow2 = [&]() { auto&& _m = B_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
            auto C_shadow2 = [&]() { auto&& _m = C_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
            auto D_shadow2 = [&]() { auto&& _m = D_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
        ...
        auto next() {
            ...
            auto C_shadow2 = [&]() { auto&& _m = C_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
            auto D_shadow2 = [&]() { auto&& _m = D_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
            auto E_shadow2 = [&]() { auto&& _m = E_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
        ...
        auto next() {
            ...
            auto D_shadow2 = [&]() { auto&& _m = D_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
            auto E_shadow2 = [&]() { auto&& _m = E_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
            auto F_shadow2 = [&]() { auto&& _m = F_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
        ...
        auto next() {
            ...
            auto E_shadow2 = [&]() { auto&& _m = E_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
            auto F_shadow2 = [&]() { auto&& _m = F_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
            auto G_shadow2 = [&]() { auto&& _m = G_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
        ...
        auto next() {
            ...
            auto F_shadow2 = [&]() { auto&& _m = F_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
            auto G_shadow2 = [&]() { auto&& _m = G_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
            auto H_shadow2 = [&]() { auto&& _m = H_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
        ...
        auto next() {
            ...
            auto G_shadow2 = [&]() { auto&& _m = G_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
            auto H_shadow2 = [&]() { auto&& _m = H_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
            auto I_shadow2 = [&]() { auto&& _m = I_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
        ...
        auto next() {
            ...
            auto H_shadow2 = [&]() { auto&& _m = H_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
            auto I_shadow2 = [&]() { auto&& _m = I_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
            auto J_shadow2 = [&]() { auto&& _m = J_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
        ...
        auto next() {
            ...
            auto I_shadow2 = [&]() { auto&& _m = I_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
            auto J_shadow2 = [&]() { auto&& _m = J_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
            auto K_shadow2 = [&]() { auto&& _m = K_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
        ...
        auto next() {
            ...
            auto J_shadow2 = [&]() { auto&& _m = J_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
            auto K_shadow2 = [&]() { auto&& _m = K_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
            auto L_shadow2 = [&]() { auto&& _m = L_shadow1.next(); if (_m.is_none()) { return rusty::None; } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
