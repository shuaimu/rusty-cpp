...
export module itertools;
import rusty;

namespace adaptors {}
namespace adaptors::coalesce_tests {}
namespace adaptors::map {}
namespace adaptors::multi_product {}
...
namespace iter_index::private_iter_index {}
...
export using diff::Diff;
export using minmax::MinMaxResult;
export using with_position::Position;
export using either_or_both::EitherOrBoth;
template<typename T>
using VecDequeIntoIter = decltype(rusty::iter(std::declval<rusty::VecDeque<T>>()));
template<typename T>
using VecIntoIter = decltype(rusty::iter(std::declval<rusty::Vec<T>>()));
template<typename I, typename J>
export bool equal(I a, J b);
template<typename I, typename J>
export void assert_equal(I a, J b);
template<typename A, typename I, typename F>
export size_t partition(I iter, F pred);
...
// Rust-only: using __std_iter = std::iter;
...
export using concat_impl::concat;

export using cons_tuples_impl::cons_tuples;

export using diff::diff_with;
...
// Rust-only: using peeking_take_while::PeekingNext;

export using process_results_impl::process_results;

export using repeatn::repeat_n;

export using sources::iterate;
export using sources::unfold;

namespace structs {}
using namespace ::structs;

export using unziptuple::multiunzip;
// Rust-only: using unziptuple::MultiUnzip;

export using with_position::Position;

export using ziptuple::multizip;
...
namespace iter_index {
    ...
    // Rust-only: using std::iter::Skip;
    // Rust-only: using std::iter::Take;

    // Rust-only: using std::ops::Range;
    // Rust-only: using std::ops::RangeFrom;
    // Rust-only: using std::ops::RangeFull;
    // Rust-only: using std::ops::RangeInclusive;
    // Rust-only: using std::ops::RangeTo;
    // Rust-only: using std::ops::RangeToInclusive;
...
return value;
    ...
    export using ::adaptors::map::map_into;
    export using ::adaptors::map::map_ok;
    export using ::adaptors::map::MapInto;
    export using ::adaptors::map::MapOk;

    using namespace ::adaptors::multi_product;

    namespace fmt = rusty::fmt;

    // Rust-only: using std::iter::Enumerate;
    // Rust-only: using std::iter::FromIterator;
    // Rust-only: using std::iter::Fuse;
    // Rust-only: using std::iter::FusedIterator;
...
namespace cons_tuples_impl {
    ...
    // Rust-only: using adaptors::map::MapSpecialCaseFn;
...
namespace exactly_one_err {
    ...
    // Rust-only: using std::iter::ExactSizeIterator;
...
namespace flatten_ok {
    ...
    namespace fmt = rusty::fmt;
    // Rust-only: using std::iter::DoubleEndedIterator;
    // Rust-only: using std::iter::FusedIterator;
...
namespace grouping_map {
    ...
    // Rust-only: using std::iter::Iterator;

    // Rust-only: using std::ops::Add;
    // Rust-only: using std::ops::Mul;
...
namespace tuple_impl {
    ...
    // Rust-only: using std::iter::Cycle;
...
namespace traits {
    ...
    // Rust-only: using iter_index::IteratorIndex;

    // Rust-only: using tuple_impl::HomogeneousTuple;
...
namespace unique_impl {
    ...
    // Rust-only: using std::collections::hash_map::Entry;
...
namespace zip_longest {
    ...
    // Rust-only: using std::cmp::Ordering::Equal;
    // Rust-only: using std::cmp::Ordering::Greater;
    // Rust-only: using std::cmp::Ordering::Less;
...
namespace structs {
    ...
    export using adaptors::multi_product::MultiProduct;

    export using adaptors::Batching;
    export using adaptors::coalesce_tests::Coalesce;
    export using adaptors::coalesce_tests::Dedup;
    export using adaptors::coalesce_tests::DedupBy;
    export using adaptors::coalesce_tests::DedupByWithCount;
    export using adaptors::coalesce_tests::DedupWithCount;
    export using adaptors::FilterMapOk;
    export using adaptors::FilterOk;
    export using adaptors::Interleave;
    export using adaptors::InterleaveShortest;
    export using adaptors::map::MapInto;
    export using adaptors::map::MapOk;
    export using adaptors::Positions;
    export using adaptors::Product;
    export using adaptors::PutBack;
    export using adaptors::TakeWhileRef;
    export using adaptors::TupleCombinations;
    export using adaptors::Update;
    export using adaptors::WhileSome;

    export using combinations::ArrayCombinations;
    export using combinations::Combinations;

    export using combinations_with_replacement::CombinationsWithReplacement;

    export using cons_tuples_impl::ConsTuples;

    export using duplicates_impl::Duplicates;
    export using duplicates_impl::DuplicatesBy;

    export using exactly_one_err::ExactlyOneError;

    export using flatten_ok::FlattenOk;

    export using format::Format;
    export using format::FormatWith;

    export using groupbylazy::GroupBy;

    export using groupbylazy::Chunk;
    export using groupbylazy::ChunkBy;
    export using groupbylazy::Chunks;
    export using groupbylazy::Group;
    export using groupbylazy::Groups;
    export using groupbylazy::IntoChunks;

    export using grouping_map::GroupingMap;
    export using grouping_map::GroupingMapBy;

    export using intersperse_tests::Intersperse;
    export using intersperse_tests::IntersperseWith;

    export using kmerge_impl::KMerge;
    export using kmerge_impl::KMergeBy;

    export using merge_join::Merge;
    export using merge_join::MergeBy;
    export using merge_join::MergeJoinBy;

    export using multipeek_impl::MultiPeek;

    export using pad_tail::PadUsing;

    export using peek_nth::PeekNth;

    export using peeking_take_while::PeekingTakeWhile;

    export using permutations::Permutations;

    export using powerset::Powerset;

    export using process_results_impl::ProcessResults;

    export using put_back_n_impl::PutBackN;

    export using rciter_impl::RcIter;

    export using repeatn::RepeatN;

    export using sources::Iterate;
    export using sources::Unfold;

    export using take_while_inclusive::TakeWhileInclusive;

    export using tee::Tee;

    export using tuple_impl::CircularTupleWindows;
    export using tuple_impl::TupleBuffer;
    export using tuple_impl::TupleWindows;
    export using tuple_impl::Tuples;

    export using unique_impl::Unique;
    export using unique_impl::UniqueBy;

    export using with_position::WithPosition;

    export using zip_eq_impl::ZipEq;

    export using zip_longest::ZipLongest;

    export using ziptuple::Zip;
...
namespace free_mod {
    ...
    // Rust-only: using Itertools;

    export using adaptors::interleave;
    export using adaptors::put_back;

    export using kmerge_impl::kmerge;

    export using merge_join::merge;
    export using merge_join::merge_join_by;

    export using multipeek_impl::multipeek;

    export using peek_nth::peek_nth;

    export using put_back_n_impl::put_back_n;

    export using rciter_impl::rciter;

    export using zip_eq_impl::zip_eq;
