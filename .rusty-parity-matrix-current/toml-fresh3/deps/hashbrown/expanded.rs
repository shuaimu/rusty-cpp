...
mod map {
    ...
    impl<K, V, A, const N: usize> From<[(K, V); N]>
    for HashMap<K, V, DefaultHashBuilder, A>
    where
        K: Eq + Hash,
        A: Default + Allocator,
    {
...
mod raw_entry {
    ...
    impl<K: Debug, V: Debug, S, A: Allocator> Debug
