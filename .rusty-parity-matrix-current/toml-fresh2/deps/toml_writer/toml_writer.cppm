...
namespace key {
    ...
    namespace rusty_ext {
        ...
        rusty::fmt::Result write_toml_key(const std::string_view& self_, W& writer) {
            using Self = std::remove_reference_t<decltype(self_)>;
            return ::key::rusty_ext::write_toml_key(::TomlKeyBuilder::new_(std::string_view(self_)).as_default(), rusty::detail::deref_if_pointer_like(writer));
        }
...
namespace value {
    ...
    namespace rusty_ext {
        ...
        rusty::fmt::Result write_toml_value(const std::string_view& self_, W& writer) {
            using Self = std::remove_reference_t<decltype(self_)>;
            return ::value::rusty_ext::write_toml_value(::TomlStringBuilder::new_(std::string_view(self_)).as_default(), rusty::detail::deref_if_pointer_like(writer));
        }
...
namespace integer {
    ...
    struct Radix : std::variant<Radix_Decimal, Radix_Hexadecimal, Radix_Octal, Radix_Binary> {
        ...
        static Radix Hexadecimal(HexCase case_) { return Radix{Radix_Hexadecimal{.case_ = std::forward<HexCase>(case_)}}; }
    ...
    struct TomlInteger {
        ...
        rusty::fmt::Result fmt(rusty::fmt::Formatter& f) const {
            return rusty::fmt::Formatter::debug_struct_field2_finish(f, "TomlInteger", "value", &this->value, "format", &this->format);
        }
        static TomlInteger<N> new_(N value) {
            return TomlInteger<N>{.value = std::move(value), .format = TomlIntegerFormat::new_()};
        }
        template<typename W>
        rusty::fmt::Result write_toml_value(W& writer) const {
