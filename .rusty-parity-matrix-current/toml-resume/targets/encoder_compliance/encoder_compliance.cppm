...
export module encoder_compliance;
import rusty;
...
namespace decoder {
    ...
    struct Decoder;
    rusty::Result<toml_test_harness::DecodedValue, toml_test_harness::Error> value_to_decoded(const Value& value);
    rusty::Result<toml_test_harness::DecodedValue, toml_test_harness::Error> table_to_decoded(const value::Table& value);

    struct Decoder {

        Decoder clone() const;
        std::string_view name() const;
        rusty::Result<toml_test_harness::DecodedValue, toml_test_harness::Error> decode(std::span<const uint8_t> data) const;
    };
...
namespace encoder {
    ...
    struct Encoder;
    struct EncoderPretty;
    rusty::Result<Value, toml_test_harness::Error> from_decoded(const toml_test_harness::DecodedValue& decoded);
    rusty::Result<Value, toml_test_harness::Error> from_decoded_scalar(const toml_test_harness::DecodedScalar& decoded);
    rusty::Result<value::Table, toml_test_harness::Error> from_table(const rusty::HashMap<rusty::String, toml_test_harness::DecodedValue>& decoded);
    rusty::Result<value::Array, toml_test_harness::Error> from_array(std::span<const toml_test_harness::DecodedValue> decoded);

    struct Encoder {

        Encoder clone() const;
        std::string_view name() const;
        rusty::Result<rusty::String, toml_test_harness::Error> encode(toml_test_harness::DecodedValue data) const;
    };

    struct EncoderPretty {

        EncoderPretty clone() const;
        std::string_view name() const;
        rusty::Result<rusty::String, toml_test_harness::Error> encode(toml_test_harness::DecodedValue data) const;
    };
...
void main() {
    const auto valid_ext = rusty::collect_range(rusty::map(rusty::filter(rusty::map(rusty::iter(walkdir::WalkDir::new_("tests/fixtures/valid").sort_by_file_name()), Result::unwrap), [&](auto&& e) { return e.path().extension() == rusty::Some(rusty::ffi::OsStr::new_("toml")); }), [&](auto&& e) {
auto name = rusty::to_owned(rusty::str_runtime::strip_prefix(e.path(), "tests/fixtures").unwrap());
auto fixture = std::fs::read(e.path()).unwrap();
const auto expected_path = e.path().with_extension("json");
auto expected = std::fs::read(std::move(expected_path)).unwrap();
return toml_test_data::Valid{.name = std::move(name), .fixture = std::move(fixture), .expected = std::move(expected)};
}));
    const auto encoder_shadow1 = ::encoder::Encoder{};
    const auto decoder_shadow1 = ::decoder::Decoder{};
    auto harness = toml_test_harness::EncoderHarness::new_(std::move(encoder_shadow1), std::move(decoder_shadow1));
    harness.version("1.1.0");
    harness.extend_valid(std::move(valid_ext));
    harness.test();
}
...
namespace decoder {
    ...
    rusty::Result<toml_test_harness::DecodedValue, toml_test_harness::Error> value_to_decoded(const Value& value) {
        return [&]() -> rusty::Result<toml_test_harness::DecodedValue, toml_test_harness::Error> { auto&& _m = value; if (std::holds_alternative<Value_Integer>(rusty::detail::deref_if_pointer(_m))) { auto&& v = rusty::detail::deref_if_pointer(std::get<Value_Integer>(rusty::detail::deref_if_pointer(_m))._0); return rusty::Result<toml_test_harness::DecodedValue, toml_test_harness::Error>::Ok(toml_test_harness::DecodedValue::Scalar(toml_test_harness::DecodedScalar::from(rusty::detail::deref_if_pointer_like(v)))); } if (std::holds_alternative<Value_String>(rusty::detail::deref_if_pointer(_m))) { auto&& v = rusty::detail::deref_if_pointer(std::get<Value_String>(rusty::detail::deref_if_pointer(_m))._0); return rusty::Result<toml_test_harness::DecodedValue, toml_test_harness::Error>::Ok(toml_test_harness::DecodedValue::Scalar(toml_test_harness::DecodedScalar::from(v))); } if (std::holds_alternative<Value_Float>(rusty::detail::deref_if_pointer(_m))) { auto&& v = rusty::detail::deref_if_pointer(std::get<Value_Float>(rusty::detail::deref_if_pointer(_m))._0); return rusty::Result<toml_test_harness::DecodedValue, toml_test_harness::Error>::Ok(toml_test_harness::DecodedValue::Scalar(toml_test_harness::DecodedScalar::from(rusty::detail::deref_if_pointer_like(v)))); } if (std::holds_alternative<Value_Datetime>(rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_m)))) { auto v = rusty::detail::deref_if_pointer(std::get<Value_Datetime>(rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_m)))._0); return [&]() -> rusty::Result<toml_test_harness::DecodedValue, toml_test_harness::Error> { if (v.time.is_some()) {
    decltype(auto) time = v.time.unwrap();
    if (time.second.is_none()) {
        time.second = rusty::Option<int32_t>(0);
    }
    if (time.nanosecond.is_none()) {
        time.nanosecond = rusty::Option<int32_t>(0);
    }
}
auto value_shadow1 = rusty::String::from(rusty::to_string(v));
auto value_shadow2 = [&]() { auto&& _m0 = v.date.is_some(); auto&& _m1 = v.time.is_some(); auto&& _m2 = v.offset.is_some(); if (_m0 == true && _m1 == true && _m2 == true) { return toml_test_harness::DecodedScalar::Datetime(std::move(value_shadow1)); } if (_m0 == true && _m1 == true && _m2 == false) { return toml_test_harness::DecodedScalar::DatetimeLocal(std::move(value_shadow1)); } if (_m0 == true && _m1 == false && _m2 == false) { return toml_test_harness::DecodedScalar::DateLocal(std::move(value_shadow1)); } if (_m0 == false && _m1 == true && _m2 == false) { return toml_test_harness::DecodedScalar::TimeLocal(std::move(value_shadow1)); } if (true) { [&]() { [&]() -> rusty::Result<toml_test_harness::DecodedValue, toml_test_harness::Error> { rusty::panicking::panic_fmt(std::format("internal error: entered unreachable code: {0}", rusty::to_string(std::string("Unsupported case")))); }(); }(); } rusty::intrinsics::unreachable(); }();
return rusty::Result<toml_test_harness::DecodedValue, toml_test_harness::Error>::Ok(toml_test_harness::DecodedValue::Scalar(std::move(value_shadow2))); }(); } if (std::holds_alternative<Value_Boolean>(rusty::detail::deref_if_pointer(_m))) { auto&& v = rusty::detail::deref_if_pointer(std::get<Value_Boolean>(rusty::detail::deref_if_pointer(_m))._0); return rusty::Result<toml_test_harness::DecodedValue, toml_test_harness::Error>::Ok(toml_test_harness::DecodedValue::Scalar(toml_test_harness::DecodedScalar::from(rusty::detail::deref_if_pointer_like(v)))); } if (std::holds_alternative<Value_Array>(rusty::detail::deref_if_pointer(_m))) { auto&& v = rusty::detail::deref_if_pointer(std::get<Value_Array>(rusty::detail::deref_if_pointer(_m))._0); return [&]() -> rusty::Result<toml_test_harness::DecodedValue, toml_test_harness::Error> { const auto v_shadow1 = rusty::collect_range(rusty::map(rusty::iter(v), [&](auto&&... _args) -> decltype(auto) { return value_to_decoded(std::forward<decltype(_args)>(_args)...); }));
return rusty::Result<toml_test_harness::DecodedValue, toml_test_harness::Error>::Ok(toml_test_harness::DecodedValue::Array(RUSTY_TRY_INTO(v_shadow1, rusty::Result<toml_test_harness::DecodedValue, toml_test_harness::Error>))); }(); } if (std::holds_alternative<Value_Table>(rusty::detail::deref_if_pointer(_m))) { auto&& v = rusty::detail::deref_if_pointer(std::get<Value_Table>(rusty::detail::deref_if_pointer(_m))._0); return table_to_decoded(v); } return [&]() -> rusty::Result<toml_test_harness::DecodedValue, toml_test_harness::Error> { rusty::intrinsics::unreachable(); }(); }();
    }

    rusty::Result<toml_test_harness::DecodedValue, toml_test_harness::Error> table_to_decoded(const value::Table& value) {
        const auto table = rusty::collect_range(rusty::map(rusty::iter(value), [&](auto&& _destruct_param0) {
...
auto k_shadow1 = rusty::to_owned(std::move(k));
auto v_shadow1 = RUSTY_TRY(value_to_decoded(std::move(v)));
return rusty::Ok(std::make_tuple(std::move(k_shadow1), std::move(v_shadow1)));
}));
        return rusty::Result<toml_test_harness::DecodedValue, toml_test_harness::Error>::Ok(toml_test_harness::DecodedValue::Table(RUSTY_TRY_INTO(table, rusty::Result<toml_test_harness::DecodedValue, toml_test_harness::Error>)));
    }
...
namespace encoder {
    ...
    rusty::Result<Value, toml_test_harness::Error> from_decoded(const toml_test_harness::DecodedValue& decoded) {
        auto value = [&]() { auto&& _m = decoded; if (std::holds_alternative<toml_test_harness::DecodedValue_Scalar>(rusty::detail::deref_if_pointer(_m))) { auto&& value = rusty::detail::deref_if_pointer(std::get<toml_test_harness::DecodedValue_Scalar>(rusty::detail::deref_if_pointer(_m))._0); return RUSTY_TRY_INTO(from_decoded_scalar(value), rusty::Result<Value, toml_test_harness::Error>); } if (std::holds_alternative<toml_test_harness::DecodedValue_Table>(rusty::detail::deref_if_pointer(_m))) { auto&& value = rusty::detail::deref_if_pointer(std::get<toml_test_harness::DecodedValue_Table>(rusty::detail::deref_if_pointer(_m))._0); return Value::Table(RUSTY_TRY_INTO(from_table(value), rusty::Result<Value, toml_test_harness::Error>)); } if (std::holds_alternative<toml_test_harness::DecodedValue_Array>(rusty::detail::deref_if_pointer(_m))) { auto&& value = rusty::detail::deref_if_pointer(std::get<toml_test_harness::DecodedValue_Array>(rusty::detail::deref_if_pointer(_m))._0); return Value::Array(RUSTY_TRY_INTO(from_array(value), rusty::Result<Value, toml_test_harness::Error>)); } rusty::intrinsics::unreachable(); }();
        return rusty::Result<Value, toml_test_harness::Error>::Ok(std::move(value));
    }

    rusty::Result<Value, toml_test_harness::Error> from_decoded_scalar(const toml_test_harness::DecodedScalar& decoded) {
        return [&]() -> rusty::Result<Value, toml_test_harness::Error> { auto&& _m = decoded; if (std::holds_alternative<toml_test_harness::DecodedScalar_String>(rusty::detail::deref_if_pointer(_m))) { auto&& value = rusty::detail::deref_if_pointer(std::get<toml_test_harness::DecodedScalar_String>(rusty::detail::deref_if_pointer(_m))._0); return rusty::Result<Value, toml_test_harness::Error>::Ok(Value::String(rusty::clone(value))); } if (std::holds_alternative<toml_test_harness::DecodedScalar_Integer>(rusty::detail::deref_if_pointer(_m))) { auto&& value = rusty::detail::deref_if_pointer(std::get<toml_test_harness::DecodedScalar_Integer>(rusty::detail::deref_if_pointer(_m))._0); return rusty::str_runtime::parse<int64_t>(value).map_err(toml_test_harness::Error::new_).map([&](auto&& _v) -> Value { return Value::Integer(std::forward<decltype(_v)>(_v)); }); } if (std::holds_alternative<toml_test_harness::DecodedScalar_Float>(rusty::detail::deref_if_pointer(_m))) { auto&& value = rusty::detail::deref_if_pointer(std::get<toml_test_harness::DecodedScalar_Float>(rusty::detail::deref_if_pointer(_m))._0); return rusty::str_runtime::parse<double>(value).map_err(toml_test_harness::Error::new_).map([&](auto&& _v) -> Value { return Value::Float(std::forward<decltype(_v)>(_v)); }); } if (std::holds_alternative<toml_test_harness::DecodedScalar_Bool>(rusty::detail::deref_if_pointer(_m))) { auto&& value = rusty::detail::deref_if_pointer(std::get<toml_test_harness::DecodedScalar_Bool>(rusty::detail::deref_if_pointer(_m))._0); return rusty::str_runtime::parse<bool>(value).map_err(toml_test_harness::Error::new_).map([&](auto&& _v) -> Value { return Value::Boolean(std::forward<decltype(_v)>(_v)); }); } if (std::holds_alternative<toml_test_harness::DecodedScalar_Datetime>(rusty::detail::deref_if_pointer(_m))) { auto&& value = rusty::detail::deref_if_pointer(std::get<toml_test_harness::DecodedScalar_Datetime>(rusty::detail::deref_if_pointer(_m))._0); return value::Datetime::from_str(rusty::to_string_view(value)).map_err(toml_test_harness::Error::new_).map([&](auto&& _v) -> Value { return Value::Datetime(std::forward<decltype(_v)>(_v)); }); } if (std::holds_alternative<toml_test_harness::DecodedScalar_DatetimeLocal>(rusty::detail::deref_if_pointer(_m))) { auto&& value = rusty::detail::deref_if_pointer(std::get<toml_test_harness::DecodedScalar_DatetimeLocal>(rusty::detail::deref_if_pointer(_m))._0); return value::Datetime::from_str(rusty::to_string_view(value)).map_err(toml_test_harness::Error::new_).map([&](auto&& _v) -> Value { return Value::Datetime(std::forward<decltype(_v)>(_v)); }); } if (std::holds_alternative<toml_test_harness::DecodedScalar_DateLocal>(rusty::detail::deref_if_pointer(_m))) { auto&& value = rusty::detail::deref_if_pointer(std::get<toml_test_harness::DecodedScalar_DateLocal>(rusty::detail::deref_if_pointer(_m))._0); return value::Datetime::from_str(rusty::to_string_view(value)).map_err(toml_test_harness::Error::new_).map([&](auto&& _v) -> Value { return Value::Datetime(std::forward<decltype(_v)>(_v)); }); } if (std::holds_alternative<toml_test_harness::DecodedScalar_TimeLocal>(rusty::detail::deref_if_pointer(_m))) { auto&& value = rusty::detail::deref_if_pointer(std::get<toml_test_harness::DecodedScalar_TimeLocal>(rusty::detail::deref_if_pointer(_m))._0); return value::Datetime::from_str(rusty::to_string_view(value)).map_err(toml_test_harness::Error::new_).map([&](auto&& _v) -> Value { return Value::Datetime(std::forward<decltype(_v)>(_v)); }); } return [&]() -> rusty::Result<Value, toml_test_harness::Error> { rusty::intrinsics::unreachable(); }(); }();
    }

    rusty::Result<value::Table, toml_test_harness::Error> from_table(const rusty::HashMap<rusty::String, toml_test_harness::DecodedValue>& decoded) {
        return rusty::Result<value::Table, toml_test_harness::Error>::from_iter(rusty::map(rusty::iter(decoded), [&](auto&& _destruct_param0) {
auto&& k = rusty::detail::deref_if_pointer(std::get<0>(rusty::detail::deref_if_pointer(_destruct_param0)));
auto&& v = rusty::detail::deref_if_pointer(std::get<1>(rusty::detail::deref_if_pointer(_destruct_param0)));
auto v_shadow1 = RUSTY_TRY(from_decoded(std::move(v)));
return rusty::Ok(std::make_tuple(rusty::to_owned(std::move(k)), std::move(v_shadow1)));
}));
    }

    rusty::Result<value::Array, toml_test_harness::Error> from_array(std::span<const toml_test_harness::DecodedValue> decoded) {
        return rusty::Result<value::Array, toml_test_harness::Error>::from_iter(rusty::map(rusty::iter(decoded), [&](auto&&... _args) -> decltype(auto) { return from_decoded(std::forward<decltype(_args)>(_args)...); }));
    }
...
namespace decoder {
    std::string_view Decoder::name() const {
        return std::string_view("toml");
    }
}

namespace decoder {
    rusty::Result<toml_test_harness::DecodedValue, toml_test_harness::Error> Decoder::decode(std::span<const uint8_t> data) const {
        // TODO: external crate 'itertools' — provide type mapping or transpile dependency
        // Rust-only unresolved import: using _ = itertools::Itertools;
        // TODO: external crate 'serde' — provide type mapping or transpile dependency
        // Rust-only unresolved import: using _ = serde::de::Deserialize;
        auto data_shadow1 = RUSTY_TRY_INTO(rusty::str_runtime::from_utf8(data).map_err(toml_test_harness::Error::new_), rusty::Result<toml_test_harness::DecodedValue, toml_test_harness::Error>);
        auto [table, errors] = rusty::detail::deref_if_pointer_like(de::DeTable::parse_recoverable(std::move(data_shadow1)));
        if (!rusty::is_empty(errors)) {
            auto errors_shadow1 = rusty::join(rusty::iter(std::move(errors)), "\n---\n");
            auto error = toml_test_harness::Error::new_(std::move(errors_shadow1));
            return rusty::Result<toml_test_harness::DecodedValue, toml_test_harness::Error>::Err(std::move(error));
        }
        auto document = RUSTY_TRY_INTO(Table::deserialize((std::move(table)).from()).map_err([&](auto&& err) {
err.set_input(rusty::Some(std::move(data_shadow1)));
return toml_test_harness::Error::new_(std::move(err));
}), rusty::Result<toml_test_harness::DecodedValue, toml_test_harness::Error>);
        const auto value = Value::Table(std::move(document));
        return value_to_decoded(value);
    }
}
...
namespace encoder {
    std::string_view Encoder::name() const {
        return std::string_view("toml");
    }
}

namespace encoder {
    rusty::Result<rusty::String, toml_test_harness::Error> Encoder::encode(toml_test_harness::DecodedValue data) const {
        const auto value = RUSTY_TRY_INTO(from_decoded(data), rusty::Result<rusty::String, toml_test_harness::Error>);
        auto&& _let_pat = value;
        auto&& document = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_let_pat)._0);
        auto s = RUSTY_TRY_INTO(to_string(document).map_err(toml_test_harness::Error::new_), rusty::Result<rusty::String, toml_test_harness::Error>);
        return rusty::Result<rusty::String, toml_test_harness::Error>::Ok(std::move(s));
    }
}

namespace encoder {
    EncoderPretty EncoderPretty::clone() const {
        return {};
    }
}

namespace encoder {
    std::string_view EncoderPretty::name() const {
        return std::string_view("toml");
    }
}

namespace encoder {
    rusty::Result<rusty::String, toml_test_harness::Error> EncoderPretty::encode(toml_test_harness::DecodedValue data) const {
        const auto value = RUSTY_TRY_INTO(from_decoded(data), rusty::Result<rusty::String, toml_test_harness::Error>);
        auto&& _let_pat = value;
        auto&& document = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_let_pat)._0);
        auto s = RUSTY_TRY_INTO(to_string_pretty(document).map_err(toml_test_harness::Error::new_), rusty::Result<rusty::String, toml_test_harness::Error>);
        return rusty::Result<rusty::String, toml_test_harness::Error>::Ok(std::move(s));
    }
}
