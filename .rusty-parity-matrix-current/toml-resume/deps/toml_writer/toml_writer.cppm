...
namespace string {
    std::partial_ordering TomlString::operator<=>(const TomlString& other) const {
        return rusty::to_partial_ordering([&]() -> rusty::Option<rusty::cmp::Ordering> {
            return [&]() -> rusty::Option<rusty::cmp::Ordering> { auto&& _m = rusty::partial_cmp(this->decoded, other.decoded); if (_m.is_some()) { auto&& _mv0 = std::as_const(_m).unwrap(); if (_mv0 == ::core::cmp::Ordering::Equal) { return [&]() -> rusty::Option<rusty::cmp::Ordering> { auto&& _m = rusty::partial_cmp(this->encoding, other.encoding); if (_m.is_some()) { auto&& _mv0 = std::as_const(_m).unwrap(); if (_mv0 == ::core::cmp::Ordering::Equal) { return rusty::partial_cmp(this->newline, other.newline); } } if (true) { const auto& cmp = _m; return cmp; } return [&]() -> rusty::Option<rusty::cmp::Ordering> { rusty::intrinsics::unreachable(); }(); }(); } } if (true) { const auto& cmp = _m; return cmp; } return [&]() -> rusty::Option<rusty::cmp::Ordering> { rusty::intrinsics::unreachable(); }(); }();
        }());
    }
}
...
namespace string {
    rusty::cmp::Ordering TomlString::cmp(const TomlString& other) const {
        return ({ auto&& _m = rusty::cmp::cmp(this->decoded, other.decoded); std::optional<rusty::cmp::Ordering> _match_value; bool _m_matched = false; if (!_m_matched && (_m == ::core::cmp::Ordering::Equal)) { _match_value.emplace(std::move(({ auto&& _m = rusty::cmp::cmp(this->encoding, other.encoding); std::optional<rusty::cmp::Ordering> _match_value; bool _m_matched = false; if (!_m_matched && (_m == ::core::cmp::Ordering::Equal)) { _match_value.emplace(std::move(rusty::cmp::cmp(this->newline, other.newline))); _m_matched = true; } if (!_m_matched) { const auto& cmp = _m; _match_value.emplace(std::move(cmp)); _m_matched = true; } if (!_m_matched) { rusty::intrinsics::unreachable(); } std::move(_match_value).value(); }))); _m_matched = true; } if (!_m_matched) { const auto& cmp = _m; _match_value.emplace(std::move(cmp)); _m_matched = true; } if (!_m_matched) { rusty::intrinsics::unreachable(); } std::move(_match_value).value(); });
    }
}
...
namespace string {
    rusty::cmp::Ordering TomlKey::cmp(const TomlKey& other) const {
        return ({ auto&& _m = rusty::cmp::cmp(this->decoded, other.decoded); std::optional<rusty::cmp::Ordering> _match_value; bool _m_matched = false; if (!_m_matched && (_m == ::core::cmp::Ordering::Equal)) { _match_value.emplace(std::move(rusty::cmp::cmp(this->encoding, other.encoding))); _m_matched = true; } if (!_m_matched) { const auto& cmp = _m; _match_value.emplace(std::move(cmp)); _m_matched = true; } if (!_m_matched) { rusty::intrinsics::unreachable(); } std::move(_match_value).value(); });
    }
}
