...
macros::insert_toml(root, std::array{rusty::slice_from("-package", 1)}, Value::Table(value::Table::new_()));
{
    macros::insert_toml(root, std::array{rusty::slice_from("-package", 1), rusty::slice_from("-name", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer("toml");
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
    {
        macros::insert_toml(root, std::array{rusty::slice_from("-package", 1), rusty::slice_from("-version", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer("0.4.5");
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
        {
            macros::insert_toml(root, std::array{rusty::slice_from("-package", 1), rusty::slice_from("-authors", 1)}, [&]() { auto array = value::Array::new_();
...
return Value::Array(std::move(array)); }());
            macros::insert_toml(root, std::array{rusty::slice_from("-badges", 1)}, Value::Table(value::Table::new_()));
            {
                macros::insert_toml(root, std::array{rusty::slice_from("-badges", 1), rusty::slice_from("-travis-ci", 1)}, [&]() { auto table_shadow2 = Value::Table(value::Table::new_());
macros::insert_toml(table_shadow2, std::array{rusty::slice_from("-repository", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer("alexcrichton/toml-rs");
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
return table_shadow2; }());
                macros::insert_toml(root, std::array{rusty::slice_from("-dependencies", 1)}, Value::Table(value::Table::new_()));
                {
                    macros::insert_toml(root, std::array{rusty::slice_from("-dependencies", 1), rusty::slice_from("-serde", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer("1.0");
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
                    macros::insert_toml(root, std::array{rusty::slice_from("-dev-dependencies", 1)}, Value::Table(value::Table::new_()));
                    {
                        macros::insert_toml(root, std::array{rusty::slice_from("-dev-dependencies", 1), rusty::slice_from("-serde_derive", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer("1.0");
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
                        {
                            macros::insert_toml(root, std::array{rusty::slice_from("-dev-dependencies", 1), rusty::slice_from("-serde_json", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer("1.0");
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
                        }
                    }
                }
...
return [&]() { auto&& _m = root; if (std::holds_alternative<Value_Table>(rusty::detail::deref_if_pointer(_m))) { auto&& table_shadow1 = rusty::detail::deref_if_pointer(std::get<Value_Table>(rusty::detail::deref_if_pointer(_m))._0); return table_shadow1; } if (true) { rusty::panicking::panic("internal error: entered unreachable code"); } rusty::intrinsics::unreachable(); }(); }();
...
return Value::Table(std::move(table_shadow1)); }();
    ...
    void test_array() {
        auto actual = [&]() { auto table_shadow1 = value::Table::new_();
auto root = Value::Table(std::move(table_shadow1));
macros::push_toml(root, std::array{rusty::slice_from("-fruit", 1)});
{
    macros::insert_toml(root, std::array{rusty::slice_from("-fruit", 1), rusty::slice_from("-name", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer("apple");
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
    macros::insert_toml(root, std::array{rusty::slice_from("-fruit", 1), rusty::slice_from("-physical", 1)}, Value::Table(value::Table::new_()));
    {
        macros::insert_toml(root, std::array{rusty::slice_from("-fruit", 1), rusty::slice_from("-physical", 1), rusty::slice_from("-color", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer("red");
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
        {
            macros::insert_toml(root, std::array{rusty::slice_from("-fruit", 1), rusty::slice_from("-physical", 1), rusty::slice_from("-shape", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer("round");
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
            macros::push_toml(root, std::array{rusty::slice_from("-fruit", 1), rusty::slice_from("-variety", 1)});
            {
                macros::insert_toml(root, std::array{rusty::slice_from("-fruit", 1), rusty::slice_from("-variety", 1), rusty::slice_from("-name", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer("red delicious");
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
                macros::push_toml(root, std::array{rusty::slice_from("-fruit", 1), rusty::slice_from("-variety", 1)});
                {
                    macros::insert_toml(root, std::array{rusty::slice_from("-fruit", 1), rusty::slice_from("-variety", 1), rusty::slice_from("-name", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer("granny smith");
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
                    macros::push_toml(root, std::array{rusty::slice_from("-fruit", 1)});
                    {
                        macros::insert_toml(root, std::array{rusty::slice_from("-fruit", 1), rusty::slice_from("-name", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer("banana");
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
                        macros::push_toml(root, std::array{rusty::slice_from("-fruit", 1), rusty::slice_from("-variety", 1)});
                        {
                            macros::insert_toml(root, std::array{rusty::slice_from("-fruit", 1), rusty::slice_from("-variety", 1), rusty::slice_from("-name", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer("plantain");
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
                        }
                    }
                }
...
auto root = Value::Table(std::move(table_shadow1));
{
    macros::insert_toml(root, std::array{rusty::slice_from("-positive", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer(1);
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
    {
        macros::insert_toml(root, std::array{rusty::slice_from("-negative", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer((-1));
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
        {
            macros::insert_toml(root, std::array{rusty::slice_from("-table", 1)}, [&]() { auto table_shadow2 = Value::Table(value::Table::new_());
macros::insert_toml(table_shadow2, std::array{rusty::slice_from("-positive", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer(1);
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
macros::insert_toml(table_shadow2, std::array{rusty::slice_from("-negative", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer((-1));
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
return table_shadow2; }());
            {
                macros::insert_toml(root, std::array{rusty::slice_from("-array", 1)}, [&]() { auto array = value::Array::new_();
...
return Value::Array(std::move(array)); }());
                {
                    macros::insert_toml(root, std::array{rusty::slice_from("-neg_zero", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer((-0));
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
                    {
                        macros::insert_toml(root, std::array{rusty::slice_from("-pos_zero", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer((0));
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
                        {
                            macros::insert_toml(root, std::array{rusty::slice_from("-float", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer(1.618);
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
                            {
                                macros::insert_toml(root, std::array{rusty::slice_from("-sf1", 1)}, Value::Float(::double_::INFINITY));
                                {
                                    macros::insert_toml(root, std::array{rusty::slice_from("-sf2", 1)}, Value::Float(::double_::INFINITY));
                                    {
                                        macros::insert_toml(root, std::array{rusty::slice_from("-sf3", 1)}, Value::Float(::double_::NEG_INFINITY));
                                        {
                                            macros::insert_toml(root, std::array{rusty::slice_from("-sf7", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer((0.0));
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
                                            {
                                                macros::insert_toml(root, std::array{rusty::slice_from("-sf8", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer((-0.0));
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
                                                {
                                                    macros::insert_toml(root, std::array{rusty::slice_from("-hex", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer(2748);
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
                                                    {
                                                        macros::insert_toml(root, std::array{rusty::slice_from("-oct", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer(493);
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
                                                        {
                                                            macros::insert_toml(root, std::array{rusty::slice_from("-bin", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer(214);
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
                                                        }
                                                    }
                                                }
...
auto root = Value::Table(std::move(table_shadow1));
{
    macros::insert_toml(root, std::array{rusty::slice_from("-sf4", 1)}, Value::Float(std::copysign(::double_::NAN, 1.0)));
    {
        macros::insert_toml(root, std::array{rusty::slice_from("-sf5", 1)}, Value::Float(std::copysign(::double_::NAN, 1.0)));
        {
            macros::insert_toml(root, std::array{rusty::slice_from("-sf6", 1)}, Value::Float(std::copysign(::double_::NAN, -1.0)));
        }
    }
}
return [&]() { auto&& _m = root; if (std::holds_alternative<Value_Table>(rusty::detail::deref_if_pointer(_m))) { auto&& table_shadow1 = rusty::detail::deref_if_pointer(std::get<Value_Table>(rusty::detail::deref_if_pointer(_m))._0); return table_shadow1; } if (true) { rusty::panicking::panic("internal error: entered unreachable code"); } rusty::intrinsics::unreachable(); }(); }();
    ...
    void test_datetime() {
        auto actual = [&]() { auto table_shadow1 = value::Table::new_();
auto root = Value::Table(std::move(table_shadow1));
macros::insert_toml(root, std::array{rusty::slice_from("-odt1", 1)}, Value::Datetime(("1979-05-27T07:32:00Z").parse().unwrap()));
macros::insert_toml(root, std::array{rusty::slice_from("-odt2", 1)}, Value::Datetime(("1979-05-27T00:32:00-07:00").parse().unwrap()));
macros::insert_toml(root, std::array{rusty::slice_from("-odt3", 1)}, Value::Datetime(("1979-05-27T00:32:00.999999-07:00").parse().unwrap()));
macros::insert_toml(root, std::array{rusty::slice_from("-odt4", 1)}, Value::Datetime(("1979-05-27T07:32:00Z").parse().unwrap()));
macros::insert_toml(root, std::array{rusty::slice_from("-ldt1", 1)}, Value::Datetime(("1979-05-27T07:32:00").parse().unwrap()));
macros::insert_toml(root, std::array{rusty::slice_from("-ldt2", 1)}, Value::Datetime(("1979-05-27T00:32:00.999999").parse().unwrap()));
macros::insert_toml(root, std::array{rusty::slice_from("-ld1", 1)}, Value::Datetime(("1979-05-27").parse().unwrap()));
macros::insert_toml(root, std::array{rusty::slice_from("-lt1", 1)}, Value::Datetime(("07:32:00").parse().unwrap()));
macros::insert_toml(root, std::array{rusty::slice_from("-lt2", 1)}, Value::Datetime(("00:32:00.999999").parse().unwrap()));
{
    macros::insert_toml(root, std::array{rusty::slice_from("-table", 1)}, [&]() { auto table_shadow2 = Value::Table(value::Table::new_());
macros::insert_toml(table_shadow2, std::array{rusty::slice_from("-odt1", 1)}, Value::Datetime(("1979-05-27T07:32:00Z").parse().unwrap()));
macros::insert_toml(table_shadow2, std::array{rusty::slice_from("-odt2", 1)}, Value::Datetime(("1979-05-27T00:32:00-07:00").parse().unwrap()));
macros::insert_toml(table_shadow2, std::array{rusty::slice_from("-odt3", 1)}, Value::Datetime(("1979-05-27T00:32:00.999999-07:00").parse().unwrap()));
macros::insert_toml(table_shadow2, std::array{rusty::slice_from("-odt4", 1)}, Value::Datetime(("1979-05-27T07:32:00Z").parse().unwrap()));
macros::insert_toml(table_shadow2, std::array{rusty::slice_from("-ldt1", 1)}, Value::Datetime(("1979-05-27T07:32:00").parse().unwrap()));
macros::insert_toml(table_shadow2, std::array{rusty::slice_from("-ldt2", 1)}, Value::Datetime(("1979-05-27T00:32:00.999999").parse().unwrap()));
macros::insert_toml(table_shadow2, std::array{rusty::slice_from("-ld1", 1)}, Value::Datetime(("1979-05-27").parse().unwrap()));
macros::insert_toml(table_shadow2, std::array{rusty::slice_from("-lt1", 1)}, Value::Datetime(("07:32:00").parse().unwrap()));
macros::insert_toml(table_shadow2, std::array{rusty::slice_from("-lt2", 1)}, Value::Datetime(("00:32:00.999999").parse().unwrap()));
return table_shadow2; }());
    {
        macros::insert_toml(root, std::array{rusty::slice_from("-array", 1)}, [&]() { auto array = value::Array::new_();
...
auto root = Value::Table(std::move(table_shadow1));
{
    macros::insert_toml(root, std::array{rusty::slice_from("-quoted", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer(true);
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
    {
        macros::insert_toml(root, std::array{rusty::slice_from("-table", 1)}, [&]() { auto table_shadow2 = Value::Table(value::Table::new_());
macros::insert_toml(table_shadow2, std::array{rusty::slice_from("-quoted", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer(true);
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
return table_shadow2; }());
        macros::insert_toml(root, std::array{rusty::slice_from("-target", 1), rusty::slice_from("-cfg(windows)", 1), rusty::slice_from("-dependencies", 1)}, Value::Table(value::Table::new_()));
        {
            macros::insert_toml(root, std::array{rusty::slice_from("-target", 1), rusty::slice_from("-cfg(windows)", 1), rusty::slice_from("-dependencies", 1), rusty::slice_from("-winapi", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer("0.2.8");
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
        }
    }
}
...
auto root = Value::Table(std::move(table_shadow1));
{
    macros::insert_toml(root, std::array{rusty::slice_from("-empty_inline_table", 1)}, [&]() { auto table_shadow2 = Value::Table(value::Table::new_());
return table_shadow2; }());
    {
        macros::insert_toml(root, std::array{rusty::slice_from("-empty_inline_array", 1)}, [&]() { auto array = value::Array::new_();
return Value::Array(std::move(array)); }());
        macros::insert_toml(root, std::array{rusty::slice_from("-empty_table", 1)}, Value::Table(value::Table::new_()));
        macros::push_toml(root, std::array{rusty::slice_from("-empty_array", 1)});
    }
}
return [&]() { auto&& _m = root; if (std::holds_alternative<Value_Table>(rusty::detail::deref_if_pointer(_m))) { auto&& table_shadow1 = rusty::detail::deref_if_pointer(std::get<Value_Table>(rusty::detail::deref_if_pointer(_m))._0); return table_shadow1; } if (true) { rusty::panicking::panic("internal error: entered unreachable code"); } rusty::intrinsics::unreachable(); }(); }();
        const auto expected = [&]() { auto table_shadow1 = value::Table::new_();
...
auto root = Value::Table(std::move(table_shadow1));
{
    macros::insert_toml(root, std::array{rusty::slice_from("-a", 1), rusty::slice_from("-b", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer(123);
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
    macros::insert_toml(root, std::array{rusty::slice_from("-a", 1), rusty::slice_from("-c", 1)}, Value::Datetime(("1979-05-27T07:32:00Z").parse().unwrap()));
    macros::insert_toml(root, std::array{rusty::slice_from("-table", 1)}, Value::Table(value::Table::new_()));
    {
        macros::insert_toml(root, std::array{rusty::slice_from("-table", 1), rusty::slice_from("-a", 1), rusty::slice_from("-b", 1), rusty::slice_from("-c", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer(1);
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
        {
            macros::insert_toml(root, std::array{rusty::slice_from("-table", 1), rusty::slice_from("-a", 1), rusty::slice_from("-b", 1), rusty::slice_from("-d", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer(2);
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
            {
                macros::insert_toml(root, std::array{rusty::slice_from("-table", 1), rusty::slice_from("-in", 1)}, [&]() { auto table_shadow2 = Value::Table(value::Table::new_());
macros::insert_toml(table_shadow2, std::array{rusty::slice_from("-type", 1), rusty::slice_from("-name", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer("cat");
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
macros::insert_toml(table_shadow2, std::array{rusty::slice_from("-type", 1), rusty::slice_from("-color", 1)}, [&]() { const auto de = macros::IntoDeserializer::into_deserializer("blue");
return macros::Deserialize::deserialize(std::move(de)).unwrap(); }());
return table_shadow2; }());
            }
        }
