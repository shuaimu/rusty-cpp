...
struct Either : std::variant<Either_Left<L, R>, Either_Right<L, R>> {
    ...
    rusty::cmp::Ordering cmp(const Either<L, R>& other) const {
        const auto __self_discr = rusty::intrinsics::discriminant_value((*this));
        const auto __arg1_discr = rusty::intrinsics::discriminant_value(other);
        return ({ auto&& _m = rusty::cmp::cmp(__self_discr, __arg1_discr); std::optional<rusty::cmp::Ordering> _match_value; bool _m_matched = false; if (!_m_matched && (_m == ::core::cmp::Ordering::Equal)) { _match_value.emplace(std::move([&]() -> rusty::cmp::Ordering { auto&& _m0 = (*this); auto&& _m1 = other; if (std::holds_alternative<std::variant_alternative_t<0, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m0))>>>(rusty::detail::deref_if_pointer(_m0)) && std::holds_alternative<std::variant_alternative_t<0, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m1))>>>(rusty::detail::deref_if_pointer(_m1))) { auto&& __self_0 = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<0, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m0))>>>(rusty::detail::deref_if_pointer(_m0))._0); auto&& __arg1_0 = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<0, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m1))>>>(rusty::detail::deref_if_pointer(_m1))._0); return rusty::cmp::cmp(__self_0, __arg1_0); } if (std::holds_alternative<std::variant_alternative_t<1, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m0))>>>(rusty::detail::deref_if_pointer(_m0)) && std::holds_alternative<std::variant_alternative_t<1, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m1))>>>(rusty::detail::deref_if_pointer(_m1))) { auto&& __self_0 = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<1, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m0))>>>(rusty::detail::deref_if_pointer(_m0))._0); auto&& __arg1_0 = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<1, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m1))>>>(rusty::detail::deref_if_pointer(_m1))._0); return rusty::cmp::cmp(__self_0, __arg1_0); } if (true) { return [&]() -> rusty::cmp::Ordering { rusty::intrinsics::unreachable(); }(); } return [&]() -> rusty::cmp::Ordering { rusty::intrinsics::unreachable(); }(); }())); _m_matched = true; } if (!_m_matched) { const auto& cmp = _m; _match_value.emplace(std::move(cmp)); _m_matched = true; } if (!_m_matched) { rusty::intrinsics::unreachable(); } std::move(_match_value).value(); });
    }
    ...
    decltype(auto) operator*() {
        return [&]() { auto&& _m = (*this); if (std::holds_alternative<std::variant_alternative_t<0, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))) { auto&& inner = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<0, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))._0); return rusty::deref_mut(inner); } if (std::holds_alternative<std::variant_alternative_t<1, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))) { auto&& inner = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<1, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))._0); return rusty::deref_mut(inner); } rusty::intrinsics::unreachable(); }();
    }
...
return i > nclear;
        ...
        auto next_element() {
            ...
            return ({ auto&& _m = this->iter.next(); std::optional<rusty::Option<rusty::detail::associated_item_t<I>>> _match_value; bool _m_matched = false; if (!_m_matched) { const auto& None = _m; _match_value.emplace(std::move([&]() -> rusty::Option<rusty::detail::associated_item_t<I>> { this->done = true;
return rusty::Option<rusty::detail::associated_item_t<I>>(rusty::None); }())); _m_matched = true; } if (!_m_matched) { const auto& otherwise = _m; _match_value.emplace(std::move(otherwise)); _m_matched = true; } if (!_m_matched) { rusty::intrinsics::unreachable(); } std::move(_match_value).value(); });
        }
...
namespace minmax {
    ...
    template<typename I, typename K, typename F, typename L>
    MinMaxResult<rusty::detail::associated_item_t<I>> minmax_impl(I it, F key_for, L lt) {
        auto [min, max, min_key, max_key] = rusty::detail::deref_if_pointer_like(({ auto&& _m = it.next(); std::optional<std::remove_cvref_t<decltype(([&]() -> decltype(auto) { auto _mv = _m.unwrap();
auto&& x = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
return (({ auto&& _m = it.next(); std::optional<std::remove_cvref_t<decltype(([&]() -> decltype(auto) { auto _mv = _m.unwrap();
auto&& y = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
return ([&]() { auto xk = key_for(x);
auto yk = key_for(y);
return (!lt(y, x, yk, xk) ? std::make_tuple(x, y, std::move(xk), std::move(yk)) : std::make_tuple(y, x, std::move(yk), std::move(xk))); }()); })())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& y = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move([&]() { auto xk = key_for(x);
auto yk = key_for(y);
return (!lt(y, x, yk, xk) ? std::make_tuple(x, y, std::move(xk), std::move(yk)) : std::make_tuple(y, x, std::move(yk), std::move(xk))); }())); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return MinMaxResult<rusty::detail::associated_item_t<I>>{MinMaxResult_OneElement<rusty::detail::associated_item_t<I>>{x}}; } std::move(_match_value).value(); })); })())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& x = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(({ auto&& _m = it.next(); std::optional<std::remove_cvref_t<decltype(([&]() -> decltype(auto) { auto _mv = _m.unwrap();
auto&& y = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
return ([&]() { auto xk = key_for(x);
auto yk = key_for(y);
return (!lt(y, x, yk, xk) ? std::make_tuple(x, y, std::move(xk), std::move(yk)) : std::make_tuple(y, x, std::move(yk), std::move(xk))); }()); })())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
...
_match_value.emplace(std::move([&]() { auto xk = key_for(x);
auto yk = key_for(y);
return (!lt(y, x, yk, xk) ? std::make_tuple(x, y, std::move(xk), std::move(yk)) : std::make_tuple(y, x, std::move(yk), std::move(xk))); }())); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return MinMaxResult<rusty::detail::associated_item_t<I>>{MinMaxResult_OneElement<rusty::detail::associated_item_t<I>>{x}}; } std::move(_match_value).value(); }))); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return MinMaxResult<rusty::detail::associated_item_t<I>>{MinMaxResult_NoElements<rusty::detail::associated_item_t<I>>{}}; } std::move(_match_value).value(); }));
        while (true) {
            auto&& _m = it.next();
...
for (auto&& _for_item : rusty::for_in(rusty::rev(rusty::zip(rusty::iter_mut(inner.iters), rusty::iter_mut(values))))) {
    ...
    if (auto&& _iflet_scrutinee = iter.iter.next(); _iflet_scrutinee.is_some()) {
        ...
        return rusty::Option<rusty::Vec<rusty::detail::associated_item_t<I>>>(rusty::clone(values));
    } else {
...
this->_0 = rusty::None;
return rusty::Option<rusty::Vec<rusty::detail::associated_item_t<I>>>(rusty::None); }(); } if (_m.is_none()) { return [&]() { auto next = rusty::collect_range(rusty::map(rusty::iter_mut(inner.iters), [&](auto&& i) { return i.iter.next(); }));
...
return value;
                    ...
                    if (count == 0) {
                        return rusty::Option<rusty::Vec<rusty::detail::associated_item_t<I>>>(rusty::None);
                    } else {
                        return rusty::Option<rusty::Vec<rusty::detail::associated_item_t<I>>>(std::move(last));
                    }
                } else {
    ...
    struct Interleave {
        ...
        auto next() {
            ...
            if (this->next_coming_from_j) {
                return ({ auto&& _m = this->i.next(); std::optional<std::remove_cvref_t<decltype((this->j.next()))>> _match_value; bool _m_matched = false; if (!_m_matched) { const auto& None = _m; _match_value.emplace(std::move(this->j.next())); _m_matched = true; } if (!_m_matched) { const auto& r = _m; _match_value.emplace(std::move(r)); _m_matched = true; } if (!_m_matched) { rusty::intrinsics::unreachable(); } std::move(_match_value).value(); });
            } else {
                return ({ auto&& _m = this->j.next(); std::optional<std::remove_cvref_t<decltype((this->i.next()))>> _match_value; bool _m_matched = false; if (!_m_matched) { const auto& None = _m; _match_value.emplace(std::move(this->i.next())); _m_matched = true; } if (!_m_matched) { const auto& r = _m; _match_value.emplace(std::move(r)); _m_matched = true; } if (!_m_matched) { rusty::intrinsics::unreachable(); } std::move(_match_value).value(); });
            }
        }
        std::tuple<size_t, rusty::Option<size_t>> size_hint() const {
...
return [&]() { auto&& _m = j.next(); if (_m.is_some()) { auto&& _mv0 = _m.unwrap(); auto&& y = rusty::detail::deref_if_pointer(_mv0); return rusty::Ok(f(std::move(acc), std::move(y))); } if (_m.is_none()) { return rusty::Err(std::move(acc)); } rusty::intrinsics::unreachable(); }();
    ...
    struct PutBack {
        ...
        auto next() {
            using namespace peeking_take_while;
            return ({ auto&& _m = this->top; std::optional<std::remove_cvref_t<decltype((this->iter.next()))>> _match_value; bool _m_matched = false; if (!_m_matched) { const auto& None = _m; _match_value.emplace(std::move(this->iter.next())); _m_matched = true; } if (!_m_matched) { const auto& some = _m; _match_value.emplace(std::move(some.take())); _m_matched = true; } if (!_m_matched) { rusty::intrinsics::unreachable(); } std::move(_match_value).value(); });
        }
        std::tuple<size_t, rusty::Option<size_t>> size_hint() const {
            using namespace peeking_take_while;
        ...
        auto nth(size_t n) {
            using namespace peeking_take_while;
            return ({ auto&& _m = this->top; std::optional<std::remove_cvref_t<decltype((this->iter.nth(std::move(n))))>> _match_value; bool _m_matched = false; if (!_m_matched) { const auto& None = _m; _match_value.emplace(std::move(this->iter.nth(std::move(n)))); _m_matched = true; } if (!_m_matched) { const auto& some = _m; _match_value.emplace(std::move([&]() {
...
return this->iter.nth(n - 1);
        ...
        auto peeking_next(F accept) {
            ...
            if (auto&& _iflet_scrutinee = this->next(); _iflet_scrutinee.is_some()) {
                ...
                return rusty::Option<rusty::detail::associated_item_t<I>>(std::move(r));
            } else {
                return rusty::Option<rusty::detail::associated_item_t<I>>(rusty::None);
            }
        }
...
return x; }())); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<rusty::detail::associated_item_t<I>, rusty::detail::associated_item_t<J>>>(rusty::None); } std::move(_match_value).value(); }); }(); } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
    ...
    struct TakeWhileRef {
        ...
        auto next() {
            ...
            return [&]() { auto&& _m = this->iter.next(); if (_m.is_none()) { return rusty::Option<rusty::detail::associated_item_t<I>>(rusty::None); } if (_m.is_some()) { auto&& _mv1 = _m.unwrap(); auto&& elt = rusty::detail::deref_if_pointer(_mv1); return [&]() {
if ((this->f)(elt)) {
return rusty::Option<rusty::detail::associated_item_t<I>>(std::move(elt));
} else {
...
return rusty::Option<rusty::detail::associated_item_t<I>>(rusty::None);
    ...
    struct WhileSome {
        ...
        template<typename A>
        auto next() {
            return [&]() { auto&& _m = this->iter.next(); if ((_m.is_none() || (rusty::detail::deref_if_pointer(_m).is_some() && std::as_const(rusty::detail::deref_if_pointer(_m)).unwrap().is_none()))) { return rusty::Option<A>(rusty::None); } if (_m.is_some()) { return _m.unwrap(); } rusty::intrinsics::unreachable(); }();
        }
        template<typename A>
        std::tuple<size_t, rusty::Option<size_t>> size_hint() const {
            return std::make_tuple(static_cast<size_t>(0), rusty::size_hint(this->iter)._1);
    ...
    struct Tuple2Combination {
        ...
        auto next() {
            if (auto&& _iflet_scrutinee = this->c.next(); _iflet_scrutinee.is_some()) {
                ...
                return rusty::Option<std::tuple<A, A>>(std::make_tuple(std::move(z), std::move(a)));
            } else {
...
return std::make_tuple(rusty::clone(z), std::move(a));
            ...
            if (auto&& _iflet_scrutinee = item.as_ref(); _iflet_scrutinee.is_some()) {
                ...
                init = rusty::fold(c.map(map_fn(std::move(z))), std::move(init), &f);
            }
            while (true) {
                ...
                init = rusty::fold(c_shadow1.map(map_fn(z)), std::move(init), &f);
            }
            return init;
        }
    };
    ...
    struct Tuple3Combination {
        ...
        auto next() {
            if (auto&& _iflet_scrutinee = this->c.next(); _iflet_scrutinee.is_some()) {
                ...
                auto z = rusty::clone(this->item).unwrap();
                return rusty::Option<std::tuple<A, A, A>>(std::make_tuple(std::move(z), std::move(a), std::move(b)));
            } else {
                this->item = this->iter.next();
                return rusty::clone(this->item).and_then([&](auto&& z) {
    ...
    struct Tuple4Combination {
        ...
        auto next() {
            if (auto&& _iflet_scrutinee = this->c.next(); _iflet_scrutinee.is_some()) {
                ...
                auto z = rusty::clone(this->item).unwrap();
                return rusty::Option<std::tuple<A, A, A, A>>(std::make_tuple(std::move(z), std::move(a), std::move(b), std::move(c)));
            } else {
                this->item = this->iter.next();
                return rusty::clone(this->item).and_then([&](auto&& z) {
    ...
    struct Tuple5Combination {
        ...
        auto next() {
            if (auto&& _iflet_scrutinee = this->c.next(); _iflet_scrutinee.is_some()) {
                ...
                auto z = rusty::clone(this->item).unwrap();
                return rusty::Option<std::tuple<A, A, A, A, A>>(std::make_tuple(std::move(z), std::move(a), std::move(b), std::move(c), std::move(d)));
            } else {
                this->item = this->iter.next();
                return rusty::clone(this->item).and_then([&](auto&& z) {
    ...
    struct Tuple6Combination {
        ...
        auto next() {
            if (auto&& _iflet_scrutinee = this->c.next(); _iflet_scrutinee.is_some()) {
                ...
                auto z = rusty::clone(this->item).unwrap();
                return rusty::Option<std::tuple<A, A, A, A, A, A>>(std::make_tuple(std::move(z), std::move(a), std::move(b), std::move(c), std::move(d), std::move(e)));
            } else {
                this->item = this->iter.next();
                return rusty::clone(this->item).and_then([&](auto&& z) {
    ...
    struct Tuple7Combination {
        ...
        auto next() {
            if (auto&& _iflet_scrutinee = this->c.next(); _iflet_scrutinee.is_some()) {
                ...
                auto z = rusty::clone(this->item).unwrap();
                return rusty::Option<std::tuple<A, A, A, A, A, A, A>>(std::make_tuple(std::move(z), std::move(a), std::move(b), std::move(c), std::move(d), std::move(e), std::move(f)));
            } else {
                this->item = this->iter.next();
                return rusty::clone(this->item).and_then([&](auto&& z) {
    ...
    struct Tuple8Combination {
        ...
        auto next() {
            if (auto&& _iflet_scrutinee = this->c.next(); _iflet_scrutinee.is_some()) {
                ...
                auto z = rusty::clone(this->item).unwrap();
                return rusty::Option<std::tuple<A, A, A, A, A, A, A, A>>(std::make_tuple(std::move(z), std::move(a), std::move(b), std::move(c), std::move(d), std::move(e), std::move(f), std::move(g)));
            } else {
                this->item = this->iter.next();
                return rusty::clone(this->item).and_then([&](auto&& z) {
    ...
    struct Tuple9Combination {
        ...
        auto next() {
            if (auto&& _iflet_scrutinee = this->c.next(); _iflet_scrutinee.is_some()) {
                ...
                auto z = rusty::clone(this->item).unwrap();
                return rusty::Option<std::tuple<A, A, A, A, A, A, A, A, A>>(std::make_tuple(std::move(z), std::move(a), std::move(b), std::move(c), std::move(d), std::move(e), std::move(f), std::move(g), std::move(h)));
            } else {
                this->item = this->iter.next();
                return rusty::clone(this->item).and_then([&](auto&& z) {
    ...
    struct Tuple10Combination {
        ...
        auto next() {
            if (auto&& _iflet_scrutinee = this->c.next(); _iflet_scrutinee.is_some()) {
                ...
                auto z = rusty::clone(this->item).unwrap();
                return rusty::Option<std::tuple<A, A, A, A, A, A, A, A, A, A>>(std::make_tuple(std::move(z), std::move(a), std::move(b), std::move(c), std::move(d), std::move(e), std::move(f), std::move(g), std::move(h), std::move(i)));
            } else {
                this->item = this->iter.next();
                return rusty::clone(this->item).and_then([&](auto&& z) {
    ...
    struct Tuple11Combination {
        ...
        auto next() {
            if (auto&& _iflet_scrutinee = this->c.next(); _iflet_scrutinee.is_some()) {
                ...
                auto z = rusty::clone(this->item).unwrap();
                return rusty::Option<std::tuple<A, A, A, A, A, A, A, A, A, A, A>>(std::make_tuple(std::move(z), std::move(a), std::move(b), std::move(c), std::move(d), std::move(e), std::move(f), std::move(g), std::move(h), std::move(i), std::move(j)));
            } else {
                this->item = this->iter.next();
                return rusty::clone(this->item).and_then([&](auto&& z) {
    ...
    struct Tuple12Combination {
        ...
        auto next() {
            if (auto&& _iflet_scrutinee = this->c.next(); _iflet_scrutinee.is_some()) {
                ...
                auto z = rusty::clone(this->item).unwrap();
                return rusty::Option<std::tuple<A, A, A, A, A, A, A, A, A, A, A, A>>(std::make_tuple(std::move(z), std::move(a), std::move(b), std::move(c), std::move(d), std::move(e), std::move(f), std::move(g), std::move(h), std::move(i), std::move(j), std::move(k)));
            } else {
                this->item = this->iter.next();
                return rusty::clone(this->item).and_then([&](auto&& z) {
    ...
    struct Update {
        ...
        auto next() {
            if (auto&& _iflet_scrutinee = this->iter.next(); _iflet_scrutinee.is_some()) {
                ...
                (this->f)(v);
                return rusty::Option<rusty::detail::associated_item_t<I>>(std::move(v));
            } else {
                return rusty::Option<rusty::detail::associated_item_t<I>>(rusty::None);
            }
        }
...
return rusty::Option<rusty::detail::associated_item_t<I>>(first); }(); } } if (_m.is_some()) { auto&& _mv1 = std::as_const(_m).unwrap(); if (std::holds_alternative<std::variant_alternative_t<2, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_mv1))>>>(rusty::detail::deref_if_pointer(_mv1))) { auto&& second = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<2, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_mv1))>>>(rusty::detail::deref_if_pointer(_mv1))._0); return rusty::Option<rusty::detail::associated_item_t<I>>(second); } } if (_m.is_none()) { return this->inner.next(); } rusty::intrinsics::unreachable(); }();
        }
        std::tuple<size_t, rusty::Option<size_t>> size_hint() const {
            ...
            while (true) {
                if (this->inner_front.is_some()) {
                    ...
                    if (auto&& _iflet_scrutinee = inner.next(); rusty::detail::option_has_value(_iflet_scrutinee)) {
                        ...
                        return rusty::Option<rusty::Result<rusty::detail::associated_item_t<T>, E>>(rusty::Result<rusty::detail::associated_item_t<T>, E>::Ok(std::move(item)));
                    }
                    ...
                    if (!_m_matched) {
                        if (_m.is_some()) {
                            ...
                            if (rusty::detail::deref_if_pointer(_mv1).is_err()) {
                                return rusty::Option<rusty::Result<rusty::detail::associated_item_t<T>, E>>(rusty::Result<rusty::detail::associated_item_t<T>, E>::Err(e));
                                _m_matched = true;
                            }
                        }
                    }
                    if (!_m_matched) {
                        if (_m.is_none()) {
                            if (this->inner_back.is_some()) {
                                ...
                                return rusty::Option<rusty::Result<rusty::detail::associated_item_t<T>, E>>(rusty::None);
                            }
                            _m_matched = true;
                        }
                    }
...
destination_map.entry(std::move(key)).extend(rusty::Some(std::move(val)));
        ...
        rusty::HashMap<K, V> max_by(F compare) {
            return this->reduce([&](auto&& acc, auto&& key, auto&& val) { return ({ auto&& _m = compare(std::move(key), acc, val); std::optional<std::remove_cvref_t<decltype((val))>> _match_value; bool _m_matched = false; if (!_m_matched && (_m == Ordering::Less || _m == Ordering::Equal)) { _match_value.emplace(std::move(val)); _m_matched = true; } if (!_m_matched && (_m == Ordering::Greater)) { _match_value.emplace(std::move(acc)); _m_matched = true; } if (!_m_matched) { rusty::intrinsics::unreachable(); } std::move(_match_value).value(); }); });
        }
        ...
        rusty::HashMap<K, V> min_by(F compare) {
            return this->reduce([&](auto&& acc, auto&& key, auto&& val) { return ({ auto&& _m = compare(std::move(key), acc, val); std::optional<std::remove_cvref_t<decltype((acc))>> _match_value; bool _m_matched = false; if (!_m_matched && (_m == Ordering::Less || _m == Ordering::Equal)) { _match_value.emplace(std::move(acc)); _m_matched = true; } if (!_m_matched && (_m == Ordering::Greater)) { _match_value.emplace(std::move(val)); _m_matched = true; } if (!_m_matched) { rusty::intrinsics::unreachable(); } std::move(_match_value).value(); }); });
        }
        template<typename F, typename CK, typename K, typename V>
...
namespace intersperse_tests {
    ...
    struct IntersperseWith {
        ...
        auto next() {
            ...
            return [&]() { auto&& _m = peek; if (_m.is_some()) { auto&& _mv0 = _m.unwrap(); auto&& item = rusty::detail::deref_if_pointer(_mv0); return item.take(); } if (_m.is_some()) { auto&& _mv1 = std::as_const(_m).unwrap(); if (_mv1.is_none()) { return ({ auto&& _m = iter.next(); std::optional<std::remove_cvref_t<std::remove_cvref_t<decltype(([&]() { rusty::detail::deref_if_pointer_like(peek) = rusty::Some(std::move(new_));
return rusty::Some(([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::intersperse_tests::rusty_ext::generate(std::forward<decltype(__self)>(__self)); }) { return ::intersperse_tests::rusty_ext::generate(std::forward<decltype(__self)>(__self)); } else { return ::intersperse_tests::rusty_ext::generate(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self))); } })(element)); }()))>>> _match_value; bool _m_matched = false; if (!_m_matched) { const auto& new_ = _m; _match_value.emplace(std::move([&]() { rusty::detail::deref_if_pointer_like(peek) = rusty::Some(std::move(new_));
return rusty::Some(([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::intersperse_tests::rusty_ext::generate(std::forward<decltype(__self)>(__self)); }) { return ::intersperse_tests::rusty_ext::generate(std::forward<decltype(__self)>(__self)); } else { return ::intersperse_tests::rusty_ext::generate(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self))); } })(element)); }())); _m_matched = true; } if (!_m_matched) { const auto& None = _m; _match_value.emplace(std::move(rusty::None)); _m_matched = true; } if (!_m_matched) { rusty::intrinsics::unreachable(); } std::move(_match_value).value(); }); } } if (_m.is_none()) { return [&]() { rusty::detail::deref_if_pointer_like(peek) = rusty::Some(rusty::None);
...
return ([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::kmerge_impl::rusty_ext::kmerge_pred(std::forward<decltype(__self)>(__self), a.head, b.head); }) { return ::kmerge_impl::rusty_ext::kmerge_pred(std::forward<decltype(__self)>(__self), a.head, b.head); } else { return ::kmerge_impl::rusty_ext::kmerge_pred(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), a.head, b.head); } })(less_than);
});
            return rusty::Option<rusty::detail::associated_item_t<I>>(std::move(result));
        }
        std::tuple<size_t, rusty::Option<size_t>> size_hint() const {
...
namespace combinations {
    ...
    struct CombinationsGeneric {
        ...
        auto next() {
            const auto done = (this->first ? this->init() : this->increment_indices());
            if (done) {
                return rusty::Option<rusty::detail::associated_item_t<Idx>>(rusty::None);
            }
            return rusty::Option<rusty::detail::associated_item_t<Idx>>(([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::combinations::rusty_ext::extract_item(std::forward<decltype(__self)>(__self), this->pool); }) { return ::combinations::rusty_ext::extract_item(std::forward<decltype(__self)>(__self), this->pool); } else { return ::combinations::rusty_ext::extract_item(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), this->pool); } })(this->indices));
        }
        auto nth(size_t n) {
...
return false; }(); } if (_m.is_none()) { return true; } return [&]() -> bool { rusty::intrinsics::unreachable(); }(); }();
        ...
        auto next() {
            ...
            return rusty::Option<rusty::Vec<rusty::detail::associated_item_t<I>>>(this->pool.get_at(this->indices));
        }
        auto nth(size_t n) {
            if (this->first) {
                if (!(rusty::is_empty(this->indices) || this->pool.get_next())) {
...
return rusty::Option<typename F::MergeResult>(std::move(next)); }(); } rusty::intrinsics::unreachable(); }();
    ...
    struct MergeFuncLR {
        ...
        auto merge(L left, R right) {
            return ({ auto&& _m = this->_0(left, right); std::optional<std::remove_cvref_t<decltype((std::make_tuple(rusty::None, either_or_both::EitherOrBoth_Both<F, F>{std::move(left), std::move(right)})))>> _match_value; bool _m_matched = false; if (!_m_matched && (_m == Ordering::Equal)) { _match_value.emplace(std::move(std::make_tuple(rusty::None, either_or_both::EitherOrBoth_Both<F, F>{std::move(left), std::move(right)}))); _m_matched = true; } if (!_m_matched && (_m == Ordering::Less)) { _match_value.emplace(std::move(std::make_tuple(rusty::Some(rusty::either::Right<L, R>(R(std::move(right)))), Left<L, L>(L(std::move(left)))))); _m_matched = true; } if (!_m_matched && (_m == Ordering::Greater)) { _match_value.emplace(std::move(std::make_tuple(rusty::Some(rusty::either::Left<L, R>(L(std::move(left)))), Right<L, L>(L(std::move(right)))))); _m_matched = true; } if (!_m_matched) { rusty::intrinsics::unreachable(); } std::move(_match_value).value(); });
        }
        template<typename L, typename R>
        static size_hint::SizeHint size_hint(size_hint::SizeHint left, size_hint::SizeHint right) {
...
namespace pad_tail {
    ...
    struct PadUsing {
        ...
        // Rust-only dependent associated type alias skipped in constrained mode: Item
        auto next() {
            return ({ auto&& _m = this->iter.next(); std::optional<std::remove_cvref_t<std::remove_cvref_t<decltype(([&]() {
...
}()))>>> _match_value; bool _m_matched = false; if (!_m_matched) { const auto& None = _m; _match_value.emplace(std::move([&]() {
if (this->pos < this->min) {
auto e = rusty::Some((this->filler)(this->pos));
[&]() { static_cast<void>(this->pos += 1); return std::make_tuple(); }();
return e;
...
}())); _m_matched = true; } if (!_m_matched) { const auto& e = _m; _match_value.emplace(std::move([&]() { [&]() { static_cast<void>(this->pos += 1); return std::make_tuple(); }();
return e; }())); _m_matched = true; } if (!_m_matched) { rusty::intrinsics::unreachable(); } std::move(_match_value).value(); });
        }
        std::tuple<size_t, rusty::Option<size_t>> size_hint() const {
...
return f(std::move(acc), std::move(item));
        ...
        auto next_back() {
            if (this->min == static_cast<size_t>(0)) {
                ...
                [&]() { static_cast<void>(this->min -= 1); return std::make_tuple(); }();
                return rusty::Option<rusty::detail::associated_item_t<I>>((this->filler)(this->min));
            }
        }
        template<typename B, typename G>
        B rfold(B init, G f) {
...
return rusty::Option<rusty::Vec<rusty::detail::associated_item_t<I>>>(rusty::slice(vals, 0, k).to_vec()); }(); } if (std::holds_alternative<std::variant_alternative_t<1, rusty::detail::variant_underlying_type_t<decltype(_m)>>>(_m)) { const auto& k = std::get<std::variant_alternative_t<1, rusty::detail::variant_underlying_type_t<decltype(_m)>>>(_m).k; auto&& min_n = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<1, rusty::detail::variant_underlying_type_t<decltype(_m)>>>(_m).min_n); return [&]() {
if (vals.get_next()) {
...
return rusty::Option<rusty::Vec<rusty::detail::associated_item_t<I>>>(std::move(item));
} else {
...
return rusty::Option<rusty::Vec<rusty::detail::associated_item_t<I>>>(vals.get_at(rusty::slice(indices, 0, k))); }(); } if (std::holds_alternative<std::variant_alternative_t<3, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))) { return rusty::Option<rusty::Vec<rusty::detail::associated_item_t<I>>>(rusty::None); } rusty::intrinsics::unreachable(); }();
        }
        size_t count() {
            auto&& _let_pat = (*this);
            auto&& vals = rusty::detail::deref_if_pointer(_let_pat.vals);
    ...
    struct Powerset {
        ...
        auto next() {
            if (auto&& _iflet_scrutinee = this->combs.next(); _iflet_scrutinee.is_some()) {
                decltype(auto) elt = _iflet_scrutinee.unwrap();
                return rusty::Option<rusty::Vec<rusty::detail::associated_item_t<I>>>(std::move(elt));
            ...
            while (true) {
                {
                    ...
                    if (!_m_matched) {
                        if (_m.is_ok()) {
                            ...
                            return rusty::Option<rusty::Vec<rusty::detail::associated_item_t<I>>>(item);
                            _m_matched = true;
                        }
                    }
                    if (!_m_matched) {
...
namespace tee {
    ...
    struct Tee {
        ...
        auto next() {
            ...
            return [&]() { auto&& _m = buffer.iter.next(); if (_m.is_none()) { return rusty::Option<rusty::detail::associated_item_t<I>>(rusty::None); } if (_m.is_some()) { auto&& _mv1 = _m.unwrap(); auto&& elt = rusty::detail::deref_if_pointer(_mv1); return [&]() { buffer.backlog.push_back(rusty::clone(elt));
buffer.owner = !this->id;
return rusty::Option<rusty::detail::associated_item_t<I>>(std::move(elt)); }(); } rusty::intrinsics::unreachable(); }();
        }
        std::tuple<size_t, rusty::Option<size_t>> size_hint() const {
            const auto buffer = this->rcbuffer.borrow();
    ...
    struct TupleBuffer {
        ...
        auto next() {
            ...
            if (auto&& _iflet_scrutinee = rusty::get_mut(s, this->cur); _iflet_scrutinee.is_some()) {
                ...
                return rusty::Option<rusty::detail::associated_item_t<T>>(rusty::None);
            }
        }
        std::tuple<size_t, rusty::Option<size_t>> size_hint() const {
...
return [&]() { auto&& _m = this->peekable.peek(); if (_m.is_some()) { return rusty::Option<std::tuple<Position, rusty::detail::associated_item_t<I>>>(std::make_tuple(with_position::Position_First(), std::move(item))); } if (_m.is_none()) { return rusty::Option<std::tuple<Position, rusty::detail::associated_item_t<I>>>(std::make_tuple(with_position::Position_Only(), std::move(item))); } rusty::intrinsics::unreachable(); }();
} else {
return [&]() { auto&& _m = this->peekable.peek(); if (_m.is_some()) { return rusty::Option<std::tuple<Position, rusty::detail::associated_item_t<I>>>(std::make_tuple(with_position::Position_Middle(), std::move(item))); } if (_m.is_none()) { return rusty::Option<std::tuple<Position, rusty::detail::associated_item_t<I>>>(std::make_tuple(with_position::Position_Last(), std::move(item))); } rusty::intrinsics::unreachable(); }();
}
}(); } if (_m.is_none()) { return rusty::Option<std::tuple<Position, rusty::detail::associated_item_t<I>>>(rusty::None); } rusty::intrinsics::unreachable(); }();
        }
        std::tuple<size_t, rusty::Option<size_t>> size_hint() const {
...
namespace zip_longest {
    ...
    struct ZipLongest {
        ...
        auto next_back() {
            return ({ auto&& _m = rusty::cmp::cmp(rusty::len(this->a), rusty::len(this->b)); std::optional<std::remove_cvref_t<std::remove_cvref_t<decltype(([&]() { auto&& _m0 = this->a.next_back(); auto&& _m1 = this->b.next_back(); if (_m0.is_none() && _m1.is_none()) { return rusty::None; } if (rusty::detail::deref_if_pointer(_m0).is_some() && rusty::detail::deref_if_pointer(_m1).is_some()) { auto&& a = rusty::detail::deref_if_pointer(std::as_const(rusty::detail::deref_if_pointer(_m0)).unwrap()); auto&& b = rusty::detail::deref_if_pointer(std::as_const(rusty::detail::deref_if_pointer(_m1)).unwrap()); return rusty::Option<either_or_both::EitherOrBoth<T, T>>(either_or_both::EitherOrBoth_Both<T, T>{a, b}); } if (rusty::detail::deref_if_pointer(_m0).is_some() && _m1.is_none()) { auto&& a = rusty::detail::deref_if_pointer(std::as_const(rusty::detail::deref_if_pointer(_m0)).unwrap()); return rusty::Option<either_or_both::EitherOrBoth<T, T>>(Left<T, T>(T(a))); } if (_m0.is_none() && rusty::detail::deref_if_pointer(_m1).is_some()) { auto&& b = rusty::detail::deref_if_pointer(std::as_const(rusty::detail::deref_if_pointer(_m1)).unwrap()); return rusty::Option<either_or_both::EitherOrBoth<T, T>>(Right<T, T>(T(b))); } rusty::intrinsics::unreachable(); }()))>>> _match_value; bool _m_matched = false; if (!_m_matched) { const auto& Equal = _m; _match_value.emplace(std::move([&]() { auto&& _m0 = this->a.next_back(); auto&& _m1 = this->b.next_back(); if (_m0.is_none() && _m1.is_none()) { return rusty::None; } if (rusty::detail::deref_if_pointer(_m0).is_some() && rusty::detail::deref_if_pointer(_m1).is_some()) { auto&& a = rusty::detail::deref_if_pointer(std::as_const(rusty::detail::deref_if_pointer(_m0)).unwrap()); auto&& b = rusty::detail::deref_if_pointer(std::as_const(rusty::detail::deref_if_pointer(_m1)).unwrap()); return rusty::Option<either_or_both::EitherOrBoth<T, T>>(either_or_both::EitherOrBoth_Both<T, T>{a, b}); } if (rusty::detail::deref_if_pointer(_m0).is_some() && _m1.is_none()) { auto&& a = rusty::detail::deref_if_pointer(std::as_const(rusty::detail::deref_if_pointer(_m0)).unwrap()); return rusty::Option<either_or_both::EitherOrBoth<T, T>>(Left<T, T>(T(a))); } if (_m0.is_none() && rusty::detail::deref_if_pointer(_m1).is_some()) { auto&& b = rusty::detail::deref_if_pointer(std::as_const(rusty::detail::deref_if_pointer(_m1)).unwrap()); return rusty::Option<either_or_both::EitherOrBoth<T, T>>(Right<T, T>(T(b))); } rusty::intrinsics::unreachable(); }())); _m_matched = true; } if (!_m_matched) { const auto& Greater = _m; _match_value.emplace(std::move(this->a.next_back().map([](auto&& _v) { return either_or_both::EitherOrBoth_Left<T, T>{std::forward<decltype(_v)>(_v)}; }))); _m_matched = true; } if (!_m_matched) { const auto& Less = _m; _match_value.emplace(std::move(this->b.next_back().map([](auto&& _v) { return either_or_both::EitherOrBoth_Right<T, T>{std::forward<decltype(_v)>(_v)}; }))); _m_matched = true; } if (!_m_matched) { rusty::intrinsics::unreachable(); } std::move(_match_value).value(); });
        }
        template<typename B, typename F>
        B rfold(B init, F f) {
            auto&& _let_pat = (*this);
...
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item>>(rusty::None); } std::move(_match_value).value(); });
            return rusty::Option<std::tuple<typename A::Item>>(std::make_tuple(A_shadow2));
        }
        template<typename A>
        std::tuple<size_t, rusty::Option<size_t>> size_hint() const {
        ...
        auto next() {
            ...
            auto A_shadow2 = ({ auto&& _m = A_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item>>(rusty::None); } std::move(_match_value).value(); });
...
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item>>(rusty::None); } std::move(_match_value).value(); });
            return rusty::Option<std::tuple<typename A::Item, typename B::Item>>(std::make_tuple(A_shadow2, B_shadow2));
        }
        template<typename A, typename B>
        std::tuple<size_t, rusty::Option<size_t>> size_hint() const {
            auto sh = std::make_tuple(std::numeric_limits<size_t>::max(), rusty::None);
        ...
        auto next() {
            ...
            auto A_shadow2 = ({ auto&& _m = A_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item>>(rusty::None); } std::move(_match_value).value(); });
            auto B_shadow2 = ({ auto&& _m = B_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item>>(rusty::None); } std::move(_match_value).value(); });
...
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item>>(rusty::None); } std::move(_match_value).value(); });
            return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item>>(std::make_tuple(A_shadow2, B_shadow2, C_shadow2));
        }
        template<typename A, typename B, typename C>
        std::tuple<size_t, rusty::Option<size_t>> size_hint() const {
            auto sh = std::make_tuple(std::numeric_limits<size_t>::max(), rusty::None);
        ...
        auto next() {
            ...
            auto A_shadow2 = ({ auto&& _m = A_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item>>(rusty::None); } std::move(_match_value).value(); });
            auto B_shadow2 = ({ auto&& _m = B_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item>>(rusty::None); } std::move(_match_value).value(); });
            auto C_shadow2 = ({ auto&& _m = C_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
...
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item>>(rusty::None); } std::move(_match_value).value(); });
            return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item>>(std::make_tuple(A_shadow2, B_shadow2, C_shadow2, D_shadow2));
        }
        template<typename A, typename B, typename C, typename D>
        std::tuple<size_t, rusty::Option<size_t>> size_hint() const {
            auto sh = std::make_tuple(std::numeric_limits<size_t>::max(), rusty::None);
        ...
        auto next() {
            ...
            auto A_shadow2 = ({ auto&& _m = A_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item>>(rusty::None); } std::move(_match_value).value(); });
            auto B_shadow2 = ({ auto&& _m = B_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item>>(rusty::None); } std::move(_match_value).value(); });
            auto C_shadow2 = ({ auto&& _m = C_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
...
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item>>(rusty::None); } std::move(_match_value).value(); });
            return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item>>(std::make_tuple(A_shadow2, B_shadow2, C_shadow2, D_shadow2, E_shadow2));
        }
        template<typename A, typename B, typename C, typename D, typename E>
        std::tuple<size_t, rusty::Option<size_t>> size_hint() const {
            auto sh = std::make_tuple(std::numeric_limits<size_t>::max(), rusty::None);
        ...
        auto next() {
            ...
            auto A_shadow2 = ({ auto&& _m = A_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item, typename F::Item>>(rusty::None); } std::move(_match_value).value(); });
            auto B_shadow2 = ({ auto&& _m = B_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item, typename F::Item>>(rusty::None); } std::move(_match_value).value(); });
            auto C_shadow2 = ({ auto&& _m = C_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
...
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item, typename F::Item>>(rusty::None); } std::move(_match_value).value(); });
            return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item, typename F::Item>>(std::make_tuple(A_shadow2, B_shadow2, C_shadow2, D_shadow2, E_shadow2, F_shadow2));
        }
        template<typename A, typename B, typename C, typename D, typename E, typename F>
        std::tuple<size_t, rusty::Option<size_t>> size_hint() const {
            auto sh = std::make_tuple(std::numeric_limits<size_t>::max(), rusty::None);
        ...
        auto next() {
            ...
            auto A_shadow2 = ({ auto&& _m = A_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item, typename F::Item, typename G::Item>>(rusty::None); } std::move(_match_value).value(); });
            auto B_shadow2 = ({ auto&& _m = B_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item, typename F::Item, typename G::Item>>(rusty::None); } std::move(_match_value).value(); });
            auto C_shadow2 = ({ auto&& _m = C_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
...
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item, typename F::Item, typename G::Item>>(rusty::None); } std::move(_match_value).value(); });
            return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item, typename F::Item, typename G::Item>>(std::make_tuple(A_shadow2, B_shadow2, C_shadow2, D_shadow2, E_shadow2, F_shadow2, G_shadow2));
        }
        template<typename A, typename B, typename C, typename D, typename E, typename F, typename G>
        std::tuple<size_t, rusty::Option<size_t>> size_hint() const {
            auto sh = std::make_tuple(std::numeric_limits<size_t>::max(), rusty::None);
        ...
        auto next() {
            ...
            auto A_shadow2 = ({ auto&& _m = A_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item, typename F::Item, typename G::Item, typename H::Item>>(rusty::None); } std::move(_match_value).value(); });
            auto B_shadow2 = ({ auto&& _m = B_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item, typename F::Item, typename G::Item, typename H::Item>>(rusty::None); } std::move(_match_value).value(); });
            auto C_shadow2 = ({ auto&& _m = C_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
...
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item, typename F::Item, typename G::Item, typename H::Item>>(rusty::None); } std::move(_match_value).value(); });
            return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item, typename F::Item, typename G::Item, typename H::Item>>(std::make_tuple(A_shadow2, B_shadow2, C_shadow2, D_shadow2, E_shadow2, F_shadow2, G_shadow2, H_shadow2));
        }
        template<typename A, typename B, typename C, typename D, typename E, typename F, typename G, typename H>
        std::tuple<size_t, rusty::Option<size_t>> size_hint() const {
            auto sh = std::make_tuple(std::numeric_limits<size_t>::max(), rusty::None);
        ...
        auto next() {
            ...
            auto A_shadow2 = ({ auto&& _m = A_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item, typename F::Item, typename G::Item, typename H::Item, typename I::Item>>(rusty::None); } std::move(_match_value).value(); });
            auto B_shadow2 = ({ auto&& _m = B_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item, typename F::Item, typename G::Item, typename H::Item, typename I::Item>>(rusty::None); } std::move(_match_value).value(); });
            auto C_shadow2 = ({ auto&& _m = C_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
...
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item, typename F::Item, typename G::Item, typename H::Item, typename I::Item>>(rusty::None); } std::move(_match_value).value(); });
            return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item, typename F::Item, typename G::Item, typename H::Item, typename I::Item>>(std::make_tuple(A_shadow2, B_shadow2, C_shadow2, D_shadow2, E_shadow2, F_shadow2, G_shadow2, H_shadow2, I_shadow2));
        }
        template<typename A, typename B, typename C, typename D, typename E, typename F, typename G, typename H, typename I>
        std::tuple<size_t, rusty::Option<size_t>> size_hint() const {
            auto sh = std::make_tuple(std::numeric_limits<size_t>::max(), rusty::None);
        ...
        auto next() {
            ...
            auto A_shadow2 = ({ auto&& _m = A_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item, typename F::Item, typename G::Item, typename H::Item, typename I::Item, typename J::Item>>(rusty::None); } std::move(_match_value).value(); });
            auto B_shadow2 = ({ auto&& _m = B_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item, typename F::Item, typename G::Item, typename H::Item, typename I::Item, typename J::Item>>(rusty::None); } std::move(_match_value).value(); });
            auto C_shadow2 = ({ auto&& _m = C_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
...
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item, typename F::Item, typename G::Item, typename H::Item, typename I::Item, typename J::Item>>(rusty::None); } std::move(_match_value).value(); });
            return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item, typename F::Item, typename G::Item, typename H::Item, typename I::Item, typename J::Item>>(std::make_tuple(A_shadow2, B_shadow2, C_shadow2, D_shadow2, E_shadow2, F_shadow2, G_shadow2, H_shadow2, I_shadow2, J_shadow2));
        }
        template<typename A, typename B, typename C, typename D, typename E, typename F, typename G, typename H, typename I, typename J>
        std::tuple<size_t, rusty::Option<size_t>> size_hint() const {
            auto sh = std::make_tuple(std::numeric_limits<size_t>::max(), rusty::None);
        ...
        auto next() {
            ...
            auto A_shadow2 = ({ auto&& _m = A_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item, typename F::Item, typename G::Item, typename H::Item, typename I::Item, typename J::Item, typename K::Item>>(rusty::None); } std::move(_match_value).value(); });
            auto B_shadow2 = ({ auto&& _m = B_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item, typename F::Item, typename G::Item, typename H::Item, typename I::Item, typename J::Item, typename K::Item>>(rusty::None); } std::move(_match_value).value(); });
            auto C_shadow2 = ({ auto&& _m = C_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
...
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item, typename F::Item, typename G::Item, typename H::Item, typename I::Item, typename J::Item, typename K::Item>>(rusty::None); } std::move(_match_value).value(); });
            return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item, typename F::Item, typename G::Item, typename H::Item, typename I::Item, typename J::Item, typename K::Item>>(std::make_tuple(A_shadow2, B_shadow2, C_shadow2, D_shadow2, E_shadow2, F_shadow2, G_shadow2, H_shadow2, I_shadow2, J_shadow2, K_shadow2));
        }
        template<typename A, typename B, typename C, typename D, typename E, typename F, typename G, typename H, typename I, typename J, typename K>
        std::tuple<size_t, rusty::Option<size_t>> size_hint() const {
            auto sh = std::make_tuple(std::numeric_limits<size_t>::max(), rusty::None);
        ...
        auto next() {
            ...
            auto A_shadow2 = ({ auto&& _m = A_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item, typename F::Item, typename G::Item, typename H::Item, typename I::Item, typename J::Item, typename K::Item, typename L::Item>>(rusty::None); } std::move(_match_value).value(); });
            auto B_shadow2 = ({ auto&& _m = B_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item, typename F::Item, typename G::Item, typename H::Item, typename I::Item, typename J::Item, typename K::Item, typename L::Item>>(rusty::None); } std::move(_match_value).value(); });
            auto C_shadow2 = ({ auto&& _m = C_shadow1.next(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
...
auto&& elt = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(elt)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item, typename F::Item, typename G::Item, typename H::Item, typename I::Item, typename J::Item, typename K::Item, typename L::Item>>(rusty::None); } std::move(_match_value).value(); });
            return rusty::Option<std::tuple<typename A::Item, typename B::Item, typename C::Item, typename D::Item, typename E::Item, typename F::Item, typename G::Item, typename H::Item, typename I::Item, typename J::Item, typename K::Item, typename L::Item>>(std::make_tuple(A_shadow2, B_shadow2, C_shadow2, D_shadow2, E_shadow2, F_shadow2, G_shadow2, H_shadow2, I_shadow2, J_shadow2, K_shadow2, L_shadow2));
        }
        template<typename A, typename B, typename C, typename D, typename E, typename F, typename G, typename H, typename I, typename J, typename K, typename L>
        std::tuple<size_t, rusty::Option<size_t>> size_hint() const {
            auto sh = std::make_tuple(std::numeric_limits<size_t>::max(), rusty::None);
...
namespace k_smallest {
    ...
    rusty::Vec<rusty::detail::associated_item_t<I>> k_smallest_general(I iter, size_t k, F comparator) {
        ...
        for (auto&& i : rusty::for_in(rusty::rev((rusty::range_inclusive(0, (rusty::len(storage) / 2)))))) {
            sift_down(storage, is_less_than, std::move(i));
        }
...
if (is_less_than(val, &storage[0])) {
    ...
    sift_down(storage, is_less_than, static_cast<size_t>(0));
}
});
        ...
        while (rusty::len(heap) > 1) {
            ...
            sift_down(heap, is_less_than, static_cast<size_t>(0));
        }
        return storage;
    }
...
namespace kmerge_impl {
    ...
    void heapify(std::span<T> data, S less_than) {
        for (auto&& i : rusty::for_in(rusty::rev((rusty::range(0, rusty::len(data) / 2))))) {
            sift_down(data, std::move(i), less_than);
        }
    }
    ...
    KMergeBy<typename rusty::detail::associated_item_t<I>::IntoIter, F> kmerge_by(I iterable, F less_than) {
        ...
        heapify(heap, [&](auto&& a, auto&& b) { return ([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::kmerge_impl::rusty_ext::kmerge_pred(std::forward<decltype(__self)>(__self), a.head, b.head); }) { return ::kmerge_impl::rusty_ext::kmerge_pred(std::forward<decltype(__self)>(__self), a.head, b.head); } else { return ::kmerge_impl::rusty_ext::kmerge_pred(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), a.head, b.head); } })(less_than); });
