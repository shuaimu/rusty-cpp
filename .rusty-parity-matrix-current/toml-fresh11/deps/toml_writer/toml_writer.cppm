...
namespace integer {
    ...
    struct TomlInteger {
        ...
        rusty::fmt::Result write_toml_value(W& writer) const {
            return write_toml_value(this->value, rusty::detail::deref_if_pointer_like(this->format), rusty::detail::deref_if_pointer_like(writer));
        }
    };
...
namespace key {
    ...
    namespace rusty_ext {
        ...
        rusty::String to_toml_key(const T& self_) {
            ...
            static_cast<void>(::key::rusty_ext::write_toml_key(self_, rusty::detail::deref_if_pointer_like(result)));
            return result;
        }
...
namespace value {
    ...
    namespace rusty_ext {
        ...
        rusty::String to_toml_value(const T& self_) {
            using Self = std::remove_reference_t<decltype(self_)>;
            auto result = std::conditional_t<true, rusty::String, T>::new_();
            static_cast<void>(::value::rusty_ext::write_toml_value(self_, rusty::detail::deref_if_pointer_like(result)));
            return result;
        }
