...
namespace ser {
    ...
    struct SerializerRuntimeHelper {
        ...
        static auto collect_seq(auto self_, auto iter) -> rusty::Result<typename std::remove_reference_t<decltype(self_)>::Ok, typename std::remove_reference_t<decltype(self_)>::Error> {
            ...
            auto serializer = ({ auto&& _m = self_.serialize_seq(iterator_len_hint(iter_shadow1)); std::optional<std::remove_cvref_t<decltype(([&]() -> decltype(auto) { auto _mv = _m.unwrap();
auto&& val = _mv;
return (val); })())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
...
return rusty::Result<typename Self_::Ok, typename Self_::Error>::Err(std::move(err)); } std::move(_match_value).value(); });
        ...
        static auto collect_map(auto self_, auto iter) -> rusty::Result<typename std::remove_reference_t<decltype(self_)>::Ok, typename std::remove_reference_t<decltype(self_)>::Error> {
            using Self_ = std::remove_reference_t<decltype(self_)>;
            auto iter_shadow1 = iter.into_iter();
            auto serializer = ({ auto&& _m = self_.serialize_map(iterator_len_hint(iter_shadow1)); std::optional<std::remove_cvref_t<decltype(([&]() -> decltype(auto) { auto _mv = _m.unwrap();
auto&& val = _mv;
return (val); })())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
...
namespace de {
    ...
    namespace value {
        ...
        struct SeqDeserializer {
            ...
            rusty::Result<typename V::Value, Error> deserialize_any(V visitor) {
                auto v = ({ auto&& _m = visitor.visit_seq((*this)); std::optional<std::remove_cvref_t<decltype(([&]() -> decltype(auto) { auto _mv = _m.unwrap();
auto&& val = _mv;
return (val); })())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
...
return rusty::Option<std::tuple<de::value::private_::First<rusty::detail::associated_item_t<I>>, de::value::private_::Second<rusty::detail::associated_item_t<I>>>>((std::move(kv)).split()); }(); } if (_m.is_none()) { return rusty::Option<std::tuple<de::value::private_::First<rusty::detail::associated_item_t<I>>, de::value::private_::Second<rusty::detail::associated_item_t<I>>>>(rusty::None); } return [&]() -> rusty::Option<std::tuple<de::value::private_::First<rusty::detail::associated_item_t<I>>, de::value::private_::Second<rusty::detail::associated_item_t<I>>>> { rusty::intrinsics::unreachable(); }(); }();
            ...
            template<typename V>
            rusty::Result<typename V::Value, Error> deserialize_any(V visitor) {
                auto value = ({ auto&& _m = visitor.visit_map((*this)); std::optional<std::remove_cvref_t<decltype(([&]() -> decltype(auto) { auto _mv = _m.unwrap();
auto&& val = _mv;
return (val); })())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
...
return rusty::Result<typename V::Value, Error>::Err(std::move(err)); } std::move(_match_value).value(); });
            ...
            rusty::Result<typename V::Value, Error> deserialize_seq(V visitor) {
                auto value = ({ auto&& _m = visitor.visit_seq((*this)); std::optional<std::remove_cvref_t<decltype(([&]() -> decltype(auto) { auto _mv = _m.unwrap();
auto&& val = _mv;
return (val); })())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
...
auto value_shadow1 = ({ auto&& _m = ::de::rusty_ext::deserialize(vseed, ([&](auto&& _into_deser_recv) -> decltype(auto) { if constexpr (requires { ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else if constexpr (requires { ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else { return std::forward<decltype(_into_deser_recv)>(_into_deser_recv).into_deserializer(); } })(std::move(value))); std::optional<std::remove_cvref_t<decltype(([&]() -> decltype(auto) { auto _mv = _m.unwrap();
auto&& val = _mv;
return (val); })())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
...
return ::de::rusty_ext::deserialize(seed, std::move(de_shadow1)).map(rusty::Some); }(); } if (_m.is_none()) { return rusty::Result<rusty::Option<typename T::Value>, Error>::Ok(rusty::Option<typename T::Value>(rusty::None)); } return [&]() -> rusty::Result<rusty::Option<typename T::Value>, Error> { rusty::intrinsics::unreachable(); }(); }();
        ...
        struct PairDeserializer {
            ...
            rusty::Result<typename V::Value, Error> deserialize_seq(V visitor) {
                ...
                auto pair = ({ auto&& _m = visitor.visit_seq(pair_visitor); std::optional<std::remove_cvref_t<decltype(([&]() -> decltype(auto) { auto _mv = _m.unwrap();
auto&& val = _mv;
return (val); })())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
...
return rusty::Result<typename V::Value, Error>::Err(std::move(err)); } std::move(_match_value).value(); });
        ...
        struct MapAccessDeserializer {
            ...
            rusty::Result<std::tuple<typename T::Value, Variant>, typename A::Error> variant_seed(T seed) {
                return [&]() -> rusty::Result<std::tuple<typename T::Value, Variant>, typename A::Error> { auto&& _m = ({ auto&& _m = this->map.next_key_seed(std::move(seed)); std::optional<std::remove_cvref_t<decltype(([&]() -> decltype(auto) { auto _mv = _m.unwrap();
auto&& val = _mv;
return (val); })())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
        ...
        struct ArrayInPlaceVisitor {
            ...
            rusty::Result<Value, typename A::Error> visit_seq(A seq) {
                ...
                for (auto&& _for_item : rusty::for_in(rusty::enumerate(rusty::iter_mut(rusty::slice_full(this->_0))))) {
                    ...
                    if (({ auto&& _m = seq.next_element_seed(::private_::seed::InPlaceSeed(std::move(dest))); std::optional<std::remove_cvref_t<decltype(([&]() -> decltype(auto) { auto _mv = _m.unwrap();
auto&& val = _mv;
return (val); })())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
...
return rusty::Result<Value, typename A::Error>::Err(std::move(err)); } std::move(_match_value).value(); }).is_none()) {
    ...
    End
            ...
            struct RangeVisitor {
                ...
                template<typename A>
                rusty::Result<Value, typename A::Error> visit_seq(A seq) {
                    Idx start = ({ auto&& _m = ({ auto&& _m = seq.next_element(); std::optional<std::remove_cvref_t<decltype(([&]() -> decltype(auto) { auto _mv = _m.unwrap();
auto&& val = _mv;
return (val); })())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
...
_match_value.emplace(std::move(value)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Result<Value, typename A::Error>::Err(A::Error::invalid_length(0, (*this))); } std::move(_match_value).value(); });
                    Idx end = ({ auto&& _m = ({ auto&& _m = seq.next_element(); std::optional<std::remove_cvref_t<decltype(([&]() -> decltype(auto) { auto _mv = _m.unwrap();
auto&& val = _mv;
return (val); })())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
...
_match_value.emplace(std::move(value)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Result<Value, typename A::Error>::Err(A::Error::invalid_length(1, (*this))); } std::move(_match_value).value(); });
                ...
                rusty::Result<Value, typename A::Error> visit_map(A map) {
                    ...
                    while (true) {
                        auto&& _whilelet = ({ auto&& _m = map.next_key(); std::optional<std::remove_cvref_t<decltype(([&]() -> decltype(auto) { auto _mv = _m.unwrap();
auto&& val = _mv;
return (val); })())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
    ...
    namespace impls {
        ...
        namespace rusty_ext {
            ...
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::range<Idx>& self_, S serializer) {
                using Self = std::remove_reference_t<decltype(self_)>;
                // Rust-only: using ser::SerializeStruct;
                auto state = ({ auto&& _m = serializer.serialize_struct(std::string_view("Range"), static_cast<size_t>(2)); std::optional<std::remove_cvref_t<decltype(([&]() -> decltype(auto) { auto _mv = _m.unwrap();
auto&& val = _mv;
return (val); })())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
...
return rusty::Result<typename S::Ok, typename S::Error>::Err(std::move(err)); } std::move(_match_value).value(); });
            ...
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::range_from<Idx>& self_, S serializer) {
                using Self = std::remove_reference_t<decltype(self_)>;
                // Rust-only: using ser::SerializeStruct;
                auto state = ({ auto&& _m = serializer.serialize_struct(std::string_view("RangeFrom"), static_cast<size_t>(1)); std::optional<std::remove_cvref_t<decltype(([&]() -> decltype(auto) { auto _mv = _m.unwrap();
auto&& val = _mv;
return (val); })())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
...
return rusty::Result<typename S::Ok, typename S::Error>::Err(std::move(err)); } std::move(_match_value).value(); });
            ...
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::range_inclusive<Idx>& self_, S serializer) {
                using Self = std::remove_reference_t<decltype(self_)>;
                // Rust-only: using ser::SerializeStruct;
                auto state = ({ auto&& _m = serializer.serialize_struct(std::string_view("RangeInclusive"), static_cast<size_t>(2)); std::optional<std::remove_cvref_t<decltype(([&]() -> decltype(auto) { auto _mv = _m.unwrap();
auto&& val = _mv;
return (val); })())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
...
return rusty::Result<typename S::Ok, typename S::Error>::Err(std::move(err)); } std::move(_match_value).value(); });
            ...
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::range_to<Idx>& self_, S serializer) {
                using Self = std::remove_reference_t<decltype(self_)>;
                // Rust-only: using ser::SerializeStruct;
                auto state = ({ auto&& _m = serializer.serialize_struct(std::string_view("RangeTo"), static_cast<size_t>(1)); std::optional<std::remove_cvref_t<decltype(([&]() -> decltype(auto) { auto _mv = _m.unwrap();
auto&& val = _mv;
return (val); })())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
...
return rusty::Result<typename S::Ok, typename S::Error>::Err(std::move(err)); } std::move(_match_value).value(); });
            ...
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::time::Duration& self_, S serializer) {
                using Self = std::remove_reference_t<decltype(self_)>;
                // Rust-only: using ser::SerializeStruct;
                auto state = ({ auto&& _m = serializer.serialize_struct(std::string_view("Duration"), static_cast<size_t>(2)); std::optional<std::remove_cvref_t<decltype(([&]() -> decltype(auto) { auto _mv = _m.unwrap();
auto&& val = _mv;
return (val); })())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
...
return rusty::Result<typename S::Ok, typename S::Error>::Err(std::move(err)); } std::move(_match_value).value(); });
            ...
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::time::SystemTime& self_, S serializer) {
                using Self = std::remove_reference_t<decltype(self_)>;
                // Rust-only: using ser::SerializeStruct;
                const auto duration_since_epoch = ({ auto&& _m = self_.duration_since(::rusty::time::UNIX_EPOCH); std::optional<std::remove_cvref_t<decltype(([&]() -> decltype(auto) { auto _mv = _m.unwrap();
auto&& duration_since_epoch = _mv;
return (duration_since_epoch); })())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& duration_since_epoch = _mv;
...
return rusty::Result<typename S::Ok, typename S::Error>::Err(S::Error::custom("SystemTime must be later than UNIX_EPOCH")); } std::move(_match_value).value(); });
                auto state = ({ auto&& _m = serializer.serialize_struct(std::string_view("SystemTime"), static_cast<size_t>(2)); std::optional<std::remove_cvref_t<decltype(([&]() -> decltype(auto) { auto _mv = _m.unwrap();
auto&& val = _mv;
return (val); })())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
...
namespace de::ignored_any {
        ...
        rusty::Result<IgnoredAny, typename A::Error> IgnoredAny::visit_seq(A seq) {
            using Value = typename IgnoredAny::Value;
            while (true) {
                auto&& _whilelet = ({ auto&& _m = seq.next_element(); std::optional<std::remove_cvref_t<decltype(([&]() -> decltype(auto) { auto _mv = _m.unwrap();
auto&& val = _mv;
return (val); })())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
...
namespace de::ignored_any {
        ...
        rusty::Result<IgnoredAny, typename A::Error> IgnoredAny::visit_map(A map) {
            using Value = typename IgnoredAny::Value;
            while (true) {
                auto&& _whilelet = ({ auto&& _m = map.next_entry(); std::optional<std::remove_cvref_t<decltype(([&]() -> decltype(auto) { auto _mv = _m.unwrap();
auto&& val = _mv;
return (val); })())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
...
namespace de::ignored_any {
        ...
        rusty::Result<IgnoredAny, typename A::Error> IgnoredAny::visit_enum(A data) {
            using Value = typename IgnoredAny::Value;
            return ({ auto&& _m = data.template variant<IgnoredAny>(); std::optional<std::remove_cvref_t<decltype(([&]() -> decltype(auto) { auto _mv = _m.unwrap();
auto&& val = _mv;
return (val); })())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
...
namespace de::ignored_any {
        ...
        auto IgnoredAny::deserialize_in_place(D deserializer, IgnoredAny& place) -> rusty::Result<std::tuple<>, typename D::Error> {
            using Value = typename IgnoredAny::Value;
            place = ({ auto&& _m = std::conditional_t<true, IgnoredAny, D>::deserialize(std::move(deserializer)); std::optional<std::remove_cvref_t<decltype(([&]() -> decltype(auto) { auto _mv = _m.unwrap();
auto&& val = _mv;
return (val); })())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
...
namespace de::impls {
        ...
        rusty::Result<std::tuple<>, E> StringInPlaceVisitor::visit_byte_buf(rusty::Vec<uint8_t> v) {
            using Value = typename StringInPlaceVisitor::Value;
            return [&]() -> rusty::Result<std::tuple<>, E> { auto&& _m = std::conditional_t<true, rusty::String, E>::from_utf8(std::move(v)); if (_m.is_ok()) { auto&& _mv0 = _m.unwrap(); auto&& s = _mv0; return [&]() -> rusty::Result<std::tuple<>, E> { this->_0 = std::move(s);
...
namespace de::impls {
        ...
        rusty::Result<rusty::ffi::OsString, typename A::Error> OsStringVisitor::visit_enum(A data) {
            ...
            return [&]() { auto&& _m = ({ auto&& _m = data.variant(); std::optional<std::remove_cvref_t<decltype(([&]() -> decltype(auto) { auto _mv = _m.unwrap();
auto&& val = _mv;
return (val); })())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
