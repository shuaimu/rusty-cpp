...
return [&]() { auto&& _m = root; return std::visit(overloaded { [&](Value_Table&& _v) { auto&& table = rusty::detail::deref_if_pointer(_v._0); return table_shadow1; }, [&](auto&&) { return (static_cast<void>(rusty::panicking::panic("internal error: entered unreachable code")), rusty::intrinsics::unreachable()); } }, std::move(_m)); }(); }();
