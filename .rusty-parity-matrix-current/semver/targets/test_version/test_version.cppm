...
void test_eq() {
    {
        auto&& _m0_tmp = util::version(std::string_view("1.2.3"));
        auto _m0 = &_m0_tmp;
        auto&& _m1_tmp = util::version(std::string_view("1.2.3"));
        auto _m1 = &_m1_tmp;
        auto _m_tuple = std::make_tuple(_m0, _m1);
        bool _m_matched = false;
        if (!_m_matched) {
    ...
    {
        auto&& _m0_tmp = util::version(std::string_view("1.2.3-alpha1"));
        auto _m0 = &_m0_tmp;
        auto&& _m1_tmp = util::version(std::string_view("1.2.3-alpha1"));
        auto _m1 = &_m1_tmp;
        auto _m_tuple = std::make_tuple(_m0, _m1);
        bool _m_matched = false;
        if (!_m_matched) {
    ...
    {
        auto&& _m0_tmp = util::version(std::string_view("1.2.3+build.42"));
        auto _m0 = &_m0_tmp;
        auto&& _m1_tmp = util::version(std::string_view("1.2.3+build.42"));
        auto _m1 = &_m1_tmp;
        auto _m_tuple = std::make_tuple(_m0, _m1);
        bool _m_matched = false;
        if (!_m_matched) {
    ...
    {
        auto&& _m0_tmp = util::version(std::string_view("1.2.3-alpha1+42"));
        auto _m0 = &_m0_tmp;
        auto&& _m1_tmp = util::version(std::string_view("1.2.3-alpha1+42"));
        auto _m1 = &_m1_tmp;
        auto _m_tuple = std::make_tuple(_m0, _m1);
        bool _m_matched = false;
        if (!_m_matched) {
