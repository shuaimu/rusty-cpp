...
namespace encoder {
    ...
    rusty::Result<Value, toml_test_harness::Error> from_decoded(const toml_test_harness::DecodedValue& decoded) {
        auto value = [&]() { auto&& _m = decoded; return std::visit(overloaded { [&](const toml_test_harness::DecodedValue_Scalar& _v) { auto&& value = _v._0; return RUSTY_TRY_INTO(from_decoded_scalar(std::move(value)), rusty::Result<Value, toml_test_harness::Error>); }, [&](const toml_test_harness::DecodedValue_Table& _v) { auto&& value = _v._0; return Value::Table(RUSTY_TRY_INTO(from_table(std::move(value)), rusty::Result<Value, toml_test_harness::Error>)); }, [&](const toml_test_harness::DecodedValue_Array& _v) { auto&& value = _v._0; return Value::Array(RUSTY_TRY_INTO(from_array(value), rusty::Result<Value, toml_test_harness::Error>)); } }, _m); }();
        return rusty::Result<Value, toml_test_harness::Error>::Ok(std::move(value));
    }

    rusty::Result<Value, toml_test_harness::Error> from_decoded_scalar(const toml_test_harness::DecodedScalar& decoded) {
        return [&]() { auto&& _m = decoded; return std::visit(overloaded { [&](const toml_test_harness::DecodedScalar_String& _v) -> rusty::Result<Value, toml_test_harness::Error> { auto&& value = _v._0; return rusty::Result<Value, toml_test_harness::Error>::Ok(Value::String(rusty::clone(value))); }, [&](const toml_test_harness::DecodedScalar_Integer& _v) -> rusty::Result<Value, toml_test_harness::Error> { auto&& value = _v._0; return rusty::str_runtime::parse<int64_t>(value).map_err(toml_test_harness::Error::new_).map([&](auto&& _v) -> Value { return Value::Integer(std::forward<decltype(_v)>(_v)); }); }, [&](const toml_test_harness::DecodedScalar_Float& _v) -> rusty::Result<Value, toml_test_harness::Error> { auto&& value = _v._0; return rusty::str_runtime::parse<double>(value).map_err(toml_test_harness::Error::new_).map([&](auto&& _v) -> Value { return Value::Float(std::forward<decltype(_v)>(_v)); }); }, [&](const toml_test_harness::DecodedScalar_Bool& _v) -> rusty::Result<Value, toml_test_harness::Error> { auto&& value = _v._0; return bool::from_str(rusty::to_string_view(value)).map_err(toml_test_harness::Error::new_).map([&](auto&& _v) -> Value { return Value::Boolean(std::forward<decltype(_v)>(_v)); }); }, [&](const toml_test_harness::DecodedScalar_Datetime& _v) -> rusty::Result<Value, toml_test_harness::Error> { auto&& value = _v._0; return value::Datetime::from_str(rusty::to_string_view(value)).map_err(toml_test_harness::Error::new_).map([&](auto&& _v) -> Value { return Value::Datetime(std::forward<decltype(_v)>(_v)); }); }, [&](const toml_test_harness::DecodedScalar_DatetimeLocal& _v) -> rusty::Result<Value, toml_test_harness::Error> { auto&& value = _v._0; return value::Datetime::from_str(rusty::to_string_view(value)).map_err(toml_test_harness::Error::new_).map([&](auto&& _v) -> Value { return Value::Datetime(std::forward<decltype(_v)>(_v)); }); }, [&](const toml_test_harness::DecodedScalar_DateLocal& _v) -> rusty::Result<Value, toml_test_harness::Error> { auto&& value = _v._0; return value::Datetime::from_str(rusty::to_string_view(value)).map_err(toml_test_harness::Error::new_).map([&](auto&& _v) -> Value { return Value::Datetime(std::forward<decltype(_v)>(_v)); }); }, [&](const toml_test_harness::DecodedScalar_TimeLocal& _v) -> rusty::Result<Value, toml_test_harness::Error> { auto&& value = _v._0; return value::Datetime::from_str(rusty::to_string_view(value)).map_err(toml_test_harness::Error::new_).map([&](auto&& _v) -> Value { return Value::Datetime(std::forward<decltype(_v)>(_v)); }); } }, _m); }();
    }
...
namespace encoder {
    rusty::Result<rusty::String, toml_test_harness::Error> Encoder::encode(toml_test_harness::DecodedValue data) const {
        ...
        auto&& _let_pat = value;
        auto&& document = rusty::detail::deref_if_pointer(_let_pat)._0;
