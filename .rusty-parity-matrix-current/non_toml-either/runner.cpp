...
struct Either : std::variant<Either_Left<L, R>, Either_Right<L, R>> {
    ...
    auto next() {
        return [&]() { auto&& _m = (*this); if (std::holds_alternative<::Either_Left<L, R>>(rusty::detail::deref_if_pointer(_m))) { auto& inner = std::get<::Either_Left<L, R>>(rusty::detail::deref_if_pointer(_m))._0; return inner.next(); } if (std::holds_alternative<::Either_Right<L, R>>(rusty::detail::deref_if_pointer(_m))) { auto& inner = std::get<::Either_Right<L, R>>(rusty::detail::deref_if_pointer(_m))._0; return inner.next(); } rusty::intrinsics::unreachable(); }();
    }
    ...
    auto last() {
        return [&]() { auto&& _m = (*this); if (std::holds_alternative<::Either_Left<L, R>>(rusty::detail::deref_if_pointer(_m))) { auto&& inner = rusty::detail::deref_if_pointer(std::get<::Either_Left<L, R>>(rusty::detail::deref_if_pointer(_m))._0); return inner.last(); } if (std::holds_alternative<::Either_Right<L, R>>(rusty::detail::deref_if_pointer(_m))) { auto&& inner = rusty::detail::deref_if_pointer(std::get<::Either_Right<L, R>>(rusty::detail::deref_if_pointer(_m))._0); return inner.last(); } rusty::intrinsics::unreachable(); }();
    }
    auto nth(size_t n) {
        return [&]() { auto&& _m = (*this); if (std::holds_alternative<::Either_Left<L, R>>(rusty::detail::deref_if_pointer(_m))) { auto& inner = std::get<::Either_Left<L, R>>(rusty::detail::deref_if_pointer(_m))._0; return inner.nth(std::move(n)); } if (std::holds_alternative<::Either_Right<L, R>>(rusty::detail::deref_if_pointer(_m))) { auto& inner = std::get<::Either_Right<L, R>>(rusty::detail::deref_if_pointer(_m))._0; return inner.nth(std::move(n)); } rusty::intrinsics::unreachable(); }();
    }
    template<typename B>
    B collect() {
    ...
    auto next_back() {
        return [&]() { auto&& _m = (*this); if (std::holds_alternative<::Either_Left<L, R>>(rusty::detail::deref_if_pointer(_m))) { auto& inner = std::get<::Either_Left<L, R>>(rusty::detail::deref_if_pointer(_m))._0; return inner.next_back(); } if (std::holds_alternative<::Either_Right<L, R>>(rusty::detail::deref_if_pointer(_m))) { auto& inner = std::get<::Either_Right<L, R>>(rusty::detail::deref_if_pointer(_m))._0; return inner.next_back(); } rusty::intrinsics::unreachable(); }();
    }
    auto nth_back(size_t n) {
        return [&]() { auto&& _m = (*this); if (std::holds_alternative<::Either_Left<L, R>>(rusty::detail::deref_if_pointer(_m))) { auto& inner = std::get<::Either_Left<L, R>>(rusty::detail::deref_if_pointer(_m))._0; return inner.nth_back(std::move(n)); } if (std::holds_alternative<::Either_Right<L, R>>(rusty::detail::deref_if_pointer(_m))) { auto& inner = std::get<::Either_Right<L, R>>(rusty::detail::deref_if_pointer(_m))._0; return inner.nth_back(std::move(n)); } rusty::intrinsics::unreachable(); }();
    }
    template<typename Acc, typename G>
    ...
    auto rfind(P predicate) {
        return [&]() { auto&& _m = (*this); if (std::holds_alternative<::Either_Left<L, R>>(rusty::detail::deref_if_pointer(_m))) { auto& inner = std::get<::Either_Left<L, R>>(rusty::detail::deref_if_pointer(_m))._0; return inner.rfind(std::move(predicate)); } if (std::holds_alternative<::Either_Right<L, R>>(rusty::detail::deref_if_pointer(_m))) { auto& inner = std::get<::Either_Right<L, R>>(rusty::detail::deref_if_pointer(_m))._0; return inner.rfind(std::move(predicate)); } rusty::intrinsics::unreachable(); }();
    }
    size_t len() const {
    ...
    auto poll(rusty::Context& cx) {
        return [&]() { auto&& _m = this->as_pin_mut(); if (std::holds_alternative<::Either_Left<L, R>>(rusty::detail::deref_if_pointer(_m))) { auto&& inner = rusty::detail::deref_if_pointer(std::get<::Either_Left<L, R>>(rusty::detail::deref_if_pointer(_m))._0); return inner.poll(cx); } if (std::holds_alternative<::Either_Right<L, R>>(rusty::detail::deref_if_pointer(_m))) { auto&& inner = rusty::detail::deref_if_pointer(std::get<::Either_Right<L, R>>(rusty::detail::deref_if_pointer(_m))._0); return inner.poll(cx); } rusty::intrinsics::unreachable(); }();
    }
    ...
    decltype(auto) operator*() const {
        return [&]() { auto&& _m = (*this); if (std::holds_alternative<::Either_Left<L, R>>(rusty::detail::deref_if_pointer(_m))) { const auto& inner = std::get<::Either_Left<L, R>>(rusty::detail::deref_if_pointer(_m))._0; return rusty::deref_ref(rusty::deref_ref(inner)); } if (std::holds_alternative<::Either_Right<L, R>>(rusty::detail::deref_if_pointer(_m))) { const auto& inner = std::get<::Either_Right<L, R>>(rusty::detail::deref_if_pointer(_m))._0; return rusty::deref_ref(rusty::deref_ref(inner)); } rusty::intrinsics::unreachable(); }();
    }
...
namespace iterator {
    ...
    struct IterEither {
        ...
        template<typename P>
        auto find(P predicate) {
            return [&]() { auto&& _m = &this->inner; if (std::holds_alternative<Either_Left<L, R>>(rusty::detail::deref_if_pointer(_m))) { auto&& inner = rusty::detail::deref_if_pointer(std::get<Either_Left<L, R>>(rusty::detail::deref_if_pointer(_m))._0); return rusty::find(inner.map([](auto&& _v) { return rusty::either::Left<L, R>(std::forward<decltype(_v)>(_v)); }), predicate); } if (std::holds_alternative<Either_Right<L, R>>(rusty::detail::deref_if_pointer(_m))) { auto&& inner = rusty::detail::deref_if_pointer(std::get<Either_Right<L, R>>(rusty::detail::deref_if_pointer(_m))._0); return rusty::find(inner.map([](auto&& _v) { return rusty::either::Right<L, R>(std::forward<decltype(_v)>(_v)); }), predicate); } rusty::intrinsics::unreachable(); }();
        }
        template<typename B, typename F>
        rusty::Option<B> find_map(F f) {
        ...
        template<typename P>
        auto rfind(P predicate) {
            return [&]() { auto&& _m = &this->inner; if (std::holds_alternative<Either_Left<L, R>>(rusty::detail::deref_if_pointer(_m))) { auto&& inner = rusty::detail::deref_if_pointer(std::get<Either_Left<L, R>>(rusty::detail::deref_if_pointer(_m))._0); return inner.map([](auto&& _v) { return rusty::either::Left<L, R>(std::forward<decltype(_v)>(_v)); }).rfind(std::move(predicate)); } if (std::holds_alternative<Either_Right<L, R>>(rusty::detail::deref_if_pointer(_m))) { auto&& inner = rusty::detail::deref_if_pointer(std::get<Either_Right<L, R>>(rusty::detail::deref_if_pointer(_m))._0); return inner.map([](auto&& _v) { return rusty::either::Right<L, R>(std::forward<decltype(_v)>(_v)); }).rfind(std::move(predicate)); } rusty::intrinsics::unreachable(); }();
        }
        size_t len() const {
