...
namespace ser {
    ...
    struct SerializerRuntimeHelper {
        ...
        static auto collect_seq(auto self_, auto iter) -> rusty::Result<typename std::remove_reference_t<decltype(self_)>::Ok, typename std::remove_reference_t<decltype(self_)>::Error> {
            ...
            auto serializer = ({ auto&& _m = self_.serialize_seq(iterator_len_hint(iter_shadow1)); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
...
return rusty::Result<typename Self_::Ok, typename Self_::Error>::Err(err); } std::move(_match_value).value(); });
            {
                auto&& _m = iter_shadow1.try_for_each([&](auto&& item) { return serializer.serialize_element(item); });
        ...
        static auto collect_map(auto self_, auto iter) -> rusty::Result<typename std::remove_reference_t<decltype(self_)>::Ok, typename std::remove_reference_t<decltype(self_)>::Error> {
            using Self_ = std::remove_reference_t<decltype(self_)>;
            auto iter_shadow1 = iter.into_iter();
            auto serializer = ({ auto&& _m = self_.serialize_map(iterator_len_hint(iter_shadow1)); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
auto&& err = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
return rusty::Result<typename Self_::Ok, typename Self_::Error>::Err(err); } std::move(_match_value).value(); });
...
namespace de {
    ...
    namespace value {
        ...
        struct CowStrDeserializer {
            ...
            template<typename V>
            rusty::Result<typename V::Value, Error> deserialize_any(V visitor) {
                return [&]() -> rusty::Result<typename V::Value, Error> { auto&& _m = this->value; if (std::holds_alternative<rusty::Cow_Borrowed>(rusty::detail::deref_if_pointer(_m))) { auto&& string = rusty::detail::deref_if_pointer(std::get<rusty::Cow_Borrowed>(rusty::detail::deref_if_pointer(_m))._0); return visitor.visit_str(rusty::to_string_view(string)); } if (std::holds_alternative<rusty::Cow_Owned>(rusty::detail::deref_if_pointer(_m))) { auto&& string = rusty::detail::deref_if_pointer(std::get<rusty::Cow_Owned>(rusty::detail::deref_if_pointer(_m))._0); return visitor.visit_string(string); } return [&]() -> rusty::Result<typename V::Value, Error> { rusty::intrinsics::unreachable(); }(); }();
            }
            template<typename V>
            rusty::Result<typename V::Value, Error> deserialize_enum(std::string_view name, std::span<const std::string_view> variants, V visitor) {
                static_cast<void>(name);
...
return ::de::rusty_ext::deserialize(seed, ([&](auto&& _into_deser_recv) -> decltype(auto) { if constexpr (requires { ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else if constexpr (requires { ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else { return std::forward<decltype(_into_deser_recv)>(_into_deser_recv).into_deserializer(); } })(std::move(value))).map(rusty::Some); }(); } if (_m.is_none()) { return rusty::Result<rusty::Option<typename V::Value>, Error>::Ok(rusty::Option<typename V::Value>(rusty::None)); } return [&]() -> rusty::Result<rusty::Option<typename V::Value>, Error> { rusty::intrinsics::unreachable(); }(); }();
        ...
        struct MapDeserializer {
            ...
            auto next_pair() -> rusty::Option<std::tuple<de::value::private_::First<rusty::detail::associated_item_t<I>>, de::value::private_::Second<rusty::detail::associated_item_t<I>>>> {
...
return ::de::rusty_ext::deserialize(seed, ([&](auto&& _into_deser_recv) -> decltype(auto) { if constexpr (requires { ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else if constexpr (requires { ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else { return std::forward<decltype(_into_deser_recv)>(_into_deser_recv).into_deserializer(); } })(std::move(key))).map(rusty::Some); }(); } if (_m.is_none()) { return rusty::Result<rusty::Option<typename T::Value>, Error>::Ok(rusty::Option<typename T::Value>(rusty::None)); } return [&]() -> rusty::Result<rusty::Option<typename T::Value>, Error> { rusty::intrinsics::unreachable(); }(); }();
            ...
            rusty::Result<typename T::Value, Error> next_value_seed(T seed) {
                ...
                return ::de::rusty_ext::deserialize(seed, ([&](auto&& _into_deser_recv) -> decltype(auto) { if constexpr (requires { ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else if constexpr (requires { ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else { return std::forward<decltype(_into_deser_recv)>(_into_deser_recv).into_deserializer(); } })(std::move(value_shadow1)));
            }
            template<typename TK, typename TV>
            rusty::Result<rusty::Option<std::tuple<typename TK::Value, typename TV::Value>>, Error> next_entry_seed(TK kseed, TV vseed) {
                return [&]() -> rusty::Result<rusty::Option<std::tuple<typename TK::Value, typename TV::Value>>, Error> { auto&& _m = this->next_pair(); if (_m.is_some()) { auto&& _mv0 = _m.unwrap(); auto&& key = rusty::detail::deref_if_pointer(std::get<0>(rusty::detail::deref_if_pointer(_mv0))); auto&& value = rusty::detail::deref_if_pointer(std::get<1>(rusty::detail::deref_if_pointer(_mv0))); return [&]() -> rusty::Result<rusty::Option<std::tuple<typename TK::Value, typename TV::Value>>, Error> { auto key_shadow1 = ({ auto&& _m = ::de::rusty_ext::deserialize(kseed, ([&](auto&& _into_deser_recv) -> decltype(auto) { if constexpr (requires { ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else if constexpr (requires { ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else { return std::forward<decltype(_into_deser_recv)>(_into_deser_recv).into_deserializer(); } })(std::move(key))); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
auto&& err = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
return rusty::Result<rusty::Option<std::tuple<typename TK::Value, typename TV::Value>>, Error>::Err(err); } std::move(_match_value).value(); });
auto value_shadow1 = ({ auto&& _m = ::de::rusty_ext::deserialize(vseed, ([&](auto&& _into_deser_recv) -> decltype(auto) { if constexpr (requires { ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else if constexpr (requires { ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else { return std::forward<decltype(_into_deser_recv)>(_into_deser_recv).into_deserializer(); } })(std::move(value))); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
auto&& err = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
return rusty::Result<rusty::Option<std::tuple<typename TK::Value, typename TV::Value>>, Error>::Err(err); } std::move(_match_value).value(); });
...
return rusty::Result<std::tuple<typename T::Value, Variant>, typename A::Error>::Err(err); } std::move(_match_value).value(); }); if (_m.is_some()) { auto&& _mv0 = _m.unwrap(); auto&& key = rusty::detail::deref_if_pointer(_mv0); return rusty::Result<std::tuple<typename T::Value, Variant>, typename A::Error>::Ok(std::make_tuple(std::move(key), private_::map_as_enum(std::move(this->map)))); } if (_m.is_none()) { return rusty::Result<std::tuple<typename T::Value, Variant>, typename A::Error>::Err(A::Error::invalid_type(::de::Unexpected_Map{}, "enum")); } return [&]() -> rusty::Result<std::tuple<typename T::Value, Variant>, typename A::Error> { rusty::intrinsics::unreachable(); }(); }();
    ...
    namespace ignored_any {
        ...
        struct IgnoredAny {
            ...
            template<typename D>
            static auto deserialize(D deserializer) -> rusty::Result<IgnoredAny, typename D::Error>;
            template<typename D>
            static auto deserialize_in_place(D deserializer, IgnoredAny& place) -> rusty::Result<std::tuple<>, typename D::Error>;
        };
        ...
        struct ArrayInPlaceVisitor {
            ...
            rusty::Result<Value, typename A::Error> visit_seq(A seq) {
                ...
                for (auto&& _for_item : rusty::for_in(rusty::enumerate(rusty::iter_mut(rusty::slice_full(this->_0))))) {
                    ...
                    if (({ auto&& _m = seq.next_element_seed(::private_::seed::InPlaceSeed(std::move(dest))); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
auto&& err = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
...
namespace ser {
    ...
    namespace impls {
        ...
        namespace rusty_ext {
            ...
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::Option<T>& self_, S serializer) {
                using Self = std::remove_reference_t<decltype(self_)>;
                return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { auto&& _m = self_; if (_m.is_some()) { auto&& _mv0 = std::as_const(_m).unwrap(); const auto& value = _mv0; return serializer.serialize_some(value); } if (_m.is_none()) { return serializer.serialize_none(); } return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { rusty::intrinsics::unreachable(); }(); }();
            }
...
return rusty::Result<typename S::Ok, typename S::Error>::Err(err); } std::move(_match_value).value(); });
                {
                    auto&& _m = state.serialize_field("end", self_.end);
                    bool _m_matched = false;
                    if (!_m_matched) {
                        if (_m.is_ok()) {
                            auto&& _mv0 = _m.unwrap();
            ...
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::Bound<T>& self_, S serializer) {
                using Self = std::remove_reference_t<decltype(self_)>;
                return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { auto&& _m = self_; if (std::holds_alternative<rusty::Bound_Unbounded>(rusty::detail::deref_if_pointer(_m))) { return serializer.serialize_unit_variant(std::string_view("Bound"), static_cast<uint32_t>(0), std::string_view("Unbounded")); } if (std::holds_alternative<rusty::Bound_Included>(rusty::detail::deref_if_pointer(_m))) { const auto& value = std::get<rusty::Bound_Included>(rusty::detail::deref_if_pointer(_m))._0; return serializer.serialize_newtype_variant(std::string_view("Bound"), static_cast<uint32_t>(1), std::string_view("Included"), value); } if (std::holds_alternative<rusty::Bound_Excluded>(rusty::detail::deref_if_pointer(_m))) { const auto& value = std::get<rusty::Bound_Excluded>(rusty::detail::deref_if_pointer(_m))._0; return serializer.serialize_newtype_variant(std::string_view("Bound"), static_cast<uint32_t>(2), std::string_view("Excluded"), value); } return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { rusty::intrinsics::unreachable(); }(); }();
            }
            ...
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::RefCell<T>& self_, S serializer) {
                using Self = std::remove_reference_t<decltype(self_)>;
                return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { auto&& _m = self_.try_borrow(); if (_m.is_ok()) { auto&& _mv0 = _m.unwrap(); auto&& value = rusty::detail::deref_if_pointer(_mv0); return ::ser::impls::rusty_ext::serialize(value, std::move(serializer)); } if (_m.is_err()) { return rusty::Result<typename S::Ok, typename S::Error>::Err(S::Error::custom("already mutably borrowed")); } return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { rusty::intrinsics::unreachable(); }(); }();
            }

            template<typename S, typename T>
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::Mutex<T>& self_, S serializer) {
                using Self = std::remove_reference_t<decltype(self_)>;
                return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { auto&& _m = self_.lock(); if (_m.is_ok()) { auto&& _mv0 = _m.unwrap(); auto&& locked = rusty::detail::deref_if_pointer(_mv0); return ::ser::impls::rusty_ext::serialize(locked, std::move(serializer)); } if (_m.is_err()) { return rusty::Result<typename S::Ok, typename S::Error>::Err(S::Error::custom("lock poison error while serializing")); } return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { rusty::intrinsics::unreachable(); }(); }();
            }

            template<typename S, typename T>
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::RwLock<T>& self_, S serializer) {
                using Self = std::remove_reference_t<decltype(self_)>;
                return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { auto&& _m = self_.read(); if (_m.is_ok()) { auto&& _mv0 = _m.unwrap(); auto&& locked = rusty::detail::deref_if_pointer(_mv0); return ::ser::impls::rusty_ext::serialize(locked, std::move(serializer)); } if (_m.is_err()) { return rusty::Result<typename S::Ok, typename S::Error>::Err(S::Error::custom("lock poison error while serializing")); } return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { rusty::intrinsics::unreachable(); }(); }();
            }

            template<typename S, typename T, typename E>
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::Result<T, E>& self_, S serializer) {
                using Self = std::remove_reference_t<decltype(self_)>;
                return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { auto&& _m = self_; if (_m.is_ok()) { auto&& _mv0 = std::as_const(_m).unwrap(); const auto& value = _mv0; return serializer.serialize_newtype_variant(std::string_view("Result"), static_cast<uint32_t>(0), std::string_view("Ok"), value); } if (_m.is_err()) { auto&& _mv1 = std::as_const(_m).unwrap_err(); const auto& value = _mv1; return serializer.serialize_newtype_variant(std::string_view("Result"), static_cast<uint32_t>(1), std::string_view("Err"), value); } return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { rusty::intrinsics::unreachable(); }(); }();
            }
...
return rusty::Result<typename S::Ok, typename S::Error>::Err(err); } std::move(_match_value).value(); });
            ...
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::net::IpAddr& self_, S serializer) {
                ...
                if (serializer.is_human_readable()) {
                    return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { auto&& _m = self_; if (std::holds_alternative<rusty::net::IpAddr_V4>(rusty::detail::deref_if_pointer(_m))) { const auto& a = std::get<rusty::net::IpAddr_V4>(rusty::detail::deref_if_pointer(_m))._0; return ::ser::impls::rusty_ext::serialize(a, std::move(serializer)); } if (std::holds_alternative<rusty::net::IpAddr_V6>(rusty::detail::deref_if_pointer(_m))) { const auto& a = std::get<rusty::net::IpAddr_V6>(rusty::detail::deref_if_pointer(_m))._0; return ::ser::impls::rusty_ext::serialize(a, std::move(serializer)); } return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { rusty::intrinsics::unreachable(); }(); }();
                } else {
                    return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { auto&& _m = self_; if (std::holds_alternative<rusty::net::IpAddr_V4>(rusty::detail::deref_if_pointer(_m))) { const auto& a = std::get<rusty::net::IpAddr_V4>(rusty::detail::deref_if_pointer(_m))._0; return serializer.serialize_newtype_variant(std::string_view("IpAddr"), static_cast<uint32_t>(0), std::string_view("V4"), a); } if (std::holds_alternative<rusty::net::IpAddr_V6>(rusty::detail::deref_if_pointer(_m))) { const auto& a = std::get<rusty::net::IpAddr_V6>(rusty::detail::deref_if_pointer(_m))._0; return serializer.serialize_newtype_variant(std::string_view("IpAddr"), static_cast<uint32_t>(1), std::string_view("V6"), a); } return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { rusty::intrinsics::unreachable(); }(); }();
                }
            }
            ...
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::net::SocketAddr& self_, S serializer) {
                using Self = std::remove_reference_t<decltype(self_)>;
                if (serializer.is_human_readable()) {
                    return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { auto&& _m = self_; if (std::holds_alternative<rusty::net::SocketAddr_V4>(rusty::detail::deref_if_pointer(_m))) { const auto& addr = std::get<rusty::net::SocketAddr_V4>(rusty::detail::deref_if_pointer(_m))._0; return ::ser::impls::rusty_ext::serialize(addr, std::move(serializer)); } if (std::holds_alternative<rusty::net::SocketAddr_V6>(rusty::detail::deref_if_pointer(_m))) { const auto& addr = std::get<rusty::net::SocketAddr_V6>(rusty::detail::deref_if_pointer(_m))._0; return ::ser::impls::rusty_ext::serialize(addr, std::move(serializer)); } return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { rusty::intrinsics::unreachable(); }(); }();
                } else {
                    return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { auto&& _m = self_; if (std::holds_alternative<rusty::net::SocketAddr_V4>(rusty::detail::deref_if_pointer(_m))) { const auto& addr = std::get<rusty::net::SocketAddr_V4>(rusty::detail::deref_if_pointer(_m))._0; return serializer.serialize_newtype_variant(std::string_view("SocketAddr"), static_cast<uint32_t>(0), std::string_view("V4"), addr); } if (std::holds_alternative<rusty::net::SocketAddr_V6>(rusty::detail::deref_if_pointer(_m))) { const auto& addr = std::get<rusty::net::SocketAddr_V6>(rusty::detail::deref_if_pointer(_m))._0; return serializer.serialize_newtype_variant(std::string_view("SocketAddr"), static_cast<uint32_t>(1), std::string_view("V6"), addr); } return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { rusty::intrinsics::unreachable(); }(); }();
                }
            }
...
namespace de {
    bool Unexpected::operator==(const Unexpected& other) const {
        ...
        return (__self_discr == __arg1_discr) && [&]() -> bool { auto&& _m0 = (*this); auto&& _m1 = other; if (std::holds_alternative<Unexpected_Bool>(rusty::detail::deref_if_pointer(_m0)) && std::holds_alternative<Unexpected_Bool>(rusty::detail::deref_if_pointer(_m1))) { auto&& __self_0 = rusty::detail::deref_if_pointer(std::get<Unexpected_Bool>(rusty::detail::deref_if_pointer(_m0))._0); auto&& __arg1_0 = rusty::detail::deref_if_pointer(std::get<Unexpected_Bool>(rusty::detail::deref_if_pointer(_m1))._0); return __self_0 == __arg1_0; } if (std::holds_alternative<Unexpected_Unsigned>(rusty::detail::deref_if_pointer(_m0)) && std::holds_alternative<Unexpected_Unsigned>(rusty::detail::deref_if_pointer(_m1))) { auto&& __self_0 = rusty::detail::deref_if_pointer(std::get<Unexpected_Unsigned>(rusty::detail::deref_if_pointer(_m0))._0); auto&& __arg1_0 = rusty::detail::deref_if_pointer(std::get<Unexpected_Unsigned>(rusty::detail::deref_if_pointer(_m1))._0); return __self_0 == __arg1_0; } if (std::holds_alternative<Unexpected_Signed>(rusty::detail::deref_if_pointer(_m0)) && std::holds_alternative<Unexpected_Signed>(rusty::detail::deref_if_pointer(_m1))) { auto&& __self_0 = rusty::detail::deref_if_pointer(std::get<Unexpected_Signed>(rusty::detail::deref_if_pointer(_m0))._0); auto&& __arg1_0 = rusty::detail::deref_if_pointer(std::get<Unexpected_Signed>(rusty::detail::deref_if_pointer(_m1))._0); return __self_0 == __arg1_0; } if (std::holds_alternative<Unexpected_Float>(rusty::detail::deref_if_pointer(_m0)) && std::holds_alternative<Unexpected_Float>(rusty::detail::deref_if_pointer(_m1))) { auto&& __self_0 = rusty::detail::deref_if_pointer(std::get<Unexpected_Float>(rusty::detail::deref_if_pointer(_m0))._0); auto&& __arg1_0 = rusty::detail::deref_if_pointer(std::get<Unexpected_Float>(rusty::detail::deref_if_pointer(_m1))._0); return __self_0 == __arg1_0; } if (std::holds_alternative<Unexpected_Char>(rusty::detail::deref_if_pointer(_m0)) && std::holds_alternative<Unexpected_Char>(rusty::detail::deref_if_pointer(_m1))) { auto&& __self_0 = rusty::detail::deref_if_pointer(std::get<Unexpected_Char>(rusty::detail::deref_if_pointer(_m0))._0); auto&& __arg1_0 = rusty::detail::deref_if_pointer(std::get<Unexpected_Char>(rusty::detail::deref_if_pointer(_m1))._0); return __self_0 == __arg1_0; } if (std::holds_alternative<Unexpected_Str>(rusty::detail::deref_if_pointer(_m0)) && std::holds_alternative<Unexpected_Str>(rusty::detail::deref_if_pointer(_m1))) { auto&& __self_0 = rusty::detail::deref_if_pointer(std::get<Unexpected_Str>(rusty::detail::deref_if_pointer(_m0))._0); auto&& __arg1_0 = rusty::detail::deref_if_pointer(std::get<Unexpected_Str>(rusty::detail::deref_if_pointer(_m1))._0); return __self_0 == __arg1_0; } if (std::holds_alternative<Unexpected_Bytes>(rusty::detail::deref_if_pointer(_m0)) && std::holds_alternative<Unexpected_Bytes>(rusty::detail::deref_if_pointer(_m1))) { auto&& __self_0 = rusty::detail::deref_if_pointer(std::get<Unexpected_Bytes>(rusty::detail::deref_if_pointer(_m0))._0); auto&& __arg1_0 = rusty::detail::deref_if_pointer(std::get<Unexpected_Bytes>(rusty::detail::deref_if_pointer(_m1))._0); return __self_0 == __arg1_0; } if (std::holds_alternative<Unexpected_Other>(rusty::detail::deref_if_pointer(_m0)) && std::holds_alternative<Unexpected_Other>(rusty::detail::deref_if_pointer(_m1))) { auto&& __self_0 = rusty::detail::deref_if_pointer(std::get<Unexpected_Other>(rusty::detail::deref_if_pointer(_m0))._0); auto&& __arg1_0 = rusty::detail::deref_if_pointer(std::get<Unexpected_Other>(rusty::detail::deref_if_pointer(_m1))._0); return __self_0 == __arg1_0; } if (true) { return true; } return [&]() -> bool { rusty::intrinsics::unreachable(); }(); }();
    }
}
...
namespace de {
    rusty::fmt::Result Unexpected::fmt(rusty::fmt::Formatter& formatter) const {
        ...
        return [&]() -> rusty::fmt::Result { auto&& _m = (*this); if (std::holds_alternative<Unexpected_Bool>(rusty::detail::deref_if_pointer(_m))) { auto&& b = rusty::detail::deref_if_pointer(std::get<Unexpected_Bool>(rusty::detail::deref_if_pointer(_m))._0); return rusty::write_fmt(formatter, std::format("boolean `{0}`", rusty::to_string(b))); } if (std::holds_alternative<Unexpected_Unsigned>(rusty::detail::deref_if_pointer(_m))) { auto&& i = rusty::detail::deref_if_pointer(std::get<Unexpected_Unsigned>(rusty::detail::deref_if_pointer(_m))._0); return rusty::write_fmt(formatter, std::format("integer `{0}`", rusty::to_string(i))); } if (std::holds_alternative<Unexpected_Signed>(rusty::detail::deref_if_pointer(_m))) { auto&& i = rusty::detail::deref_if_pointer(std::get<Unexpected_Signed>(rusty::detail::deref_if_pointer(_m))._0); return rusty::write_fmt(formatter, std::format("integer `{0}`", rusty::to_string(i))); } if (std::holds_alternative<Unexpected_Float>(rusty::detail::deref_if_pointer(_m))) { auto&& f = rusty::detail::deref_if_pointer(std::get<Unexpected_Float>(rusty::detail::deref_if_pointer(_m))._0); return rusty::write_fmt(formatter, std::format("floating point `{0}`", rusty::to_string(WithDecimalPoint(f)))); } if (std::holds_alternative<Unexpected_Char>(rusty::detail::deref_if_pointer(_m))) { auto&& c = rusty::detail::deref_if_pointer(std::get<Unexpected_Char>(rusty::detail::deref_if_pointer(_m))._0); return rusty::write_fmt(formatter, std::format("character `{0}`", rusty::to_string(c))); } if (std::holds_alternative<Unexpected_Str>(rusty::detail::deref_if_pointer(_m))) { auto&& s = rusty::detail::deref_if_pointer(std::get<Unexpected_Str>(rusty::detail::deref_if_pointer(_m))._0); return rusty::write_fmt(formatter, std::format("string {0}", rusty::to_debug_string(s))); } if (std::holds_alternative<Unexpected_Bytes>(rusty::detail::deref_if_pointer(_m))) { return formatter.write_str(std::string_view("byte array")); } if (true) { const auto& Unit = _m; return formatter.write_str(std::string_view("unit value")); } if (true) { const auto& Option = _m; return formatter.write_str(std::string_view("Option value")); } if (true) { const auto& NewtypeStruct = _m; return formatter.write_str(std::string_view("newtype struct")); } if (true) { const auto& Seq = _m; return formatter.write_str(std::string_view("sequence")); } if (true) { const auto& Map = _m; return formatter.write_str(std::string_view("map")); } if (true) { const auto& Enum = _m; return formatter.write_str(std::string_view("enum")); } if (true) { const auto& UnitVariant = _m; return formatter.write_str(std::string_view("unit variant")); } if (true) { const auto& NewtypeVariant = _m; return formatter.write_str(std::string_view("newtype variant")); } if (true) { const auto& TupleVariant = _m; return formatter.write_str(std::string_view("tuple variant")); } if (true) { const auto& StructVariant = _m; return formatter.write_str(std::string_view("struct variant")); } if (std::holds_alternative<Unexpected_Other>(rusty::detail::deref_if_pointer(_m))) { auto&& other = rusty::detail::deref_if_pointer(std::get<Unexpected_Other>(rusty::detail::deref_if_pointer(_m))._0); return formatter.write_str(rusty::to_string_view(other)); } return [&]() -> rusty::fmt::Result { rusty::intrinsics::unreachable(); }(); }();
    }
}
...
namespace de::ignored_any {
        template<typename D>
        auto IgnoredAny::deserialize(D deserializer) -> rusty::Result<IgnoredAny, typename D::Error> {
            using Value = typename IgnoredAny::Value;
...
namespace de::ignored_any {
        template<typename D>
        auto IgnoredAny::deserialize_in_place(D deserializer, IgnoredAny& place) -> rusty::Result<std::tuple<>, typename D::Error> {
            using Value = typename IgnoredAny::Value;
...
return rusty::Result<std::tuple<>, E>::Ok(std::make_tuple()); }(); } if (_m.is_err()) { return rusty::Result<std::tuple<>, E>::Err(E::invalid_value(de::Unexpected::Bytes(v), (*this))); } return [&]() -> rusty::Result<std::tuple<>, E> { rusty::intrinsics::unreachable(); }(); }();
        }
}
...
namespace de::impls {
        ...
        rusty::Result<std::string_view, E> StrVisitor::visit_borrowed_bytes(std::span<const uint8_t> v) {
            using Value = typename StrVisitor::Value;
            return rusty::str_runtime::from_utf8(v).map_err([&](auto&& _err) -> E { return ([&](auto _closure_wild0) { return E::invalid_value(de::Unexpected::Bytes(v), (*this)); }) (std::forward<decltype(_err)>(_err)); });
        }
}
...
namespace de::impls {
        ...
        rusty::Result<const rusty::path::Path&, E> PathVisitor::visit_borrowed_bytes(std::span<const uint8_t> v) {
            using Value = typename PathVisitor::Value;
            return rusty::str_runtime::from_utf8(v).map([&](auto&& _v) -> const rusty::path::Path& { return rusty::as_ref_into<const rusty::path::Path&>(std::forward<decltype(_v)>(_v)); }).map_err([&](auto&& _err) -> E { return ([&](auto _closure_wild0) { return E::invalid_value(de::Unexpected::Bytes(v), (*this)); }) (std::forward<decltype(_err)>(_err)); });
        }
}
...
namespace de::impls {
        ...
        rusty::Result<rusty::path::PathBuf, E> PathBufVisitor::visit_bytes(std::span<const uint8_t> v) {
            using Value = typename PathBufVisitor::Value;
            return rusty::str_runtime::from_utf8(v).map([&](auto&& _v) -> rusty::path::PathBuf { return rusty::from_into<rusty::path::PathBuf>(std::forward<decltype(_v)>(_v)); }).map_err([&](auto&& _err) -> E { return ([&](auto _closure_wild0) { return E::invalid_value(de::Unexpected::Bytes(v), (*this)); }) (std::forward<decltype(_err)>(_err)); });
        }
}
