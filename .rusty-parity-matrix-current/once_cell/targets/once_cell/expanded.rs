...
mod imp {
        ...
        pub(crate) unsafe fn get_unchecked(&self) -> &T {
            if true {
                if !self.is_initialized() {
                    ::core::panicking::panic("assertion failed: self.is_initialized()")
                }
            }
    ...
    mod tests {
        ...
        extern crate test;
        #[rustc_test_marker = "imp::tests::smoke_once"]
        #[doc(hidden)]
        pub const smoke_once: test::TestDescAndFn = test::TestDescAndFn {
            desc: test::TestDesc {
                name: test::StaticTestName("imp::tests::smoke_once"),
                ignore: false,
                ignore_message: ::core::option::Option::None,
                source_file: "src/imp_std.rs",
                start_line: 305usize,
                start_col: 8usize,
                end_line: 305usize,
                end_col: 18usize,
            ...
            testfn: test::StaticTestFn(
                #[coverage(off)]
                || test::assert_test_result(smoke_once()),
            ),
        };
        fn smoke_once() {
        ...
        extern crate test;
        #[rustc_test_marker = "imp::tests::stampede_once"]
        #[doc(hidden)]
        pub const stampede_once: test::TestDescAndFn = test::TestDescAndFn {
            desc: test::TestDesc {
                name: test::StaticTestName("imp::tests::stampede_once"),
                ignore: false,
                ignore_message: ::core::option::Option::None,
                source_file: "src/imp_std.rs",
                start_line: 315usize,
            ...
            testfn: test::StaticTestFn(
                #[coverage(off)]
                || test::assert_test_result(stampede_once()),
            ),
        };
        fn stampede_once() {
            static O: OnceCell<()> = OnceCell::new();
            ...
            for _ in 0..10 {
                ...
                thread::spawn(move || {
                    ...
                    unsafe {
                        O.init(|| {
                            if !!RUN {
                                ::core::panicking::panic("assertion failed: !RUN")
                            }
                            RUN = true;
                        });
                        if !RUN {
        ...
        extern crate test;
        #[rustc_test_marker = "imp::tests::poison_bad"]
        #[doc(hidden)]
        pub const poison_bad: test::TestDescAndFn = test::TestDescAndFn {
            desc: test::TestDesc {
                name: test::StaticTestName("imp::tests::poison_bad"),
                ignore: false,
                ignore_message: ::core::option::Option::None,
                source_file: "src/imp_std.rs",
                start_line: 351usize,
            ...
            testfn: test::StaticTestFn(
                #[coverage(off)]
                || test::assert_test_result(poison_bad()),
            ),
        };
        fn poison_bad() {
            static O: OnceCell<()> = OnceCell::new();
            let t = panic::catch_unwind(|| {
                O.init(|| ::core::panicking::panic("explicit panic"));
            });
            if !t.is_err() {
            ...
            if !called {
                ::core::panicking::panic("assertion failed: called")
            }
            O.init(|| {});
        }
        extern crate test;
        #[rustc_test_marker = "imp::tests::wait_for_force_to_finish"]
        #[doc(hidden)]
        pub const wait_for_force_to_finish: test::TestDescAndFn = test::TestDescAndFn {
            desc: test::TestDesc {
                name: test::StaticTestName("imp::tests::wait_for_force_to_finish"),
                ignore: false,
                ignore_message: ::core::option::Option::None,
                source_file: "src/imp_std.rs",
                start_line: 372usize,
            ...
            testfn: test::StaticTestFn(
                #[coverage(off)]
                || test::assert_test_result(wait_for_force_to_finish()),
            ),
        };
        fn wait_for_force_to_finish() {
            ...
            tx2.send(()).unwrap();
            if !t1.join().is_ok() {
                ::core::panicking::panic("assertion failed: t1.join().is_ok()")
            }
            if !t2.join().is_ok() {
                ::core::panicking::panic("assertion failed: t2.join().is_ok()")
            }
        }
        extern crate test;
        #[rustc_test_marker = "imp::tests::test_size"]
        #[doc(hidden)]
        pub const test_size: test::TestDescAndFn = test::TestDescAndFn {
            desc: test::TestDesc {
                name: test::StaticTestName("imp::tests::test_size"),
                ignore: false,
                ignore_message: ::core::option::Option::None,
                source_file: "src/imp_std.rs",
                start_line: 410usize,
        ...
        fn test_size() {
            use std::mem::size_of;
            match (&size_of::<OnceCell<u32>>(), &(4 * size_of::<u32>())) {
                (left_val, right_val) => {
                    if !(*left_val == *right_val) {
                        let kind = ::core::panicking::AssertKind::Eq;
                        ::core::panicking::assert_failed(
...
pub mod unsync {
    ...
    impl<T> OnceCell<T> {
            ...
            F: FnOnce() -> Result<T, E>,
        {
            ...
            let val = f()?;
            if !self.set(val).is_ok() {
                {
                    ::core::panicking::panic_fmt(format_args!("reentrant init"));
                }
            }
                    ...
                    init.take()
                        .unwrap_or_else(|| {
                            ::core::panicking::panic_fmt(
                                format_args!("Lazy instance has previously been poisoned"),
                            );
                        })
                })
        }
...
pub mod sync {
    ...
    impl<T> OnceCell<T> {
        ...
        pub fn wait(&self) -> &T {
            ...
            if true {
                if !self.0.is_initialized() {
                    ::core::panicking::panic("assertion failed: self.0.is_initialized()")
                }
            }
...
pub mod race {
    ...
    #[automatically_derived]
    impl ::core::default::Default for OnceNonZeroUsize {
        #[inline]
    ...
    #[automatically_derived]
    impl ::core::fmt::Debug for OnceNonZeroUsize {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
    ...
    impl OnceNonZeroUsize {
        ...
        pub unsafe fn get_unchecked(&self) -> NonZeroUsize {
            ...
            fn as_const_ptr(r: &AtomicUsize) -> *const usize {
                ...
                const _ALIGNMENT_COMPATIBLE: () = if !(align_of::<AtomicUsize>()
                    % align_of::<usize>() == 0)
                {
                    ::core::panicking::panic(
                        "assertion failed: align_of::<AtomicUsize>() % align_of::<usize>() == 0",
                    )
                };
                p.cast::<usize>()
            }
    ...
    #[automatically_derived]
    impl ::core::default::Default for OnceBool {
        #[inline]
        fn default() -> OnceBool {
            OnceBool {
                inner: ::core::default::Default::default(),
    ...
    impl<'a, T> core::fmt::Debug for OnceRef<'a, T> {
        fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
            f.write_fmt(format_args!("OnceRef({0:?})", self.inner))
        }
    }
    ...
    mod once_box {
        ...
        impl<T> core::fmt::Debug for OnceBox<T> {
            fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                f.write_fmt(
                    format_args!("OnceBox({0:?})", self.inner.load(Ordering::Relaxed)),
                )
            }
        }
