...
namespace spanned {
    ...
    struct Spanned {
        ...
        rusty::fmt::Result fmt(rusty::fmt::Formatter& fmt) const {
            return ::de::rusty_ext::fmt(this->get_ref(), rusty::detail::deref_if_pointer_like(fmt));
        }
        ...
        bool operator==(const Spanned<T>& other) const {
            return this->value.eq(rusty::detail::deref_if_pointer_like(other.value));
        }
        template<typename H>
        void hash(H& state) const {
            rusty::hash::hash(this->value, rusty::detail::deref_if_pointer_like(state));
        }
