                  ...
                  - [ ] Leaf 4.15.4.3.3.3.3: Re-run full seven-crate matrix after 4.15.4.3.3.3.2 and mark Leaf 4 complete only when all seven crates pass
                    ...
                    - [ ] Leaf 4.15.4.3.3.3.3.3: Re-run full seven-crate matrix after 4.15.4.3.3.3.3.2 and mark Leaf 4 complete only when all seven crates pass
                      ...
                      - [ ] Leaf 4.15.4.3.3.3.3.3.6: Collapse next deterministic `arrayvec` Stage D blocker family after 4.15.4.3.3.3.3.3.5.3 (`std::any::Any` import-path lowering, `Formatter::write_fmt` runtime surface, and `MaybeUninit` omitted-template associated-value recovery first), then re-run full seven-crate matrix
                        - [ ] Leaf 4.15.4.3.3.3.3.3.6.1: Collapse the first deterministic core trio generically (no crate-specific scripts): `std::any` import/path mapping, `rusty::fmt::Formatter::write_fmt` fallback/runtime support, and omitted-template associated static-call recovery for `MaybeUninit::uninit()` owner paths.
