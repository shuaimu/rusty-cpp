                ...
                - [ ] Leaf 4.15.4.3.3.3: Re-run full seven-crate matrix after 4.15.4.3.3.2 and mark Leaf 4 complete only when all seven crates pass
                  ...
                  - [ ] Leaf 4.15.4.3.3.3.3: Re-run full seven-crate matrix after 4.15.4.3.3.3.2 and mark Leaf 4 complete only when all seven crates pass
                    ...
                    - [ ] Leaf 4.15.4.3.3.3.3.3: Re-run full seven-crate matrix after 4.15.4.3.3.3.3.2 and mark Leaf 4 complete only when all seven crates pass
                      ...
                      - [ ] Leaf 4.15.4.3.3.3.3.3.7: Collapse the next deterministic `arrayvec` Stage D iterator/boxed-call frontier after 6.3 (`alloc::boxed::box_new`/`into_vec`, `Add::add`, iterator `map`/`fold`, and first-order for-loop iterator bridging), then re-run full seven-crate matrix
                        ...
                        - [ ] Leaf 4.15.4.3.3.3.3.3.7.2: Re-run full seven-crate matrix after 7.1 and record the next deterministic blocker (or mark Leaf 4 complete if all pass).
