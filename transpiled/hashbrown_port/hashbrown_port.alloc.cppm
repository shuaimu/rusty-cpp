...
export module hashbrown_port.alloc;
...
namespace inner {
    ...
    public:
        ...
        virtual rusty::Result<rusty::ptr::NonNull<uint8_t>, std::tuple<>> allocate(rusty::alloc::Layout layout) const = 0;
    ...
    export struct Global {
        ...
        rusty::Result<rusty::ptr::NonNull<uint8_t>, std::tuple<>> allocate(rusty::alloc::Layout layout) const;
        void deallocate(rusty::ptr::NonNull<uint8_t> ptr, rusty::alloc::Layout layout) const;
        static Global default_();

        // TODO: derive(Copy)
        Global clone() const { return Global{}; }
    };
...
namespace inner {
    ...
    export template<typename A>
        requires (rusty::alloc::Allocator<A>)
    rusty::Result<rusty::ptr::NonNull<uint8_t>, std::tuple<>> do_alloc(const A& alloc, rusty::alloc::Layout layout) {
        // do_alloc-error-convert: rusty AllocError → std::tuple<>
...
namespace inner {
    rusty::Result<rusty::ptr::NonNull<uint8_t>, std::tuple<>> Global::allocate(rusty::alloc::Layout layout) const {
        // alloc-stub: replaced with std::malloc/std::free direct calls
...
namespace inner {
template <>
class AllocatorAdapter<rusty::alloc::Global> final : public Allocator {
    rusty::alloc::Global value_;
public:
    explicit AllocatorAdapter(rusty::alloc::Global v) : value_(std::move(v)) {}
    rusty::Result<rusty::ptr::NonNull<uint8_t>, std::tuple<>> allocate(rusty::alloc::Layout layout) const override {
        // adapter-error-convert: rusty AllocError → std::tuple<>
...
template <>
class AllocatorAdapterRef<rusty::alloc::Global> final : public Allocator {
    const rusty::alloc::Global& value_;
public:
...
template <>
class AllocatorAdapterRefMut<rusty::alloc::Global> final : public Allocator {
    rusty::alloc::Global& value_;
public:
