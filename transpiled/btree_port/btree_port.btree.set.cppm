...
// btree_port port: Stitch peekable field typed as plain Iter by post_transpile_patch.py
...
template<typename T, typename A>
DifferenceInner_Stitch<T, A> Stitch(Iter<T> self_iter, Iter<T> other_iter);
template<typename T, typename A>
...
template<typename T, typename A>
DifferenceInner_Stitch<T, A> Stitch(Iter<T> self_iter, Iter<T> other_iter) { return DifferenceInner_Stitch<T, A>{.self_iter = std::forward<Iter<T>>(self_iter), .other_iter = std::forward<Iter<T>>(other_iter)};  }
template<typename T, typename A>
