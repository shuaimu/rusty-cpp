...
// Rust-only namespace import skipped for type path: using namespace Cow;
...
class ToOwned {
public:
    virtual ~ToOwned() noexcept(false) {}
    virtual Owned to_owned() const = 0;
    virtual void clone_into(Owned& target) const = 0;
    ToOwned(const ToOwned&) = delete;
    ToOwned& operator=(const ToOwned&) = delete;
    ToOwned(ToOwned&&) = delete;
    ToOwned& operator=(ToOwned&&) = delete;
protected:
    ToOwned() = default;
};

template <class Owned, class U> class ToOwnedAdapter;
template <class Owned, class U> class ToOwnedAdapterRef;
template <class Owned, class U> class ToOwnedAdapterRefMut;
...
export template<typename B>
struct Cow_Owned {
    typename ToOwnedTraits<B>::Owned _0;
};
template<typename B>
Cow_Borrowed<B> Borrowed(const B& _0);
template<typename B>
Cow_Owned<B> Owned(typename ToOwnedTraits<B>::Owned _0);
template<typename B>
struct Cow : std::variant<Cow_Borrowed<B>, Cow_Owned<B>> {
    using variant = std::variant<Cow_Borrowed<B>, Cow_Owned<B>>;
    using variant::variant;
    static Cow<B> Borrowed(const B& _0) { return Cow<B>{Cow_Borrowed<B>{std::forward<decltype(_0)>(_0)}}; }
    static Cow<B> Owned(typename ToOwnedTraits<B>::Owned _0) { return Cow<B>{Cow_Owned<B>{std::forward<decltype(_0)>(_0)}}; }


    const B& borrow() const {
        return rusty::detail::deref_if_pointer_like((*this));
    }
    Cow<B> clone() const {
        return [&]() -> Cow<B> { auto&& _m = (*this); if (rusty::detail::deref_if_pointer(_m).index() == 0) { auto&& b = rusty::detail::deref_if_pointer(std::get<0>(rusty::detail::deref_if_pointer(_m))._0); return Cow<B>{Cow_Borrowed<B>{b}}; } if (rusty::detail::deref_if_pointer(_m).index() == 1) { const auto& o = std::get<1>(rusty::detail::deref_if_pointer(_m))._0; return [&]() -> Cow<B> { const B& b = o.borrow();
return Cow<B>{Cow_Owned<B>{rusty::to_owned(b)}}; }(); } return [&]() -> Cow<B> { rusty::intrinsics::unreachable(); }(); }();
    }
    void clone_from(const Cow<B>& source) {
        {
            auto&& _m0 = (*this);
            auto&& _m1 = source;
            auto _m_tuple = std::forward_as_tuple(_m0, _m1);
            bool _m_matched = false;
            if (!_m_matched && ((rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(std::get<0>(rusty::detail::deref_if_pointer(_m_tuple)))).index() == 1 && rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(std::get<1>(rusty::detail::deref_if_pointer(_m_tuple)))).index() == 1))) {
                auto& dest = std::get<1>(rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(std::get<0>(rusty::detail::deref_if_pointer(_m_tuple)))))._0;
                const auto& o = std::get<1>(rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(std::get<1>(rusty::detail::deref_if_pointer(_m_tuple)))))._0;
                ([&](auto&& __self) -> decltype(auto) { if constexpr (requires { rusty_ext::clone_into(std::forward<decltype(__self)>(__self), rusty::detail::deref_if_pointer_like(dest)); }) { return rusty_ext::clone_into(std::forward<decltype(__self)>(__self), rusty::detail::deref_if_pointer_like(dest)); } else { return rusty_ext::clone_into(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), rusty::detail::deref_if_pointer_like(rusty::detail::deref_if_pointer_like(dest))); } })(o.borrow());
                _m_matched = true;
            }
            if (!_m_matched && (true)) {
                auto&& t = rusty::detail::deref_if_pointer(std::get<0>(rusty::detail::deref_if_pointer(_m_tuple)));
                auto&& s = rusty::detail::deref_if_pointer(std::get<1>(rusty::detail::deref_if_pointer(_m_tuple)));
                rusty::detail::deref_if_pointer_like(t) = rusty::clone(s);
                _m_matched = true;
            }
        }
    }
    static bool is_borrowed(const Cow<B>& c) {
        return [&]() -> bool { auto&& _m = c; if (rusty::detail::deref_if_pointer(_m).index() == 0) { return true; } if (rusty::detail::deref_if_pointer(_m).index() == 1) { return false; } return [&]() -> bool { rusty::intrinsics::unreachable(); }(); }();
    }
    static bool is_owned(const Cow<B>& c) {
        return !Cow<B>::is_borrowed(c);
    }
    decltype(auto) to_mut() {
        return [&]() -> typename ToOwnedTraits<B>::Owned& { auto&& _m = (*this); if (rusty::detail::deref_if_pointer(_m).index() == 0) { auto&& borrowed = rusty::detail::deref_if_pointer(std::get<0>(rusty::detail::deref_if_pointer(_m))._0); return [&]() -> typename ToOwnedTraits<B>::Owned& { (*this) = Owned(rusty::to_owned(borrowed));
return [&]() { auto&& _m = (*this); return std::visit(overloaded { [&](std::variant_alternative_t<0, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>& _v) -> typename ToOwnedTraits<B>::Owned& {  return (static_cast<void>(rusty::intrinsics::unreachable()), [&]() -> typename ToOwnedTraits<B>::Owned& { rusty::intrinsics::unreachable(); }()); }, [&](std::variant_alternative_t<1, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>& _v) -> typename ToOwnedTraits<B>::Owned& { auto& owned = _v._0; return owned; } }, _m); }(); }(); } if (rusty::detail::deref_if_pointer(_m).index() == 1) { auto& owned = std::get<1>(rusty::detail::deref_if_pointer(_m))._0; return owned; } return [&]() -> typename ToOwnedTraits<B>::Owned& { rusty::intrinsics::unreachable(); }(); }();
    }
    auto into_owned() {
        return [&]() -> typename ToOwnedTraits<B>::Owned { auto&& _m = (*this); if (rusty::detail::deref_if_pointer(_m).index() == 0) { auto&& borrowed = rusty::detail::deref_if_pointer(std::get<0>(rusty::detail::deref_if_pointer(_m))._0); return rusty::to_owned(borrowed); } if (rusty::detail::deref_if_pointer(_m).index() == 1) { auto&& owned = rusty::detail::deref_if_pointer(std::get<1>(rusty::detail::deref_if_pointer(_m))._0); return owned; } return [&]() -> typename ToOwnedTraits<B>::Owned { rusty::intrinsics::unreachable(); }(); }();
    }
    using Target = B;
    const B& operator*() const {
        return [&]() -> const B& { auto&& _m = (*this); if (rusty::detail::deref_if_pointer(_m).index() == 0) { auto&& borrowed = rusty::detail::deref_if_pointer(std::get<0>(rusty::detail::deref_if_pointer(_m))._0); return borrowed; } if (rusty::detail::deref_if_pointer(_m).index() == 1) { const auto& owned = std::get<1>(rusty::detail::deref_if_pointer(_m))._0; return owned.borrow(); } return [&]() -> const B& { rusty::intrinsics::unreachable(); }(); }();
    }
    rusty::cmp::Ordering cmp(const Cow<B>& other) const {
        return rusty::cmp::cmp(rusty::detail::deref_if_pointer_like((*this)), rusty::detail::deref_if_pointer_like(other));
    }
    template<typename C>
    bool operator==(const Cow<C>& other) const {
        return (rusty::detail::deref_if_pointer_like((*this))).eq(rusty::detail::deref_if_pointer_like(other));
    }
    std::partial_ordering operator<=>(const Cow<B>& other) const {
    ...
    rusty::fmt::Result fmt(rusty::fmt::Formatter& f) const {
        return [&]() -> rusty::fmt::Result { auto&& _m = (*this); if (rusty::detail::deref_if_pointer(_m).index() == 0) { const auto& b = std::get<0>(rusty::detail::deref_if_pointer(_m))._0; return rusty::write_fmt(f, rusty::to_debug_string(b)); } if (rusty::detail::deref_if_pointer(_m).index() == 1) { const auto& o = std::get<1>(rusty::detail::deref_if_pointer(_m))._0; return rusty::write_fmt(f, rusty::to_debug_string(o)); } return [&]() -> rusty::fmt::Result { rusty::intrinsics::unreachable(); }(); }();
    }
    static Cow<B> default_() {
        return Cow<B>{Cow_Owned<B>{typename ToOwnedTraits<B>::Owned::default_()}};
    }
    template<typename H>
    ...
    auto operator+(Cow<std::string_view> rhs) const {
        (*this) += rhs;
        return std::move((*this));
    }
    void operator+=(std::string_view rhs) {
        if (rusty::is_empty((*this))) {
            (*this) = rusty::Cow(rusty::Cow_Borrowed(rhs));
        } else if (!rusty::is_empty(rhs)) {
            if (auto&& _iflet_scrutinee = (*this); rusty::detail::deref_if_pointer(_iflet_scrutinee).index() == 0) {
                auto&& lhs = rusty::detail::deref_if_pointer(std::get<0>(rusty::detail::deref_if_pointer(_iflet_scrutinee))._0);
                auto s = String::with_capacity(rusty::len(lhs) + rusty::len(rhs));
                s.push_str(std::move(lhs));
                (*this) = rusty::Cow(rusty::Cow_Owned(std::move(s)));
            }
            this->to_mut().push_str(rhs);
        }
    }
    void operator+=(Cow<std::string_view> rhs) {
        if (rusty::is_empty((*this))) {
            (*this) = std::move(rhs);
        } else if (!rusty::is_empty(rhs)) {
            if (auto&& _iflet_scrutinee = (*this); rusty::detail::deref_if_pointer(_iflet_scrutinee).index() == 0) {
...
template<typename B>
Cow_Borrowed<B> Borrowed(const B& _0) { return Cow_Borrowed<B>{std::forward<const B&>(_0)};  }
template<typename B>
Cow_Owned<B> Owned(typename ToOwnedTraits<B>::Owned _0) { return Cow_Owned<B>{std::forward<typename ToOwnedTraits<B>::Owned>(_0)};  }
...
// Methods for T
// Rust-only associated type alias with unbound generic skipped in constrained mode: Owned
T to_owned() const {
    return rusty::clone((*this));
}
void clone_into(T& target) const {
    target.clone_from((*this));
}

#endif  // patcher: end orphan-impl stub
// Extension trait ToOwned lowered to rusty_ext:: free functions
namespace rusty_ext {
    export template<typename T>
    T to_owned(const T& self_) {
        using Self = std::remove_reference_t<decltype(self_)>;
        return rusty::clone(self_);
    }
...
// TODO(interface_traits): skipped generic impl `ToOwnedAdapter<T>`
