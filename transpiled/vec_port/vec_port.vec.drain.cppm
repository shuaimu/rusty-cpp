            ...
            if (rusty::detail::deref_if_pointer_like(this->_0.tail_len) > 0) {
                // @unsafe
                {
                    ...
                    if (rusty::detail::deref_if_pointer_like(tail) != rusty::detail::deref_if_pointer_like(start)) {
                        const auto src = rusty::ptr::add(reinterpret_cast<const uint8_t*>(rusty::as_ptr(source_vec)), std::move(tail));
                        const auto dst = rusty::ptr::add(reinterpret_cast<uint8_t*>(rusty::as_mut_ptr(source_vec)), std::move(start));
