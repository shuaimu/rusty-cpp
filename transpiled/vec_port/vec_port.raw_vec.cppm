...
size_t min_non_zero_cap(size_t size);
void handle_error(rusty::collections::TryReserveError e);
rusty::Result<rusty::alloc::Layout, rusty::collections::TryReserveError> layout_array(size_t cap, rusty::alloc::Layout elem_layout);

enum class AllocInit {
    Uninitialized,
    Zeroed
};
inline constexpr AllocInit AllocInit_Uninitialized() { return AllocInit::Uninitialized; }
inline constexpr AllocInit AllocInit_Zeroed() { return AllocInit::Zeroed; }
...
// Rust-only: using rusty::ptr::Unique;
...
template<typename A = rusty::alloc::Global>
    requires (rusty::alloc::Allocator<A>)
struct RawVecInner {
    rusty::ptr::Unique<uint8_t> ptr_field;
...
return rusty::Result<RawVecInner<A>, rusty::collections::TryReserveError>::Err(rusty::from_into<rusty::collections::TryReserveError>(rusty::collections::TryReserveErrorKind::CapacityOverflow)); } ([&](auto&& __v) -> decltype(auto) { using __MatchValueT = std::remove_cvref_t<decltype(__v)>; if constexpr (requires { typename __MatchValueT::type; }) { if constexpr (std::is_same_v<__MatchValueT, std::reference_wrapper<typename __MatchValueT::type>>) { return std::forward<decltype(__v)>(__v).get(); } else { return std::forward<decltype(__v)>(__v); } } else { return std::forward<decltype(__v)>(__v); } })(std::move(_match_value).value()); });
        if (layout.size == 0) {
            return rusty::Result<RawVecInner<A>, rusty::collections::TryReserveError>::Ok(RawVecInner<A>::new_in(std::move(alloc), elem_layout.alignment()));
        }
        const auto result = [&]() { auto&& _m = init; if (_m == AllocInit::Uninitialized) return ([&](auto&& __recv) -> decltype(auto) { if constexpr (requires { std::forward<decltype(__recv)>(__recv).allocate(std::move(layout)); }) { return std::forward<decltype(__recv)>(__recv).allocate(std::move(layout)); } else { return std::forward<decltype(__recv)>(__recv)->allocate(std::move(layout)); } }(alloc));
if (_m == AllocInit::Zeroed) return ([&](auto&& __recv) -> decltype(auto) { if constexpr (requires { std::forward<decltype(__recv)>(__recv).allocate_zeroed(std::move(layout)); }) { return std::forward<decltype(__recv)>(__recv).allocate_zeroed(std::move(layout)); } else { return std::forward<decltype(__recv)>(__recv)->allocate_zeroed(std::move(layout)); } }(alloc)); }();
        const auto ptr_shadow1 = ({ auto&& _m = result; std::conditional_t<std::is_reference_v<decltype(_m.unwrap())>, std::optional<std::reference_wrapper<std::remove_reference_t<decltype(_m.unwrap())>>>, std::optional<std::remove_cvref_t<decltype(_m.unwrap())>>> _match_value; if (_m.is_ok()) { auto&& _mv = _m.unwrap();
auto&& ptr_shadow1 = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::forward<decltype(_mv)>(_mv)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto&& _mv = _m.unwrap_err();
return rusty::Result<RawVecInner<A>, rusty::collections::TryReserveError>::Err(rusty::from_into<rusty::collections::TryReserveError>(rusty::alloc::AllocError{.layout = std::move(layout), .non_exhaustive = std::make_tuple()})); } ([&](auto&& __v) -> decltype(auto) { using __MatchValueT = std::remove_cvref_t<decltype(__v)>; if constexpr (requires { typename __MatchValueT::type; }) { if constexpr (std::is_same_v<__MatchValueT, std::reference_wrapper<typename __MatchValueT::type>>) { return std::forward<decltype(__v)>(__v).get(); } else { return std::forward<decltype(__v)>(__v); } } else { return std::forward<decltype(__v)>(__v); } })(std::move(_match_value).value()); });
        return rusty::Result<RawVecInner<A>, rusty::collections::TryReserveError>::Ok(RawVecInner<A>{.ptr_field = rusty::ptr::Unique<uint8_t>::from(ptr_shadow1.cast()), .cap = std::move(capacity), .alloc = std::move(alloc)});
    }
    ...
    auto grow_amortized(size_t len, size_t additional, rusty::alloc::Layout elem_layout) -> rusty::Result<std::tuple<>, rusty::collections::TryReserveError> {
        assert((rusty::detail::deref_if_pointer_like(additional) > 0));
        if (elem_layout.size == 0) {
            return rusty::Result<std::tuple<>, rusty::collections::TryReserveError>::Err(rusty::from_into<rusty::collections::TryReserveError>(rusty::collections::TryReserveErrorKind::CapacityOverflow));
        }
        ...
        // @unsafe
        {
            this->set_ptr_and_cap(std::move(ptr_shadow1), std::move(cap_shadow1));
        }
    ...
    auto finish_grow(size_t cap, rusty::alloc::Layout elem_layout) const -> rusty::Result<rusty::ptr::NonNull<uint8_t>, rusty::collections::TryReserveError> {
        ...
        auto memory = [&]() {
if (_curmem.is_some()) {
const auto _pair = _curmem.unwrap();
const auto ptr_shadow1 = std::move(std::get<0>(_pair));
const auto old_layout = std::move(std::get<1>(_pair));
assert((old_layout.align == new_layout.align));
return [&]() { __builtin_assume(old_layout.align == new_layout.align);
return ([&](auto&& __recv) -> decltype(auto) { if constexpr (requires { std::forward<decltype(__recv)>(__recv).grow(std::move(ptr_shadow1), std::move(old_layout), std::move(new_layout)); }) { return std::forward<decltype(__recv)>(__recv).grow(std::move(ptr_shadow1), std::move(old_layout), std::move(new_layout)); } else { return std::forward<decltype(__recv)>(__recv)->grow(std::move(ptr_shadow1), std::move(old_layout), std::move(new_layout)); } }(this->alloc)); }();
} else {
return ([&](auto&& __recv) -> decltype(auto) { if constexpr (requires { std::forward<decltype(__recv)>(__recv).allocate(std::move(new_layout)); }) { return std::forward<decltype(__recv)>(__recv).allocate(std::move(new_layout)); } else { return std::forward<decltype(__recv)>(__recv)->allocate(std::move(new_layout)); } }(this->alloc));
}
}();
        return [&]() -> rusty::Result<rusty::ptr::NonNull<uint8_t>, rusty::collections::TryReserveError> { auto&& _m = memory; if (_m.is_ok()) { auto&& _mv0 = _m.unwrap(); auto&& memory = rusty::detail::deref_if_pointer(_mv0); return rusty::Result<rusty::ptr::NonNull<uint8_t>, rusty::collections::TryReserveError>::Ok(std::move(memory)); } if (_m.is_err()) { return rusty::Result<rusty::ptr::NonNull<uint8_t>, rusty::collections::TryReserveError>::Err(rusty::from_into<rusty::collections::TryReserveError>(rusty::alloc::AllocError{.layout = std::move(new_layout), .non_exhaustive = std::make_tuple()})); } return [&]() -> rusty::Result<rusty::ptr::NonNull<uint8_t>, rusty::collections::TryReserveError> { rusty::intrinsics::unreachable(); }(); }();
    }
    static RawVecInner<A> new_in(A alloc, rusty::ptr::Alignment align) {
        auto ptr_shadow1 = rusty::ptr::Unique<uint8_t>::new_unchecked(reinterpret_cast<uint8_t*>(align.as_usize()));
        return RawVecInner<A>{.ptr_field = std::move(ptr_shadow1), .cap = ZERO_CAP, .alloc = std::move(alloc)};
    }
    static rusty::Result<RawVecInner<A>, rusty::collections::TryReserveError> try_with_capacity_in(size_t capacity, A alloc, rusty::alloc::Layout elem_layout) {
    ...
    static RawVecInner<A> from_nonnull_in(rusty::ptr::NonNull<uint8_t> ptr, const auto& cap, A alloc) {
        return RawVecInner<A>{.ptr_field = rusty::ptr::Unique<uint8_t>::from(std::move(ptr)), .cap = std::move(cap), .alloc = std::move(alloc)};
    }
    template<typename T>
    std::add_pointer_t<T> ptr() const {
        return const_cast<std::add_pointer_t<T>>(reinterpret_cast<std::add_pointer_t<std::add_const_t<T>>>(rusty::as_ptr(this->template non_null<T>())));
    }
    template<typename T>
    rusty::ptr::NonNull<T> non_null() const {
        return this->ptr_field.cast();
    }
    size_t capacity(size_t elem_size) const {
        if (rusty::detail::deref_if_pointer_like(elem_size) == static_cast<size_t>(0)) {
    ...
    rusty::Option<std::tuple<rusty::ptr::NonNull<uint8_t>, rusty::alloc::Layout>> current_memory(rusty::alloc::Layout elem_layout) const {
        if ((elem_layout.size == 0) || (this->cap == 0)) {
            return rusty::Option<std::tuple<rusty::ptr::NonNull<uint8_t>, rusty::alloc::Layout>>{rusty::None};
        } else {
            // @unsafe
            {
                const auto alloc_size = elem_layout.size * (this->cap);
                auto layout = Layout::from_size_align_unchecked(std::move(alloc_size), elem_layout.align);
                return rusty::Option<std::tuple<rusty::ptr::NonNull<uint8_t>, rusty::alloc::Layout>>(std::make_tuple(rusty::from_into<rusty::ptr::NonNull<uint8_t>>(this->ptr_field), std::move(layout)));
            }
        }
    }
    void reserve(size_t len, size_t additional, rusty::alloc::Layout elem_layout) {
        ...
        if (this->needs_to_grow(std::move(len), std::move(additional), std::move(elem_layout))) {
            // @unsafe
            {
                do_reserve_and_handle((*this), std::move(len), std::move(additional), std::move(elem_layout));
            }
        }
    }
    auto try_reserve(size_t len, size_t additional, rusty::alloc::Layout elem_layout) -> rusty::Result<std::tuple<>, rusty::collections::TryReserveError> {
        if (this->needs_to_grow(std::move(len), std::move(additional), std::move(elem_layout))) {
            // @unsafe
            {
                RUSTY_TRY_INTO(this->grow_amortized(std::move(len), std::move(additional), std::move(elem_layout)), rusty::Result<std::tuple<>, rusty::collections::TryReserveError>);
            }
        }
        // @unsafe
        {
            __builtin_assume(!this->needs_to_grow(std::move(len), std::move(additional), std::move(elem_layout)));
        }
        return rusty::Result<std::tuple<>, rusty::collections::TryReserveError>::Ok(std::make_tuple());
    }
    ...
    auto try_reserve_exact(size_t len, size_t additional, rusty::alloc::Layout elem_layout) -> rusty::Result<std::tuple<>, rusty::collections::TryReserveError> {
        if (this->needs_to_grow(std::move(len), std::move(additional), std::move(elem_layout))) {
            // @unsafe
            {
                RUSTY_TRY_INTO(this->grow_exact(std::move(len), std::move(additional), std::move(elem_layout)), rusty::Result<std::tuple<>, rusty::collections::TryReserveError>);
            }
        }
        // @unsafe
        {
    ...
    auto try_shrink_to_fit(size_t cap, rusty::alloc::Layout elem_layout) -> rusty::Result<std::tuple<>, rusty::collections::TryReserveError> {
        // @unsafe
        {
            return this->shrink(std::move(cap), std::move(elem_layout));
        }
    }
    bool needs_to_grow(size_t len, size_t additional, rusty::alloc::Layout elem_layout) const {
        return rusty::detail::deref_if_pointer_like(additional) > (static_cast<size_t>(this->capacity(elem_layout.size)) - static_cast<size_t>(std::move(len)));
    }
    void set_ptr_and_cap(rusty::ptr::NonNull<uint8_t> ptr, size_t cap) {
        this->ptr_field = rusty::ptr::Unique<uint8_t>::from(ptr.cast());
        this->cap = std::move(cap);
    }
    auto grow_exact(size_t len, size_t additional, rusty::alloc::Layout elem_layout) -> rusty::Result<std::tuple<>, rusty::collections::TryReserveError> {
        if (elem_layout.size == 0) {
            return rusty::Result<std::tuple<>, rusty::collections::TryReserveError>::Err(rusty::from_into<rusty::collections::TryReserveError>(rusty::collections::TryReserveErrorKind::CapacityOverflow));
        }
        auto cap = RUSTY_TRY_INTO([&]() { auto&& _checked_lhs = len; return rusty::checked_add(_checked_lhs, static_cast<std::remove_cvref_t<decltype((_checked_lhs))>>(std::move(additional))); }().ok_or(rusty::collections::TryReserveErrorKind::CapacityOverflow), rusty::Result<std::tuple<>, rusty::collections::TryReserveError>);
        auto ptr_shadow1 = RUSTY_TRY_INTO(this->finish_grow(std::move(cap), std::move(elem_layout)), rusty::Result<std::tuple<>, rusty::collections::TryReserveError>);
        // @unsafe
        {
            this->set_ptr_and_cap(std::move(ptr_shadow1), std::move(cap));
        }
        return rusty::Result<std::tuple<>, rusty::collections::TryReserveError>::Ok(std::make_tuple());
    }
    auto shrink(size_t cap, rusty::alloc::Layout elem_layout) -> rusty::Result<std::tuple<>, rusty::collections::TryReserveError> {
        if (!(rusty::detail::deref_if_pointer_like(cap) <= this->capacity(elem_layout.size))) { throw std::logic_error("Tried to shrink to a larger capacity"); }
        // @unsafe
        {
            return this->shrink_unchecked(std::move(cap), std::move(elem_layout));
        }
    }
    auto shrink_unchecked(size_t cap, rusty::alloc::Layout elem_layout) -> rusty::Result<std::tuple<>, rusty::collections::TryReserveError> {
        ...
        if (rusty::detail::deref_if_pointer_like(cap) == static_cast<size_t>(0)) {
            // @unsafe
            {
            ...
            this->ptr_field = rusty::ptr::Unique<uint8_t>::new_unchecked(reinterpret_cast<uint8_t*>(elem_layout.align));
            this->cap = ZERO_CAP;
        } else {
            auto ptr_shadow2 = ({ const auto new_size = elem_layout.size * (std::move(cap));
auto new_layout = Layout::from_size_align_unchecked(std::move(new_size), layout.align);
RUSTY_TRY_INTO(([&](auto&& __recv) -> decltype(auto) { if constexpr (requires { std::forward<decltype(__recv)>(__recv).shrink(std::move(ptr_shadow1), std::move(layout), std::move(new_layout)); }) { return std::forward<decltype(__recv)>(__recv).shrink(std::move(ptr_shadow1), std::move(layout), std::move(new_layout)); } else { return std::forward<decltype(__recv)>(__recv)->shrink(std::move(ptr_shadow1), std::move(layout), std::move(new_layout)); } }(this->alloc)).map_err([&](auto _closure_wild0) { return rusty::alloc::AllocError{.layout = std::move(new_layout), .non_exhaustive = std::make_tuple()}; }), rusty::Result<std::tuple<>, rusty::collections::TryReserveError>); });
            // @unsafe
            {
    ...
    void deallocate(rusty::alloc::Layout elem_layout) {
        if (auto&& _iflet_scrutinee = this->current_memory(std::move(elem_layout)); _iflet_scrutinee.is_some()) {
...
struct RawVec {
    ...
    RawVec& operator=(RawVec&& other) noexcept {
        ...
        this->~RawVec();
        new (this) RawVec(std::move(other));
        return *this;
    }
    void rusty_mark_forgotten() const noexcept { _rusty_forgotten = true; }


    static RawVec<T, A> new_() {
        return RawVec<T, A>::new_in(rusty::alloc::Global{});
    }
    static RawVec<T, A> with_capacity(size_t capacity) {
        return RawVec<T, A>(RawVecInner<A>::with_capacity(std::move(capacity), rusty::clone(rusty::clone(rusty::alloc::Layout::new_<T>()))), rusty::PhantomData<T>{});
    }
    static RawVec<T, A> with_capacity_zeroed(size_t capacity) {
        return RawVec<T, A>(RawVecInner<A>::with_capacity_zeroed_in(std::move(capacity), rusty::alloc::Global{}, rusty::clone(rusty::clone(rusty::alloc::Layout::new_<T>()))), rusty::PhantomData<T>{});
    }
    static RawVec<T, A> with_capacity_in(size_t capacity, A alloc) {
        return RawVec<T, A>(RawVecInner<A>::with_capacity_in(std::move(capacity), std::move(alloc), rusty::clone(rusty::clone(rusty::alloc::Layout::new_<T>()))), rusty::PhantomData<T>{});
    }
    void grow_one() {
        // @unsafe
        {
            this->inner.grow_one(rusty::clone(rusty::clone(rusty::alloc::Layout::new_<T>())));
        }
    }
    static RawVec<T, A> new_in(A alloc) {
        // const-block elided (Rust 2024 compile-time fence)
        return RawVec<T, A>(RawVecInner<A>::new_in(std::move(alloc), rusty::ptr::Alignment::of<T>()), rusty::PhantomData<T>{});
    }
    static rusty::Result<RawVec<T, A>, rusty::collections::TryReserveError> try_with_capacity_in(size_t capacity, A alloc) {
        return [&]() -> rusty::Result<RawVec<T, A>, rusty::collections::TryReserveError> { auto&& _m = RawVecInner<std::remove_cvref_t<decltype((alloc))>>::try_with_capacity_in(std::move(capacity), std::move(alloc), rusty::clone(rusty::clone(rusty::alloc::Layout::new_<T>()))); if (_m.is_ok()) { auto&& _mv0 = _m.unwrap(); auto&& inner = rusty::detail::deref_if_pointer(_mv0); return rusty::Result<RawVec<T, A>, rusty::collections::TryReserveError>::Ok(RawVec<T, A>(std::move(inner), rusty::PhantomData<T>{})); } if (_m.is_err()) { auto&& _mv1 = _m.unwrap_err(); auto&& e = rusty::detail::deref_if_pointer(_mv1); return rusty::Result<RawVec<T, A>, rusty::collections::TryReserveError>::Err(std::move(e)); } return [&]() -> rusty::Result<RawVec<T, A>, rusty::collections::TryReserveError> { rusty::intrinsics::unreachable(); }(); }();
    }
    static RawVec<T, A> with_capacity_zeroed_in(size_t capacity, A alloc) {
        return RawVec<T, A>(RawVecInner<A>::with_capacity_zeroed_in(std::move(capacity), std::move(alloc), rusty::clone(rusty::clone(rusty::alloc::Layout::new_<T>()))), rusty::PhantomData<T>{});
    }
    rusty::Box<std::span<rusty::MaybeUninit<T>>, A> into_box(size_t len) {
        if (!(rusty::detail::deref_if_pointer_like(len) <= this->capacity())) { throw std::logic_error("`len` must be smaller than or equal to `self.capacity()`"); }
        const auto me = rusty::mem::manually_drop_new(std::move((*this)));
        // @unsafe
        {
            auto slice = rusty::from_raw_parts_mut(reinterpret_cast<std::add_pointer_t<rusty::MaybeUninit<T>>>(static_cast<std::uintptr_t>(me.ptr())), std::move(len));
            return rusty::Box<std::span<rusty::MaybeUninit<T>>, A>::from_raw_in(std::move(slice), rusty::ptr::read(&me.inner.alloc));
        }
    }
    ...
    static RawVec<T, A> from_nonnull_in(rusty::ptr::NonNull<T> ptr, size_t capacity, A alloc) {
        // @unsafe
        {
    ...
    std::add_pointer_t<T> ptr() const {
        return this->inner.template ptr<T>();
    }
    rusty::ptr::NonNull<T> non_null() const {
    ...
    void reserve(size_t len, size_t additional) {
        // @unsafe
        {
            this->inner.reserve(std::move(len), std::move(additional), rusty::clone(rusty::clone(rusty::alloc::Layout::new_<T>())));
        }
    }
    auto try_reserve(size_t len, size_t additional) -> rusty::Result<std::tuple<>, rusty::collections::TryReserveError> {
        // @unsafe
        {
            return this->inner.try_reserve(std::move(len), std::move(additional), rusty::clone(rusty::clone(rusty::alloc::Layout::new_<T>())));
        }
    }
    void reserve_exact(size_t len, size_t additional) {
        // @unsafe
        {
            this->inner.reserve_exact(std::move(len), std::move(additional), rusty::clone(rusty::clone(rusty::alloc::Layout::new_<T>())));
        }
    }
    auto try_reserve_exact(size_t len, size_t additional) -> rusty::Result<std::tuple<>, rusty::collections::TryReserveError> {
        // @unsafe
        {
            return this->inner.try_reserve_exact(std::move(len), std::move(additional), rusty::clone(rusty::clone(rusty::alloc::Layout::new_<T>())));
        }
    }
    void shrink_to_fit(size_t cap) {
        // @unsafe
        {
            this->inner.shrink_to_fit(std::move(cap), rusty::clone(rusty::clone(rusty::alloc::Layout::new_<T>())));
        }
    }
    auto try_shrink_to_fit(size_t cap) -> rusty::Result<std::tuple<>, rusty::collections::TryReserveError> {
        // @unsafe
        {
            return this->inner.try_shrink_to_fit(std::move(cap), rusty::clone(rusty::clone(rusty::alloc::Layout::new_<T>())));
        }
    }
    ~RawVec() noexcept(false) {
        if (_rusty_forgotten) { return; }
        // @unsafe
        {
            this->inner.deallocate(rusty::clone(rusty::clone(rusty::alloc::Layout::new_<T>())));
        }
    }
};
...
/// `Cap(cap)`, except if `T` is a ZST then `0usize`.
///
...
size_t min_non_zero_cap(size_t size) {
    ...
    } else if (rusty::detail::deref_if_pointer_like(size) <= 1024) {
