...
namespace unsync {
    ...
    struct OnceCell {
        ...
        rusty::fmt::Result fmt(rusty::fmt::Formatter& f) const {
            return [&]() -> rusty::fmt::Result { auto&& _m = this->get(); if (_m.is_some()) { auto&& _mv0 = _m.unwrap(); auto&& v = rusty::detail::deref_if_pointer(_mv0); return f.debug_tuple("OnceCell").field(std::move(v)).finish(); } if (_m.is_none()) { return f.write_str("OnceCell(Uninit)"); } return [&]() -> rusty::fmt::Result { rusty::intrinsics::unreachable(); }(); }();
        }
        OnceCell<T> clone() const {
            return [&]() -> OnceCell<T> { auto&& _m = this->get(); if (_m.is_some()) { auto&& _mv0 = _m.unwrap(); auto&& value = rusty::detail::deref_if_pointer(_mv0); return OnceCell<T>::with_value(rusty::clone(value)); } if (_m.is_none()) { return OnceCell<T>::new_(); } return [&]() -> OnceCell<T> { rusty::intrinsics::unreachable(); }(); }();
        }
        void clone_from(const OnceCell<T>& source) {
            {
                ...
                if (!_m_matched && ((rusty::detail::deref_if_pointer(std::get<0>(rusty::detail::deref_if_pointer(_m_tuple))).is_some() && rusty::detail::deref_if_pointer(std::get<1>(rusty::detail::deref_if_pointer(_m_tuple))).is_some()))) {
                    auto&& this_ = rusty::detail::deref_if_pointer(std::as_const(rusty::detail::deref_if_pointer(std::get<0>(rusty::detail::deref_if_pointer(_m_tuple)))).unwrap());
                    auto&& source = rusty::detail::deref_if_pointer(std::as_const(rusty::detail::deref_if_pointer(std::get<1>(rusty::detail::deref_if_pointer(_m_tuple)))).unwrap());
        ...
        const T& get_or_init(F f) const {
            ...
            return [&]() -> const T& { auto&& _m = this->get_or_try_init([&]() -> rusty::Result<T, std::tuple<>> { return rusty::Result<T, std::tuple<>>::Ok(f()); }); if (_m.is_ok()) { return std::as_const(_m).unwrap(); } if (_m.is_err()) { auto&& _mv1 = std::as_const(_m).unwrap_err(); auto&& void_ = rusty::detail::deref_if_pointer(_mv1); return [&]() -> const T& { rusty::intrinsics::unreachable(); }(); } return [&]() -> const T& { rusty::intrinsics::unreachable(); }(); }();
        }
        template<typename F>
        ...
        rusty::Option<T> take() {
            return mem::take((*this)).into_inner();
        }
    ...
    struct Lazy {
        ...
        rusty::fmt::Result fmt(rusty::fmt::Formatter& f) const {
            return f.debug_struct("Lazy").field("cell", &this->cell).field("init", "..").finish();
        }
...
rusty::panicking::panic_fmt(std::string("Lazy instance has previously been poisoned"));
        ...
        static const T& force(const Lazy<T, F>& this_) {
            return this_.cell.get_or_init([&]() { return [&]() { auto&& _m = this_.init.take(); if (_m.is_some()) { auto&& _mv0 = _m.unwrap(); auto&& f = rusty::detail::deref_if_pointer(_mv0); return f(); } if (_m.is_none()) { [&]() { rusty::panicking::panic_fmt(std::string("Lazy instance has previously been poisoned")); }(); } rusty::intrinsics::unreachable(); }(); });
        }
        static T& force_mut(Lazy<T, F>& this_) {
            if (this_.cell.get_mut().is_none()) {
                auto value = [&]() { auto&& _m = this_.init.get_mut()->take(); if (_m.is_some()) { auto&& _mv0 = _m.unwrap(); auto&& f = rusty::detail::deref_if_pointer(_mv0); return f(); } if (_m.is_none()) { [&]() { [&]() -> T& { rusty::panicking::panic_fmt(std::string("Lazy instance has previously been poisoned")); }(); }(); } rusty::intrinsics::unreachable(); }();
                this_.cell = OnceCell<T>::with_value(std::move(value));
            }
            return this_.cell.get_mut().unwrap_or_else([&]() { [&]() -> T& { rusty::panicking::panic("internal error: entered unreachable code"); }(); });
        }
...
namespace race {
    ...
    struct OnceRef {
        ...
        auto set(const T& value) const -> rusty::Result<std::tuple<>, std::tuple<>> {
            return [&]() -> rusty::Result<std::tuple<>, std::tuple<>> { auto&& _m = this->compare_exchange(value); if (_m.is_ok()) { return rusty::Result<std::tuple<>, std::tuple<>>::Ok(std::make_tuple()); } if (_m.is_err()) { return rusty::Result<std::tuple<>, std::tuple<>>::Err(std::make_tuple()); } return [&]() -> rusty::Result<std::tuple<>, std::tuple<>> { rusty::intrinsics::unreachable(); }(); }();
        }
        template<typename F>
        const T& get_or_init(F f) const {
            enum class Void {
            ...
            return [&]() -> const T& { auto&& _m = this->get_or_try_init([&]() -> rusty::Result<const T&, std::tuple<>> { return rusty::Result<const T&, std::tuple<>>::Ok([&]() -> const auto& { auto _result_ref_value = (f()); thread_local std::optional<T> _result_ref_tmp; _result_ref_tmp.reset(); _result_ref_tmp.emplace(std::move(_result_ref_value)); return *_result_ref_tmp; }()); }); if (_m.is_ok()) { return std::as_const(_m).unwrap(); } if (_m.is_err()) { auto&& _mv1 = std::as_const(_m).unwrap_err(); auto&& void_ = rusty::detail::deref_if_pointer(_mv1); return [&]() -> const T& { rusty::intrinsics::unreachable(); }(); } return [&]() -> const T& { rusty::intrinsics::unreachable(); }(); }();
        }
        template<typename F>
        auto get_or_try_init(F f) const {
            using E = rusty::result_err_t<decltype((f()))>;
            return [&]() -> rusty::Result<const T&, E> { auto&& _m = this->get(); if (_m.is_some()) { auto&& _mv0 = _m.unwrap(); auto&& val = rusty::detail::deref_if_pointer(_mv0); return rusty::Result<const T&, E>::Ok(val); } if (_m.is_none()) { return this->template init<E>(std::move(f)); } return [&]() -> rusty::Result<const T&, E> { rusty::intrinsics::unreachable(); }(); }();
        }
        template<typename E>
        rusty::Result<const T&, E> init(const auto& f) const {
            ...
            if (auto&& _iflet_scrutinee = this->compare_exchange(*value); _iflet_scrutinee.is_err()) {
    ...
    namespace once_box {
        ...
        struct OnceBox {
            ...
            const T& get_or_init(F f) const {
                ...
                return [&]() -> const T& { auto&& _m = this->get_or_try_init([&]() -> rusty::Result<rusty::Box<T>, std::tuple<>> { return rusty::Result<rusty::Box<T>, std::tuple<>>::Ok(f()); }); if (_m.is_ok()) { return std::as_const(_m).unwrap(); } if (_m.is_err()) { auto&& _mv1 = std::as_const(_m).unwrap_err(); auto&& void_ = rusty::detail::deref_if_pointer(_mv1); return [&]() -> const T& { rusty::intrinsics::unreachable(); }(); } return [&]() -> const T& { rusty::intrinsics::unreachable(); }(); }();
            }
            template<typename F>
            auto get_or_try_init(F f) const {
                using E = rusty::result_err_t<decltype((f()))>;
            ...
            rusty::Result<const T&, E> init(const auto& f) const {
                ...
                if (exchange.is_err()) {
                    ...
                    rusty::mem::drop(rusty::Box<std::remove_pointer_t<std::remove_reference_t<decltype((ptr_shadow1))>>>::from_raw(std::move(ptr_shadow1)));
                    ptr_shadow1 = std::move(old);
                }
                return rusty::Result<const T&, E>::Ok(rusty::detail::deref_if_pointer_like(ptr_shadow1));
            }
            OnceBox<T> clone() const {
                return [&]() -> OnceBox<T> { auto&& _m = this->get(); if (_m.is_some()) { auto&& _mv0 = _m.unwrap(); auto&& value = rusty::detail::deref_if_pointer(_mv0); return OnceBox<T>::with_value(rusty::Box<T>::new_(rusty::clone(value))); } if (_m.is_none()) { return OnceBox<T>::new_(); } return [&]() -> OnceBox<T> { rusty::intrinsics::unreachable(); }(); }();
            }
        };
...
return [&]() -> bool { auto&& _m = f_shadow2(); if (_m.is_ok()) { auto&& _mv0 = _m.unwrap(); auto&& value = rusty::detail::deref_if_pointer(_mv0); return [&]() -> bool { // @unsafe
{
    *slot = rusty::Option<T>(std::move(value));
}
return true; }(); } if (_m.is_err()) { auto&& _mv1 = _m.unwrap_err(); auto&& err = rusty::detail::deref_if_pointer(_mv1); return [&]() -> bool { res = rusty::Result<std::tuple<>, E>::Err(std::move(err));
    ...
    void initialize_or_wait(const rusty::sync::atomic::AtomicPtr<Waiter>& queue, rusty::Option<const std::function<bool()>&> init) {
        ...
        while (true) {
            auto curr_state = strict::addr<std::remove_pointer_t<std::remove_cvref_t<decltype((std::move(curr_queue)))>>>(std::move(curr_queue)) & STATE_MASK;
            {
                ...
                if (!_m_matched && ((std::get<0>(rusty::detail::deref_if_pointer(_m_tuple)) == INCOMPLETE && rusty::detail::deref_if_pointer(std::get<1>(rusty::detail::deref_if_pointer(_m_tuple))).is_some()))) {
                    auto&& init = rusty::detail::deref_if_pointer(std::as_const(rusty::detail::deref_if_pointer(std::get<1>(rusty::detail::deref_if_pointer(_m_tuple)))).unwrap());
                ...
                if (!_m_matched && (((std::get<0>(rusty::detail::deref_if_pointer(_m_tuple)) == INCOMPLETE && std::get<1>(rusty::detail::deref_if_pointer(_m_tuple)).is_none()) || std::get<0>(rusty::detail::deref_if_pointer(_m_tuple)) == RUNNING))) {
                    wait(queue, std::move(curr_queue));
...
namespace race {
    rusty::num::NonZeroUsize OnceNonZeroUsize::get_unchecked() const {
        ...
        const auto p = as_const_ptr(this->inner);
        const auto val = rusty::ptr::read(p);
        // @unsafe
        {
            return NonZeroUsize::new_unchecked(std::move(val));
        }
    }
}
...
namespace race {
    ...
    auto OnceNonZeroUsize::get_or_try_init(F f) const {
        using E = rusty::result_err_t<decltype((f()))>;
        return [&]() -> rusty::Result<rusty::num::NonZeroUsize, E> { auto&& _m = this->get(); if (_m.is_some()) { auto&& _mv0 = _m.unwrap(); auto&& it = rusty::detail::deref_if_pointer(_mv0); return rusty::Result<rusty::num::NonZeroUsize, E>::Ok(std::move(it)); } if (_m.is_none()) { return this->template init<E>(std::move(f)); } return [&]() -> rusty::Result<rusty::num::NonZeroUsize, E> { rusty::intrinsics::unreachable(); }(); }();
    }
}
...
namespace race {
    rusty::num::NonZeroUsize OnceBool::to_usize(bool value) {
        // @unsafe
        {
            return NonZeroUsize::new_unchecked((value ? 1 : 2));
        }
    }
}
