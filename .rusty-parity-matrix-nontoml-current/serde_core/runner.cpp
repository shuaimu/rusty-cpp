...
namespace ser {
    ...
    namespace impls {
        ...
        // Rust-only libtest metadata const skipped: test_format_u8 (marker: ser::impls::test_format_u8, should_panic: no)
...
return rusty::Result<typename Self_::Ok, typename Self_::Error>::Err(err); } std::move(_match_value).value(); });
            {
                ...
                if (!_m_matched) {
                    if (_m.is_err()) {
                        ...
                        return rusty::Result<typename Self_::Ok, typename Self_::Error>::Err(err);
                        _m_matched = true;
                    }
                }
            }
...
return serializer.serialize_entry(key, value);
    ...
    struct SerializeMapRuntimeHelper {
        static auto serialize_entry(auto& self_, auto key, auto value) -> rusty::Result<std::tuple<>, typename std::remove_reference_t<decltype(self_)>::Error> {
            using Self_ = std::remove_reference_t<decltype(self_)>;
            {
                auto&& _m = self_.serialize_key(key);
                bool _m_matched = false;
                if (!_m_matched) {
                    if (_m.is_ok()) {
                        auto&& _mv0 = _m.unwrap();
                ...
                if (!_m_matched) {
                    if (_m.is_err()) {
                        auto&& _mv1 = _m.unwrap_err();
                        auto&& err = rusty::detail::deref_if_pointer(_mv1);
                        return rusty::Result<std::tuple<>, typename Self_::Error>::Err(err);
                        _m_matched = true;
                    }
                }
            }
            return self_.serialize_value(value);
        }
    };
    ...
    namespace seed {
        ...
        struct InPlaceSeed {
            ...
            rusty::Result<Value, typename D::Error> deserialize(D deserializer) {
                return T::deserialize_in_place(std::move(deserializer), this->_0);
            }
        };
    ...
    namespace value {
        ...
        struct U32Deserializer {
            ...
            rusty::Result<std::tuple<typename T::Value, Variant>, Error> variant_seed(T seed) {
                return ([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::de::rusty_ext::deserialize(std::forward<decltype(__self)>(__self), std::move((*this))); }) { return ::de::rusty_ext::deserialize(std::forward<decltype(__self)>(__self), std::move((*this))); } else { return ::de::rusty_ext::deserialize(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), std::move((*this))); } })(seed).map(private_::unit_only);
            }
            rusty::fmt::Result fmt(rusty::fmt::Formatter& formatter) const {
        ...
        struct CowStrDeserializer {
            ...
            template<typename V>
            rusty::Result<typename V::Value, Error> deserialize_any(V visitor) {
                return [&]() -> rusty::Result<typename V::Value, Error> { auto&& _m = this->value; if (std::holds_alternative<std::variant_alternative_t<0, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))) { auto&& string = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<0, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))._0); return visitor.visit_str(rusty::to_string_view(string)); } if (std::holds_alternative<std::variant_alternative_t<1, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))) { auto&& string = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<1, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))._0); return visitor.visit_string(string); } return [&]() -> rusty::Result<typename V::Value, Error> { rusty::intrinsics::unreachable(); }(); }();
            }
            template<typename V>
            rusty::Result<typename V::Value, Error> deserialize_enum(std::string_view name, std::span<const std::string_view> variants, V visitor) {
                static_cast<void>(name);
        ...
        struct BytesDeserializer {
            ...
            template<typename V>
            rusty::Result<typename V::Value, Error> deserialize_any(V visitor) {
                return visitor.visit_bytes(this->value);
            }
            template<typename V>
        ...
        struct BorrowedBytesDeserializer {
            ...
            template<typename V>
            rusty::Result<typename V::Value, Error> deserialize_any(V visitor) {
                return visitor.visit_borrowed_bytes(this->value);
            }
            template<typename V>
...
return ([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::de::rusty_ext::deserialize(std::forward<decltype(__self)>(__self), ([&](auto&& _into_deser_recv) -> decltype(auto) { if constexpr (requires { ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else if constexpr (requires { ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else { return std::forward<decltype(_into_deser_recv)>(_into_deser_recv).into_deserializer(); } })(std::move(value))); }) { return ::de::rusty_ext::deserialize(std::forward<decltype(__self)>(__self), ([&](auto&& _into_deser_recv) -> decltype(auto) { if constexpr (requires { ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else if constexpr (requires { ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else { return std::forward<decltype(_into_deser_recv)>(_into_deser_recv).into_deserializer(); } })(std::move(value))); } else { return ::de::rusty_ext::deserialize(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), ([&](auto&& _into_deser_recv) -> decltype(auto) { if constexpr (requires { ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else if constexpr (requires { ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else { return std::forward<decltype(_into_deser_recv)>(_into_deser_recv).into_deserializer(); } })(std::move(value))); } })(seed).map(rusty::Some); }(); } if (_m.is_none()) { return rusty::Result<rusty::Option<typename V::Value>, Error>::Ok(rusty::Option<typename V::Value>(rusty::None)); } return [&]() -> rusty::Result<rusty::Option<typename V::Value>, Error> { rusty::intrinsics::unreachable(); }(); }();
            }
            template<typename T>
        ...
        struct SeqAccessDeserializer {
            ...
            template<typename V>
            auto deserialize_bool(V visitor) {
                return this->deserialize_any(std::move(visitor));
            }
            template<typename V>
            auto deserialize_i8(V visitor) {
                return this->deserialize_any(std::move(visitor));
            }
            template<typename V>
            auto deserialize_i16(V visitor) {
                return this->deserialize_any(std::move(visitor));
            }
            template<typename V>
            auto deserialize_i32(V visitor) {
                return this->deserialize_any(std::move(visitor));
            }
            template<typename V>
            auto deserialize_i64(V visitor) {
                return this->deserialize_any(std::move(visitor));
            }
            template<typename V>
            ...
            template<typename V>
            auto deserialize_u8(V visitor) {
                return this->deserialize_any(std::move(visitor));
            }
            template<typename V>
            auto deserialize_u16(V visitor) {
                return this->deserialize_any(std::move(visitor));
            }
            template<typename V>
            auto deserialize_u32(V visitor) {
                return this->deserialize_any(std::move(visitor));
            }
            template<typename V>
            auto deserialize_u64(V visitor) {
                return this->deserialize_any(std::move(visitor));
            }
            template<typename V>
            ...
            template<typename V>
            auto deserialize_f32(V visitor) {
                return this->deserialize_any(std::move(visitor));
            }
            template<typename V>
            auto deserialize_f64(V visitor) {
                return this->deserialize_any(std::move(visitor));
            }
            template<typename V>
            auto deserialize_char(V visitor) {
                return this->deserialize_any(std::move(visitor));
            }
            template<typename V>
            auto deserialize_str(V visitor) {
                return this->deserialize_any(std::move(visitor));
            }
            template<typename V>
            auto deserialize_string(V visitor) {
                return this->deserialize_any(std::move(visitor));
            }
            template<typename V>
            auto deserialize_bytes(V visitor) {
                return this->deserialize_any(std::move(visitor));
            }
            template<typename V>
            auto deserialize_byte_buf(V visitor) {
                return this->deserialize_any(std::move(visitor));
            }
            template<typename V>
            ...
            template<typename V>
            auto deserialize_unit(V visitor) {
                return this->deserialize_any(std::move(visitor));
            }
            template<typename V>
            auto deserialize_unit_struct(std::string_view name, V visitor) {
                static_cast<void>(name);
                return this->deserialize_any(std::move(visitor));
            }
            template<typename V>
            ...
            template<typename V>
            auto deserialize_tuple(size_t len, V visitor) {
                static_cast<void>(std::move(len));
                return this->deserialize_any(std::move(visitor));
            }
            template<typename V>
            auto deserialize_tuple_struct(std::string_view name, size_t len, V visitor) {
                static_cast<void>(name);
                static_cast<void>(std::move(len));
                return this->deserialize_any(std::move(visitor));
            }
            template<typename V>
            auto deserialize_map(V visitor) {
                return this->deserialize_any(std::move(visitor));
            }
            template<typename V>
            ...
            template<typename V>
            auto deserialize_identifier(V visitor) {
                return this->deserialize_any(std::move(visitor));
            }
            template<typename V>
            auto deserialize_ignored_any(V visitor) {
                return this->deserialize_any(std::move(visitor));
            }
        ...
        struct MapDeserializer {
            ...
            auto next_pair() {
                return [&]() -> rusty::Option<std::tuple<de::value::private_::First<rusty::detail::associated_item_t<I>>, de::value::private_::Second<rusty::detail::associated_item_t<I>>>> { auto&& _m = this->iter.next(); if (_m.is_some()) { auto&& _mv0 = _m.unwrap(); auto&& kv = rusty::detail::deref_if_pointer(_mv0); return [&]() -> rusty::Option<std::tuple<de::value::private_::First<rusty::detail::associated_item_t<I>>, de::value::private_::Second<rusty::detail::associated_item_t<I>>>> { [&]() { static_cast<void>(this->count += 1); return std::make_tuple(); }();
...
return ([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::de::rusty_ext::deserialize(std::forward<decltype(__self)>(__self), ([&](auto&& _into_deser_recv) -> decltype(auto) { if constexpr (requires { ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else if constexpr (requires { ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else { return std::forward<decltype(_into_deser_recv)>(_into_deser_recv).into_deserializer(); } })(std::move(key))); }) { return ::de::rusty_ext::deserialize(std::forward<decltype(__self)>(__self), ([&](auto&& _into_deser_recv) -> decltype(auto) { if constexpr (requires { ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else if constexpr (requires { ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else { return std::forward<decltype(_into_deser_recv)>(_into_deser_recv).into_deserializer(); } })(std::move(key))); } else { return ::de::rusty_ext::deserialize(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), ([&](auto&& _into_deser_recv) -> decltype(auto) { if constexpr (requires { ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else if constexpr (requires { ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else { return std::forward<decltype(_into_deser_recv)>(_into_deser_recv).into_deserializer(); } })(std::move(key))); } })(seed).map(rusty::Some); }(); } if (_m.is_none()) { return rusty::Result<rusty::Option<typename T::Value>, Error>::Ok(rusty::Option<typename T::Value>(rusty::None)); } return [&]() -> rusty::Result<rusty::Option<typename T::Value>, Error> { rusty::intrinsics::unreachable(); }(); }();
            }
            template<typename T>
            rusty::Result<typename T::Value, Error> next_value_seed(T seed) {
                ...
                return ([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::de::rusty_ext::deserialize(std::forward<decltype(__self)>(__self), ([&](auto&& _into_deser_recv) -> decltype(auto) { if constexpr (requires { ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else if constexpr (requires { ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else { return std::forward<decltype(_into_deser_recv)>(_into_deser_recv).into_deserializer(); } })(std::move(value_shadow1))); }) { return ::de::rusty_ext::deserialize(std::forward<decltype(__self)>(__self), ([&](auto&& _into_deser_recv) -> decltype(auto) { if constexpr (requires { ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else if constexpr (requires { ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else { return std::forward<decltype(_into_deser_recv)>(_into_deser_recv).into_deserializer(); } })(std::move(value_shadow1))); } else { return ::de::rusty_ext::deserialize(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), ([&](auto&& _into_deser_recv) -> decltype(auto) { if constexpr (requires { ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else if constexpr (requires { ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else { return std::forward<decltype(_into_deser_recv)>(_into_deser_recv).into_deserializer(); } })(std::move(value_shadow1))); } })(seed);
            }
            template<typename TK, typename TV>
            rusty::Result<rusty::Option<std::tuple<typename TK::Value, typename TV::Value>>, Error> next_entry_seed(TK kseed, TV vseed) {
                return [&]() -> rusty::Result<rusty::Option<std::tuple<typename TK::Value, typename TV::Value>>, Error> { auto&& _m = this->next_pair(); if (_m.is_some()) { auto&& _mv0 = _m.unwrap(); auto&& key = rusty::detail::deref_if_pointer(std::get<0>(rusty::detail::deref_if_pointer(_mv0))); auto&& value = rusty::detail::deref_if_pointer(std::get<1>(rusty::detail::deref_if_pointer(_mv0))); return [&]() -> rusty::Result<rusty::Option<std::tuple<typename TK::Value, typename TV::Value>>, Error> { auto key_shadow1 = ({ auto&& _m = ([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::de::rusty_ext::deserialize(std::forward<decltype(__self)>(__self), ([&](auto&& _into_deser_recv) -> decltype(auto) { if constexpr (requires { ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else if constexpr (requires { ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else { return std::forward<decltype(_into_deser_recv)>(_into_deser_recv).into_deserializer(); } })(std::move(key))); }) { return ::de::rusty_ext::deserialize(std::forward<decltype(__self)>(__self), ([&](auto&& _into_deser_recv) -> decltype(auto) { if constexpr (requires { ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else if constexpr (requires { ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else { return std::forward<decltype(_into_deser_recv)>(_into_deser_recv).into_deserializer(); } })(std::move(key))); } else { return ::de::rusty_ext::deserialize(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), ([&](auto&& _into_deser_recv) -> decltype(auto) { if constexpr (requires { ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else if constexpr (requires { ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else { return std::forward<decltype(_into_deser_recv)>(_into_deser_recv).into_deserializer(); } })(std::move(key))); } })(kseed); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(_mv)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
auto&& err = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
return rusty::Result<rusty::Option<std::tuple<typename TK::Value, typename TV::Value>>, Error>::Err(err); } std::move(_match_value).value(); });
auto value_shadow1 = ({ auto&& _m = ([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::de::rusty_ext::deserialize(std::forward<decltype(__self)>(__self), ([&](auto&& _into_deser_recv) -> decltype(auto) { if constexpr (requires { ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else if constexpr (requires { ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else { return std::forward<decltype(_into_deser_recv)>(_into_deser_recv).into_deserializer(); } })(std::move(value))); }) { return ::de::rusty_ext::deserialize(std::forward<decltype(__self)>(__self), ([&](auto&& _into_deser_recv) -> decltype(auto) { if constexpr (requires { ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else if constexpr (requires { ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else { return std::forward<decltype(_into_deser_recv)>(_into_deser_recv).into_deserializer(); } })(std::move(value))); } else { return ::de::rusty_ext::deserialize(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), ([&](auto&& _into_deser_recv) -> decltype(auto) { if constexpr (requires { ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else if constexpr (requires { ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else { return std::forward<decltype(_into_deser_recv)>(_into_deser_recv).into_deserializer(); } })(std::move(value))); } })(vseed); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(_mv)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
auto&& err = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
return rusty::Result<rusty::Option<std::tuple<typename TK::Value, typename TV::Value>>, Error>::Err(err); } std::move(_match_value).value(); });
...
return ([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::de::rusty_ext::deserialize(std::forward<decltype(__self)>(__self), std::move(de_shadow1)); }) { return ::de::rusty_ext::deserialize(std::forward<decltype(__self)>(__self), std::move(de_shadow1)); } else { return ::de::rusty_ext::deserialize(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), std::move(de_shadow1)); } })(seed).map(rusty::Some); }(); } if (_m.is_none()) { return rusty::Result<rusty::Option<typename T::Value>, Error>::Ok(rusty::Option<typename T::Value>(rusty::None)); } return [&]() -> rusty::Result<rusty::Option<typename T::Value>, Error> { rusty::intrinsics::unreachable(); }(); }();
            }
...
return rusty::Result<typename V::Value, Error>::Err(err); } std::move(_match_value).value(); });
        ...
        struct PairVisitor {
            ...
            rusty::Result<rusty::Option<typename T::Value>, Error> next_element_seed(T seed) {
                if (auto&& _iflet_scrutinee = this->_0.take(); _iflet_scrutinee.is_some()) {
                    ...
                    return ([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::de::rusty_ext::deserialize(std::forward<decltype(__self)>(__self), ([&](auto&& _into_deser_recv) -> decltype(auto) { if constexpr (requires { ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else if constexpr (requires { ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else { return std::forward<decltype(_into_deser_recv)>(_into_deser_recv).into_deserializer(); } })(std::move(k))); }) { return ::de::rusty_ext::deserialize(std::forward<decltype(__self)>(__self), ([&](auto&& _into_deser_recv) -> decltype(auto) { if constexpr (requires { ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else if constexpr (requires { ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else { return std::forward<decltype(_into_deser_recv)>(_into_deser_recv).into_deserializer(); } })(std::move(k))); } else { return ::de::rusty_ext::deserialize(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), ([&](auto&& _into_deser_recv) -> decltype(auto) { if constexpr (requires { ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else if constexpr (requires { ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else { return std::forward<decltype(_into_deser_recv)>(_into_deser_recv).into_deserializer(); } })(std::move(k))); } })(seed).map(rusty::Some);
                } else if (auto&& _iflet_scrutinee = this->_1.take(); _iflet_scrutinee.is_some()) {
                    decltype(auto) v = _iflet_scrutinee.unwrap();
                    return ([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::de::rusty_ext::deserialize(std::forward<decltype(__self)>(__self), ([&](auto&& _into_deser_recv) -> decltype(auto) { if constexpr (requires { ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else if constexpr (requires { ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else { return std::forward<decltype(_into_deser_recv)>(_into_deser_recv).into_deserializer(); } })(std::move(v))); }) { return ::de::rusty_ext::deserialize(std::forward<decltype(__self)>(__self), ([&](auto&& _into_deser_recv) -> decltype(auto) { if constexpr (requires { ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else if constexpr (requires { ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else { return std::forward<decltype(_into_deser_recv)>(_into_deser_recv).into_deserializer(); } })(std::move(v))); } else { return ::de::rusty_ext::deserialize(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), ([&](auto&& _into_deser_recv) -> decltype(auto) { if constexpr (requires { ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer<E>(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else if constexpr (requires { ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); }) { return ::de::value::rusty_ext::into_deserializer(std::forward<decltype(_into_deser_recv)>(_into_deser_recv)); } else { return std::forward<decltype(_into_deser_recv)>(_into_deser_recv).into_deserializer(); } })(std::move(v))); } })(seed).map(rusty::Some);
                } else {
        ...
        struct MapAccessDeserializer {
            ...
            // Rust-only dependent associated type alias skipped in constrained mode: Error
            template<typename T>
            auto variant_seed(T seed) {
                return [&]() { auto&& _m = ({ auto&& _m = this->map.next_key_seed(std::move(seed)); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(_mv)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
auto&& err = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
return rusty::Result<std::tuple<typename T::Value, Variant>, typename A::Error>::Err(err); } std::move(_match_value).value(); }); if (_m.is_some()) { auto&& _mv0 = _m.unwrap(); auto&& key = rusty::detail::deref_if_pointer(_mv0); return rusty::Result<std::tuple<typename T::Value, Variant>, typename A::Error>::Ok(std::make_tuple(std::move(key), private_::map_as_enum(std::move(this->map)))); } if (_m.is_none()) { return rusty::Result<std::tuple<typename T::Value, Variant>, typename A::Error>::Err(A::Error::invalid_type(::de::Unexpected_Map{}, "enum")); } rusty::intrinsics::unreachable(); }();
            }
        };
        ...
        namespace private_ {
            ...
            struct UnitOnly {
                ...
                auto unit_variant() -> rusty::Result<std::tuple<>, Error> {
                    return rusty::Result<std::tuple<>, Error>::Ok(std::make_tuple());
                }
                template<typename T>
                rusty::Result<typename T::Value, Error> newtype_variant_seed(T _seed) {
                    return rusty::Result<typename T::Value, Error>::Err(std::conditional_t<true, Error, T>::invalid_type(de::Unexpected_UnitVariant{}, "newtype variant"));
                }
                template<typename V>
                rusty::Result<typename V::Value, Error> tuple_variant(size_t _len, V _visitor) {
                    return rusty::Result<typename V::Value, Error>::Err(std::conditional_t<true, Error, V>::invalid_type(de::Unexpected_UnitVariant{}, "tuple variant"));
                }
                template<typename V>
                rusty::Result<typename V::Value, Error> struct_variant(std::span<const std::string_view> _fields, V _visitor) {
                    return rusty::Result<typename V::Value, Error>::Err(std::conditional_t<true, Error, V>::invalid_type(de::Unexpected_UnitVariant{}, "struct variant"));
                }
            };
            ...
            struct MapAsEnum {
                ...
                template<typename V>
                auto tuple_variant(size_t len, V visitor) {
                    return this->map.next_value_seed(SeedTupleVariant<V>(std::move(len), std::move(visitor)));
                }
                template<typename V>
                auto struct_variant(std::span<const std::string_view> _fields, V visitor) {
    ...
    Windows
        ...
        struct OptionVisitor {
            ...
            template<typename D>
            auto __private_visit_untagged_option(D deserializer) -> rusty::Result<Value, std::tuple<>> {
        ...
        struct ArrayInPlaceVisitor {
            ...
            rusty::Result<Value, typename A::Error> visit_seq(A seq) {
                ...
                for (auto&& _for_item : rusty::for_in(rusty::enumerate(rusty::iter_mut(rusty::slice_full(this->_0))))) {
                    auto&& idx = rusty::detail::deref_if_pointer(std::get<0>(rusty::detail::deref_if_pointer(_for_item)));
                    auto&& dest = rusty::detail::deref_if_pointer(std::get<1>(rusty::detail::deref_if_pointer(_for_item)));
...
_match_value.emplace(std::move(_mv)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
auto&& err = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
return rusty::Result<Value, typename A::Error>::Err(err); } std::move(_match_value).value(); }).is_none()) {
...
_match_value.emplace(std::move(_mv)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
auto&& err = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
return rusty::Result<Value, typename A::Error>::Err(err); } std::move(_match_value).value(); }); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& value = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(_mv)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Result<Value, typename A::Error>::Err(A::Error::invalid_length(0, (*this))); } std::move(_match_value).value(); });
...
return rusty::Result<Value, typename A::Error>::Err(err); } std::move(_match_value).value(); }); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& value = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(_mv)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Result<Value, typename A::Error>::Err(A::Error::invalid_length(1, (*this))); } std::move(_match_value).value(); });
...
return rusty::Result<Value, typename A::Error>::Err(err); } std::move(_match_value).value(); });
                        ...
                        case Field::Start:
                        {
                            ...
                            start = rusty::Option<Idx>(({ auto&& _m = map.next_value(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(_mv)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
auto&& err = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
return rusty::Result<Value, typename A::Error>::Err(err); } std::move(_match_value).value(); }));
                        ...
                        case Field::End:
                        {
                            ...
                            end = rusty::Option<Idx>(({ auto&& _m = map.next_value(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(_mv)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
auto&& err = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
return rusty::Result<Value, typename A::Error>::Err(err); } std::move(_match_value).value(); }));
                    ...
                    auto start_shadow1 = ({ auto&& _m = start; std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& start = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(_mv)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Result<Value, typename A::Error>::Err(A::Error::missing_field("start")); } std::move(_match_value).value(); });
                    auto end_shadow1 = ({ auto&& _m = end; std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& end = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(_mv)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Result<Value, typename A::Error>::Err(A::Error::missing_field("end")); } std::move(_match_value).value(); });
...
_match_value.emplace(std::move(_mv)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Result<Value, typename A::Error>::Err(A::Error::missing_field("end")); } std::move(_match_value).value(); });
        ...
        struct FromStrVisitor {
            ...
            rusty::Result<Value, E> visit_str(std::string_view s) {
                return Value::from_str(rusty::to_string_view(s)).map_err([&](auto&& _err) -> E { return (E::custom) (std::forward<decltype(_err)>(_err)); });
            }
        };
...
if constexpr (requires { self_.expecting(formatter); }) {
    return self_.expecting(formatter);
}
return formatter.write_str(rusty::to_string(self_));
        }
...
namespace ser {
    ...
    namespace impls {
        ...
        void test_format_u8() {
            auto i = static_cast<uint8_t>(0);
            while (true) {
                auto buf = [](auto _seed) { std::array<uint8_t, 3> _repeat{}; _repeat.fill(static_cast<uint8_t>(_seed)); return _repeat; }(static_cast<uint8_t>(0));
                const auto written = format_u8(std::move(i), buf);
                {
                    auto&& _m0_tmp = rusty::as_bytes(rusty::to_string(i));
                    auto _m0 = &_m0_tmp;
                    auto&& _m1_tmp = rusty::slice_to(buf, written);
                    auto _m1 = &_m1_tmp;
                ...
                {
                    auto&& _m = [&]() { auto&& _checked_lhs = i; return rusty::checked_add(_checked_lhs, static_cast<std::remove_cvref_t<decltype((_checked_lhs))>>(1)); }();
                    bool _m_matched = false;
                    if (!_m_matched) {
                        if (_m.is_some()) {
                            auto&& _mv0 = _m.unwrap();
...
return rusty::Result<typename S::Ok, typename S::Error>::Err(err); } std::move(_match_value).value(); });
            ...
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::Bound<T>& self_, S serializer) {
                using Self = std::remove_reference_t<decltype(self_)>;
                return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { auto&& _m = self_; if (std::holds_alternative<std::variant_alternative_t<0, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))) { return serializer.serialize_unit_variant(std::string_view("Bound"), static_cast<uint32_t>(0), std::string_view("Unbounded")); } if (std::holds_alternative<std::variant_alternative_t<1, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))) { const auto& value = std::get<std::variant_alternative_t<1, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))._0; return serializer.serialize_newtype_variant(std::string_view("Bound"), static_cast<uint32_t>(1), std::string_view("Included"), rusty::detail::deref_if_pointer_like(value)); } if (std::holds_alternative<std::variant_alternative_t<2, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))) { const auto& value = std::get<std::variant_alternative_t<2, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))._0; return serializer.serialize_newtype_variant(std::string_view("Bound"), static_cast<uint32_t>(2), std::string_view("Excluded"), rusty::detail::deref_if_pointer_like(value)); } return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { rusty::intrinsics::unreachable(); }(); }();
            }
            ...
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::Box<T>& self_, S serializer) {
                using Self = std::remove_reference_t<decltype(self_)>;
                return ([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); }) { return ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); } else { return ::ser::impls::rusty_ext::serialize(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), std::move(serializer)); } })((*(*(self_))));
            }

            template<typename S, typename T>
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::Cow& self_, S serializer) {
                using Self = std::remove_reference_t<decltype(self_)>;
                return ([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); }) { return ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); } else { return ::ser::impls::rusty_ext::serialize(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), std::move(serializer)); } })((rusty::detail::deref_if_pointer_like(self_)));
            }

            template<typename S>
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::num::NonZeroI8& self_, S serializer) {
                using Self = std::remove_reference_t<decltype(self_)>;
                return ([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); }) { return ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); } else { return ::ser::impls::rusty_ext::serialize(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), std::move(serializer)); } })(self_.get());
            }
            ...
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::RefCell<T>& self_, S serializer) {
                using Self = std::remove_reference_t<decltype(self_)>;
                return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { auto&& _m = self_.try_borrow(); if (_m.is_ok()) { auto&& _mv0 = _m.unwrap(); auto&& value = rusty::detail::deref_if_pointer(_mv0); return ([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); }) { return ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); } else { return ::ser::impls::rusty_ext::serialize(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), std::move(serializer)); } })(value); } if (_m.is_err()) { return rusty::Result<typename S::Ok, typename S::Error>::Err(S::Error::custom("already mutably borrowed")); } return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { rusty::intrinsics::unreachable(); }(); }();
            }

            template<typename S, typename T>
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::Mutex<T>& self_, S serializer) {
                using Self = std::remove_reference_t<decltype(self_)>;
                return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { auto&& _m = self_.lock(); if (_m.is_ok()) { auto&& _mv0 = _m.unwrap(); auto&& locked = rusty::detail::deref_if_pointer(_mv0); return ([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); }) { return ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); } else { return ::ser::impls::rusty_ext::serialize(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), std::move(serializer)); } })(locked); } if (_m.is_err()) { return rusty::Result<typename S::Ok, typename S::Error>::Err(S::Error::custom("lock poison error while serializing")); } return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { rusty::intrinsics::unreachable(); }(); }();
            }

            template<typename S, typename T>
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::RwLock<T>& self_, S serializer) {
                using Self = std::remove_reference_t<decltype(self_)>;
                return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { auto&& _m = self_.read(); if (_m.is_ok()) { auto&& _mv0 = _m.unwrap(); auto&& locked = rusty::detail::deref_if_pointer(_mv0); return ([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); }) { return ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); } else { return ::ser::impls::rusty_ext::serialize(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), std::move(serializer)); } })(locked); } if (_m.is_err()) { return rusty::Result<typename S::Ok, typename S::Error>::Err(S::Error::custom("lock poison error while serializing")); } return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { rusty::intrinsics::unreachable(); }(); }();
            }
...
return rusty::Result<typename S::Ok, typename S::Error>::Err(err); } std::move(_match_value).value(); });
                {
                    auto&& _m = state.serialize_field("secs", rusty::detail::deref_if_pointer_like(self_.as_secs()));
                    bool _m_matched = false;
                    if (!_m_matched) {
                        if (_m.is_ok()) {
                            auto&& _mv0 = _m.unwrap();
                ...
                {
                    auto&& _m = state.serialize_field("nanos", rusty::detail::deref_if_pointer_like(self_.subsec_nanos()));
                    bool _m_matched = false;
                    if (!_m_matched) {
                        if (_m.is_ok()) {
                            auto&& _mv0 = _m.unwrap();
...
auto&& duration_since_epoch = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
_match_value.emplace(std::move(_mv)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
...
return rusty::Result<typename S::Ok, typename S::Error>::Err(err); } std::move(_match_value).value(); });
                {
                    auto&& _m = state.serialize_field("secs_since_epoch", rusty::detail::deref_if_pointer_like(duration_since_epoch.as_secs()));
                    bool _m_matched = false;
                    if (!_m_matched) {
                        if (_m.is_ok()) {
                            auto&& _mv0 = _m.unwrap();
                ...
                {
                    auto&& _m = state.serialize_field("nanos_since_epoch", rusty::detail::deref_if_pointer_like(duration_since_epoch.subsec_nanos()));
                    bool _m_matched = false;
                    if (!_m_matched) {
                        if (_m.is_ok()) {
                            auto&& _mv0 = _m.unwrap();
            ...
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::net::IpAddr& self_, S serializer) {
                ...
                if (serializer.is_human_readable()) {
                    return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { auto&& _m = self_; if (std::holds_alternative<rusty::net::IpAddr_V4>(rusty::detail::deref_if_pointer(_m))) { const auto& a = std::get<rusty::net::IpAddr_V4>(rusty::detail::deref_if_pointer(_m))._0; return ([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); }) { return ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); } else { return ::ser::impls::rusty_ext::serialize(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), std::move(serializer)); } })(a); } if (std::holds_alternative<rusty::net::IpAddr_V6>(rusty::detail::deref_if_pointer(_m))) { const auto& a = std::get<rusty::net::IpAddr_V6>(rusty::detail::deref_if_pointer(_m))._0; return ([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); }) { return ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); } else { return ::ser::impls::rusty_ext::serialize(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), std::move(serializer)); } })(a); } return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { rusty::intrinsics::unreachable(); }(); }();
                } else {
                    return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { auto&& _m = self_; if (std::holds_alternative<rusty::net::IpAddr_V4>(rusty::detail::deref_if_pointer(_m))) { const auto& a = std::get<rusty::net::IpAddr_V4>(rusty::detail::deref_if_pointer(_m))._0; return serializer.serialize_newtype_variant(std::string_view("IpAddr"), static_cast<uint32_t>(0), std::string_view("V4"), rusty::detail::deref_if_pointer_like(a)); } if (std::holds_alternative<rusty::net::IpAddr_V6>(rusty::detail::deref_if_pointer(_m))) { const auto& a = std::get<rusty::net::IpAddr_V6>(rusty::detail::deref_if_pointer(_m))._0; return serializer.serialize_newtype_variant(std::string_view("IpAddr"), static_cast<uint32_t>(1), std::string_view("V6"), rusty::detail::deref_if_pointer_like(a)); } return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { rusty::intrinsics::unreachable(); }(); }();
                }
            }
            ...
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::net::Ipv4Addr& self_, S serializer) {
                ...
                if (serializer.is_human_readable()) {
                    ...
                    return ([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); }) { return ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); } else { return ::ser::impls::rusty_ext::serialize(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), std::move(serializer)); } })(self_.octets());
                }
            }
            ...
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::net::SocketAddr& self_, S serializer) {
                using Self = std::remove_reference_t<decltype(self_)>;
                if (serializer.is_human_readable()) {
                    return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { auto&& _m = self_; if (std::holds_alternative<rusty::net::SocketAddr_V4>(rusty::detail::deref_if_pointer(_m))) { const auto& addr = std::get<rusty::net::SocketAddr_V4>(rusty::detail::deref_if_pointer(_m))._0; return ([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); }) { return ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); } else { return ::ser::impls::rusty_ext::serialize(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), std::move(serializer)); } })(addr); } if (std::holds_alternative<rusty::net::SocketAddr_V6>(rusty::detail::deref_if_pointer(_m))) { const auto& addr = std::get<rusty::net::SocketAddr_V6>(rusty::detail::deref_if_pointer(_m))._0; return ([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); }) { return ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); } else { return ::ser::impls::rusty_ext::serialize(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), std::move(serializer)); } })(addr); } return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { rusty::intrinsics::unreachable(); }(); }();
                } else {
                    return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { auto&& _m = self_; if (std::holds_alternative<rusty::net::SocketAddr_V4>(rusty::detail::deref_if_pointer(_m))) { const auto& addr = std::get<rusty::net::SocketAddr_V4>(rusty::detail::deref_if_pointer(_m))._0; return serializer.serialize_newtype_variant(std::string_view("SocketAddr"), static_cast<uint32_t>(0), std::string_view("V4"), rusty::detail::deref_if_pointer_like(addr)); } if (std::holds_alternative<rusty::net::SocketAddr_V6>(rusty::detail::deref_if_pointer(_m))) { const auto& addr = std::get<rusty::net::SocketAddr_V6>(rusty::detail::deref_if_pointer(_m))._0; return serializer.serialize_newtype_variant(std::string_view("SocketAddr"), static_cast<uint32_t>(1), std::string_view("V6"), rusty::detail::deref_if_pointer_like(addr)); } return [&]() -> rusty::Result<typename S::Ok, typename S::Error> { rusty::intrinsics::unreachable(); }(); }();
                }
            }
            ...
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::net::SocketAddrV4& self_, S serializer) {
                ...
                if (serializer.is_human_readable()) {
                    ...
                    return ([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); }) { return ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); } else { return ::ser::impls::rusty_ext::serialize(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), std::move(serializer)); } })(std::make_tuple(self_.ip(), self_.port()));
                }
            }
            ...
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::path::PathBuf& self_, S serializer) {
                using Self = std::remove_reference_t<decltype(self_)>;
                return ([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); }) { return ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); } else { return ::ser::impls::rusty_ext::serialize(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), std::move(serializer)); } })(self_.as_path());
            }

            template<typename S, typename T>
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::num::Wrapping<T>& self_, S serializer) {
                using Self = std::remove_reference_t<decltype(self_)>;
                return ([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); }) { return ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); } else { return ::ser::impls::rusty_ext::serialize(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), std::move(serializer)); } })(self_._0);
            }
            ...
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::sync::atomic::AtomicBool& self_, S serializer) {
                using Self = std::remove_reference_t<decltype(self_)>;
                return ([&](auto&& __self) -> decltype(auto) { if constexpr (requires { ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); }) { return ::ser::impls::rusty_ext::serialize(std::forward<decltype(__self)>(__self), std::move(serializer)); } else { return ::ser::impls::rusty_ext::serialize(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), std::move(serializer)); } })(self_.load(Ordering::Relaxed));
            }
...
namespace de {
    rusty::fmt::Result OneOf::fmt(rusty::fmt::Formatter& formatter) const {
        return [&]() { auto&& _m = rusty::len(this->names); if (_m == 0) [&]() -> rusty::fmt::Result { rusty::panicking::panic("explicit panic"); }();
if (_m == 1) return rusty::write_fmt(formatter, std::format("`{0}`", rusty::to_string(this->names[0])));
if (_m == 2) return rusty::write_fmt(formatter, std::format("`{0}` or `{1}`", rusty::to_string(this->names[0]), rusty::to_string(this->names[1])));
return [&]() -> rusty::fmt::Result { {
    ...
    if (!_m_matched) {
        if (_m.is_err()) {
            auto&& _mv1 = _m.unwrap_err();
            auto&& err = rusty::detail::deref_if_pointer(_mv1);
            return rusty::fmt::Result::Err(err);
            _m_matched = true;
        }
    }
}
for (auto&& _for_item : rusty::for_in(rusty::enumerate(rusty::iter(this->names)))) {
    ...
    auto&& alt = rusty::detail::deref_if_pointer(std::get<1>(rusty::detail::deref_if_pointer(_for_item)));
    if (i > 0) {
        {
...
namespace de {
    bool Unexpected::operator==(const Unexpected& other) const {
        ...
        return (__self_discr == __arg1_discr) && [&]() -> bool { auto&& _m0 = (*this); auto&& _m1 = other; if (std::holds_alternative<std::variant_alternative_t<0, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m0))>>>(rusty::detail::deref_if_pointer(_m0)) && std::holds_alternative<std::variant_alternative_t<0, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m1))>>>(rusty::detail::deref_if_pointer(_m1))) { auto&& __self_0 = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<0, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m0))>>>(rusty::detail::deref_if_pointer(_m0))._0); auto&& __arg1_0 = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<0, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m1))>>>(rusty::detail::deref_if_pointer(_m1))._0); return __self_0 == __arg1_0; } if (std::holds_alternative<std::variant_alternative_t<1, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m0))>>>(rusty::detail::deref_if_pointer(_m0)) && std::holds_alternative<std::variant_alternative_t<1, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m1))>>>(rusty::detail::deref_if_pointer(_m1))) { auto&& __self_0 = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<1, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m0))>>>(rusty::detail::deref_if_pointer(_m0))._0); auto&& __arg1_0 = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<1, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m1))>>>(rusty::detail::deref_if_pointer(_m1))._0); return __self_0 == __arg1_0; } if (std::holds_alternative<std::variant_alternative_t<2, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m0))>>>(rusty::detail::deref_if_pointer(_m0)) && std::holds_alternative<std::variant_alternative_t<2, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m1))>>>(rusty::detail::deref_if_pointer(_m1))) { auto&& __self_0 = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<2, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m0))>>>(rusty::detail::deref_if_pointer(_m0))._0); auto&& __arg1_0 = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<2, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m1))>>>(rusty::detail::deref_if_pointer(_m1))._0); return __self_0 == __arg1_0; } if (std::holds_alternative<std::variant_alternative_t<3, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m0))>>>(rusty::detail::deref_if_pointer(_m0)) && std::holds_alternative<std::variant_alternative_t<3, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m1))>>>(rusty::detail::deref_if_pointer(_m1))) { auto&& __self_0 = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<3, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m0))>>>(rusty::detail::deref_if_pointer(_m0))._0); auto&& __arg1_0 = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<3, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m1))>>>(rusty::detail::deref_if_pointer(_m1))._0); return __self_0 == __arg1_0; } if (std::holds_alternative<std::variant_alternative_t<4, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m0))>>>(rusty::detail::deref_if_pointer(_m0)) && std::holds_alternative<std::variant_alternative_t<4, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m1))>>>(rusty::detail::deref_if_pointer(_m1))) { auto&& __self_0 = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<4, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m0))>>>(rusty::detail::deref_if_pointer(_m0))._0); auto&& __arg1_0 = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<4, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m1))>>>(rusty::detail::deref_if_pointer(_m1))._0); return __self_0 == __arg1_0; } if (std::holds_alternative<std::variant_alternative_t<5, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m0))>>>(rusty::detail::deref_if_pointer(_m0)) && std::holds_alternative<std::variant_alternative_t<5, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m1))>>>(rusty::detail::deref_if_pointer(_m1))) { auto&& __self_0 = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<5, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m0))>>>(rusty::detail::deref_if_pointer(_m0))._0); auto&& __arg1_0 = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<5, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m1))>>>(rusty::detail::deref_if_pointer(_m1))._0); return __self_0 == __arg1_0; } if (std::holds_alternative<std::variant_alternative_t<6, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m0))>>>(rusty::detail::deref_if_pointer(_m0)) && std::holds_alternative<std::variant_alternative_t<6, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m1))>>>(rusty::detail::deref_if_pointer(_m1))) { auto&& __self_0 = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<6, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m0))>>>(rusty::detail::deref_if_pointer(_m0))._0); auto&& __arg1_0 = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<6, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m1))>>>(rusty::detail::deref_if_pointer(_m1))._0); return __self_0 == __arg1_0; } if (std::holds_alternative<std::variant_alternative_t<17, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m0))>>>(rusty::detail::deref_if_pointer(_m0)) && std::holds_alternative<std::variant_alternative_t<17, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m1))>>>(rusty::detail::deref_if_pointer(_m1))) { auto&& __self_0 = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<17, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m0))>>>(rusty::detail::deref_if_pointer(_m0))._0); auto&& __arg1_0 = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<17, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m1))>>>(rusty::detail::deref_if_pointer(_m1))._0); return __self_0 == __arg1_0; } if (true) { return true; } return [&]() -> bool { rusty::intrinsics::unreachable(); }(); }();
    }
}
...
namespace de {
    rusty::fmt::Result Unexpected::fmt(rusty::fmt::Formatter& formatter) const {
        ...
        return [&]() -> rusty::fmt::Result { auto&& _m = (*this); if (std::holds_alternative<std::variant_alternative_t<0, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))) { auto&& b = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<0, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))._0); return rusty::write_fmt(formatter, std::format("boolean `{0}`", rusty::to_string(b))); } if (std::holds_alternative<std::variant_alternative_t<1, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))) { auto&& i = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<1, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))._0); return rusty::write_fmt(formatter, std::format("integer `{0}`", rusty::to_string(i))); } if (std::holds_alternative<std::variant_alternative_t<2, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))) { auto&& i = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<2, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))._0); return rusty::write_fmt(formatter, std::format("integer `{0}`", rusty::to_string(i))); } if (std::holds_alternative<std::variant_alternative_t<3, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))) { auto&& f = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<3, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))._0); return rusty::write_fmt(formatter, std::format("floating point `{0}`", rusty::to_string(WithDecimalPoint(f)))); } if (std::holds_alternative<std::variant_alternative_t<4, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))) { auto&& c = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<4, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))._0); return rusty::write_fmt(formatter, std::format("character `{0}`", rusty::to_string(c))); } if (std::holds_alternative<std::variant_alternative_t<5, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))) { auto&& s = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<5, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))._0); return rusty::write_fmt(formatter, std::format("string {0}", rusty::to_debug_string(s))); } if (std::holds_alternative<std::variant_alternative_t<6, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))) { return formatter.write_str(std::string_view("byte array")); } if (true) { const auto& Unit = _m; return formatter.write_str(std::string_view("unit value")); } if (true) { const auto& Option = _m; return formatter.write_str(std::string_view("Option value")); } if (true) { const auto& NewtypeStruct = _m; return formatter.write_str(std::string_view("newtype struct")); } if (true) { const auto& Seq = _m; return formatter.write_str(std::string_view("sequence")); } if (true) { const auto& Map = _m; return formatter.write_str(std::string_view("map")); } if (true) { const auto& Enum = _m; return formatter.write_str(std::string_view("enum")); } if (true) { const auto& UnitVariant = _m; return formatter.write_str(std::string_view("unit variant")); } if (true) { const auto& NewtypeVariant = _m; return formatter.write_str(std::string_view("newtype variant")); } if (true) { const auto& TupleVariant = _m; return formatter.write_str(std::string_view("tuple variant")); } if (true) { const auto& StructVariant = _m; return formatter.write_str(std::string_view("struct variant")); } if (std::holds_alternative<std::variant_alternative_t<17, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))) { auto&& other = rusty::detail::deref_if_pointer(std::get<std::variant_alternative_t<17, rusty::detail::variant_underlying_type_t<decltype(rusty::detail::deref_if_pointer(_m))>>>(rusty::detail::deref_if_pointer(_m))._0); return formatter.write_str(rusty::to_string_view(other)); } return [&]() -> rusty::fmt::Result { rusty::intrinsics::unreachable(); }(); }();
    }
}
...
namespace de::ignored_any {
        IgnoredAny IgnoredAny::clone() const {
            using Value = typename IgnoredAny::Value;
            return {};
        }
}
...
_match_value.emplace(std::move(_mv)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
auto&& err = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
return rusty::Result<IgnoredAny, typename A::Error>::Err(err); } std::move(_match_value).value(); });
                if (!(_whilelet.is_some())) { break; }
...
_match_value.emplace(std::move(_mv)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
auto&& err = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
return rusty::Result<IgnoredAny, typename A::Error>::Err(err); } std::move(_match_value).value(); })._1.newtype_variant();
        }
}
...
_match_value.emplace(std::move(_mv)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
auto&& err = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
return rusty::Result<std::tuple<>, typename D::Error>::Err(err); } std::move(_match_value).value(); });
...
namespace de::impls {
        rusty::fmt::Result UnitVisitor::expecting(rusty::fmt::Formatter& formatter) const {
            using Value = typename UnitVisitor::Value;
            return formatter.write_str(std::string_view("unit"));
        }
}
...
namespace de::impls {
        rusty::fmt::Result BoolVisitor::expecting(rusty::fmt::Formatter& formatter) const {
            using Value = typename BoolVisitor::Value;
...
namespace de::impls {
        rusty::fmt::Result CharVisitor::expecting(rusty::fmt::Formatter& formatter) const {
            using Value = typename CharVisitor::Value;
...
namespace de::impls {
        ...
        rusty::Result<char32_t, E> CharVisitor::visit_str(std::string_view v) {
            ...
            return [&]() -> rusty::Result<char32_t, E> { auto&& _m0 = iter.next(); auto&& _m1 = iter.next(); if (rusty::detail::deref_if_pointer(_m0).is_some() && _m1.is_none()) { auto&& c = rusty::detail::deref_if_pointer(std::as_const(rusty::detail::deref_if_pointer(_m0)).unwrap()); return rusty::Result<char32_t, E>::Ok(c); } if (true) { return rusty::Result<char32_t, E>::Err(E::invalid_value(de::Unexpected_Str{std::string_view(v)}, (*this))); } return [&]() -> rusty::Result<char32_t, E> { rusty::intrinsics::unreachable(); }(); }();
        }
}

namespace de::impls {
        rusty::fmt::Result StringVisitor::expecting(rusty::fmt::Formatter& formatter) const {
            using Value = typename StringVisitor::Value;
...
namespace de::impls {
        ...
        rusty::Result<rusty::String, E> StringVisitor::visit_bytes(std::span<const uint8_t> v) {
            using Value = typename StringVisitor::Value;
            return [&]() -> rusty::Result<rusty::String, E> { auto&& _m = rusty::str_runtime::from_utf8(v); if (_m.is_ok()) { auto&& _mv0 = _m.unwrap(); auto&& s = rusty::detail::deref_if_pointer(_mv0); return rusty::Result<rusty::String, E>::Ok(rusty::to_owned(std::move(s))); } if (_m.is_err()) { return rusty::Result<rusty::String, E>::Err(E::invalid_value(de::Unexpected_Bytes{v}, (*this))); } return [&]() -> rusty::Result<rusty::String, E> { rusty::intrinsics::unreachable(); }(); }();
        }
}
...
namespace de::impls {
        ...
        rusty::Result<rusty::String, E> StringVisitor::visit_byte_buf(rusty::Vec<uint8_t> v) {
            using Value = typename StringVisitor::Value;
            return [&]() -> rusty::Result<rusty::String, E> { auto&& _m = std::conditional_t<true, rusty::String, E>::from_utf8(std::move(v)); if (_m.is_ok()) { auto&& _mv0 = _m.unwrap(); auto&& s = rusty::detail::deref_if_pointer(_mv0); return rusty::Result<rusty::String, E>::Ok(std::move(s)); } if (_m.is_err()) { auto&& _mv1 = _m.unwrap_err(); auto&& e = rusty::detail::deref_if_pointer(_mv1); return rusty::Result<rusty::String, E>::Err(E::invalid_value(de::Unexpected_Bytes{[&]() -> std::span<const uint8_t> { static const auto _slice_ref_tmp = e.into_bytes(); return std::span<const uint8_t>(_slice_ref_tmp); }()}, (*this))); } return [&]() -> rusty::Result<rusty::String, E> { rusty::intrinsics::unreachable(); }(); }();
        }
}

namespace de::impls {
        rusty::fmt::Result StringInPlaceVisitor::expecting(rusty::fmt::Formatter& formatter) const {
            using Value = typename StringInPlaceVisitor::Value;
            return formatter.write_str(std::string_view("a string"));
        }
}
...
namespace de::impls {
        ...
        rusty::Result<std::tuple<>, E> StringInPlaceVisitor::visit_bytes(std::span<const uint8_t> v) {
            using Value = typename StringInPlaceVisitor::Value;
            return [&]() -> rusty::Result<std::tuple<>, E> { auto&& _m = rusty::str_runtime::from_utf8(v); if (_m.is_ok()) { auto&& _mv0 = _m.unwrap(); auto&& s = rusty::detail::deref_if_pointer(_mv0); return [&]() -> rusty::Result<std::tuple<>, E> { this->_0.clear();
...
namespace de::impls {
        ...
        rusty::Result<std::tuple<>, E> StringInPlaceVisitor::visit_byte_buf(rusty::Vec<uint8_t> v) {
            using Value = typename StringInPlaceVisitor::Value;
            return [&]() -> rusty::Result<std::tuple<>, E> { auto&& _m = std::conditional_t<true, rusty::String, E>::from_utf8(std::move(v)); if (_m.is_ok()) { auto&& _mv0 = _m.unwrap(); auto&& s = rusty::detail::deref_if_pointer(_mv0); return [&]() -> rusty::Result<std::tuple<>, E> { this->_0 = std::move(s);
return rusty::Result<std::tuple<>, E>::Ok(std::make_tuple()); }(); } if (_m.is_err()) { auto&& _mv1 = _m.unwrap_err(); auto&& e = rusty::detail::deref_if_pointer(_mv1); return rusty::Result<std::tuple<>, E>::Err(E::invalid_value(de::Unexpected_Bytes{[&]() -> std::span<const uint8_t> { static const auto _slice_ref_tmp = e.into_bytes(); return std::span<const uint8_t>(_slice_ref_tmp); }()}, (*this))); } return [&]() -> rusty::Result<std::tuple<>, E> { rusty::intrinsics::unreachable(); }(); }();
        }
}

namespace de::impls {
        rusty::fmt::Result StrVisitor::expecting(rusty::fmt::Formatter& formatter) const {
            using Value = typename StrVisitor::Value;
...
namespace de::impls {
        rusty::fmt::Result BytesVisitor::expecting(rusty::fmt::Formatter& formatter) const {
            using Value = typename BytesVisitor::Value;
...
namespace de::impls {
        rusty::fmt::Result CStringVisitor::expecting(rusty::fmt::Formatter& formatter) const {
            using Value = typename CStringVisitor::Value;
...
_match_value.emplace(std::move(_mv)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
auto&& err = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
return rusty::Result<rusty::ffi::CString, typename A::Error>::Err(err); } std::move(_match_value).value(); });
                if (!(_whilelet.is_some())) { break; }
...
namespace de::impls {
        rusty::fmt::Result PathVisitor::expecting(rusty::fmt::Formatter& formatter) const {
            using Value = typename PathVisitor::Value;
...
namespace de::impls {
        rusty::fmt::Result PathBufVisitor::expecting(rusty::fmt::Formatter& formatter) const {
            using Value = typename PathBufVisitor::Value;
...
namespace de::impls {
        ...
        rusty::Result<rusty::path::PathBuf, E> PathBufVisitor::visit_byte_buf(rusty::Vec<uint8_t> v) {
            using Value = typename PathBufVisitor::Value;
            return std::conditional_t<true, rusty::String, E>::from_utf8(std::move(v)).map([&](auto&& _v) -> rusty::path::PathBuf { return rusty::from_into<rusty::path::PathBuf>(std::forward<decltype(_v)>(_v)); }).map_err([&](auto&& _err) -> E { return ([&](auto&& e) { return E::invalid_value(de::Unexpected_Bytes{[&]() -> std::span<const uint8_t> { static const auto _slice_ref_tmp = e.into_bytes(); return std::span<const uint8_t>(_slice_ref_tmp); }()}, (*this)); }) (std::forward<decltype(_err)>(_err)); });
        }
}

namespace de::impls {
        rusty::fmt::Result OsStringVisitor::expecting(rusty::fmt::Formatter& formatter) const {
            using Value = typename OsStringVisitor::Value;
...
_match_value.emplace(std::move(_mv)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
auto&& err = rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_mv));
return rusty::Result<rusty::ffi::OsString, typename A::Error>::Err(err); } std::move(_match_value).value(); }); return std::visit(overloaded { [&](auto&&) -> rusty::Result<rusty::ffi::OsString, typename A::Error> { return [&]() -> rusty::Result<rusty::ffi::OsString, typename A::Error> { rusty::intrinsics::unreachable(); }(); }, [&](auto&&) -> rusty::Result<rusty::ffi::OsString, typename A::Error> { return [&]() -> rusty::Result<rusty::ffi::OsString, typename A::Error> { rusty::intrinsics::unreachable(); }(); } }, std::move(_m)); }();
        }
}


// Runnable wrappers for expanded Rust test bodies
// Rust-only libtest wrapper metadata: marker=ser::impls::test_format_u8 should_panic=no
void rusty_test_ser_impls_test_format_u8() {
...
int main(int argc, char** argv) {
    if (argc == 3 && std::string(argv[1]) == "--rusty-single-test") {
        ...
        try {
            if (test_name == "rusty_test_ser_impls_test_format_u8") { rusty_test_ser_impls_test_format_u8(); return 0; }
    ...
    int pass = 0, fail = 0;
    rusty::mem::clear_all_forgotten_addresses();
    try { rusty_test_ser_impls_test_format_u8(); std::cout << "  ser_impls_test_format_u8 PASSED" << std::endl; pass++; }
    catch (const std::exception& e) { std::cerr << "  ser_impls_test_format_u8 FAILED: " << e.what() << std::endl; fail++; }
    catch (...) { std::cerr << "  ser_impls_test_format_u8 FAILED (unknown exception)" << std::endl; fail++; }
    std::cout << std::endl;
