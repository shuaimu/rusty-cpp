...
namespace lib {
    ...
    // Rust-only: using lib::core::iter;
    export namespace num = rusty::num;
    export namespace str = rusty::str_runtime;

    export namespace cmp = rusty::cmp;
    export namespace mem = rusty::mem;

    export using ::rusty::Cell;
    export using ::rusty::RefCell;

    // Rust-only: using lib::core::cmp::Reverse;
    ...
    // Rust-only: using lib::core::num::Wrapping;

    // Rust-only: using lib::core::ops::Bound;
    // Rust-only: using lib::core::ops::Range;
    // Rust-only: using lib::core::ops::RangeFrom;
    // Rust-only: using lib::core::ops::RangeInclusive;
    // Rust-only: using lib::core::ops::RangeTo;

    export namespace result = rusty;

    export using ::rusty::time::Duration;
    ...
    export using ::rusty::BTreeMap;
    export using ::rusty::BTreeSet;
    // Rust-only: using std::collections::BinaryHeap;
    // Rust-only: using std::collections::LinkedList;
    export using ::rusty::VecDeque;

    export using ::rusty::ffi::CStr;

    export using ::rusty::ffi::CString;

    // Rust-only: using std::net;

    // Rust-only: using std::error;

    export using ::rusty::HashMap;
    export using ::rusty::HashSet;

    export using ::rusty::ffi::OsStr;
    export using ::rusty::ffi::OsString;
    ...
    export using ::rusty::path::Path;
    // Rust-only: using std::path::PathBuf;

    export using ::rusty::Mutex;
    export using ::rusty::RwLock;

    // Rust-only: using std::time::SystemTime;
    // Rust-only: using std::time::UNIX_EPOCH;

    export using ::rusty::sync::atomic::Ordering;

    export using ::rusty::sync::atomic::AtomicBool;
    export using ::rusty::sync::atomic::AtomicI8;
    export using ::rusty::sync::atomic::AtomicU8;

    export using ::rusty::sync::atomic::AtomicI16;
    export using ::rusty::sync::atomic::AtomicU16;

    export using ::rusty::sync::atomic::AtomicI32;
    export using ::rusty::sync::atomic::AtomicU32;

    export using ::rusty::sync::atomic::AtomicI64;
    export using ::rusty::sync::atomic::AtomicU64;

    export using ::rusty::sync::atomic::AtomicIsize;
    export using ::rusty::sync::atomic::AtomicUsize;

    // Rust-only: using lib::core::num::Saturating;
...
namespace ser {
    ...
    namespace impls {
        ...
        // Rust-only: using ser::Error;
        // Rust-only: using ser::Serialize;
        // Rust-only: using ser::SerializeTuple;
    ...
    namespace impossible {
        ...
        // Rust-only: using ser::SerializeSeq;
        // Rust-only: using ser::SerializeStruct;
        // Rust-only: using ser::SerializeStructVariant;
        // Rust-only: using ser::SerializeTuple;
        // Rust-only: using ser::SerializeTupleStruct;
        // Rust-only: using ser::SerializeTupleVariant;
    ...
    export using ::ser::impossible::Impossible;

    // Rust-only: using StdError = std::error::Error;
...
namespace private_ {
    ...
    export using ::private_::content::Content;
    namespace private_::content {}
    using namespace private_::content;

    export using ::private_::seed::InPlaceSeed;
...
namespace __private {
    ...
    export namespace doc = ::private_::doc;
...
namespace de {
    ...
    export using ::de::ignored_any::IgnoredAny;
...
return rusty::Result<std::tuple<typename T::Value, Variant>, typename A::Error>::Err(err); } std::move(_match_value).value(); }); if (_m.is_some()) { auto&& _mv0 = _m.unwrap(); auto&& key = rusty::detail::deref_if_pointer(_mv0); return rusty::Result<std::tuple<typename T::Value, Variant>, typename A::Error>::Ok(std::make_tuple(std::move(key), private_::map_as_enum(std::move(this->map)))); } if (_m.is_none()) { return rusty::Result<std::tuple<typename T::Value, Variant>, typename A::Error>::Err(A::Error::invalid_type(::de::Unexpected_Map{}, "enum")); } rusty::intrinsics::unreachable(); }();
    ...
    namespace ignored_any {
        ...
        // Rust-only: using de::value::Error;
        // Rust-only: using de::MapAccess;
        // Rust-only: using de::SeqAccess;
        // Rust-only: using de::VariantAccess;
        // Rust-only: using de::Visitor;
...
namespace de::impls {
        ...
        rusty::Result<rusty::ffi::OsString, typename A::Error> OsStringVisitor::visit_enum(A data) {
            using Value = typename OsStringVisitor::Value;
            // Rust-only: using std::os::unix::ffi::OsStringExt;
...
export void rusty_test_ser_impls_test_format_u8() {
