...
export module test_version_req;
import rusty;
...
void test_default();
void test_exact();
export void test_greater_than();
export void test_less_than();
export void test_multiple();
export void test_whitespace_delimited_comparator_sets();
export void test_tilde();
export void test_caret();
export void test_wildcard();
export void test_logical_or();
export void test_any();
export void test_pre();
export void test_parse();
...
export void test_parse() {
    const auto err = util::req_err(std::string_view("\0", 1));
    util::assert_to_string(std::move(err), std::string_view("unexpected character '\\0' while parsing major version number"));
    const auto err_shadow1 = util::req_err(std::string_view(">= >= 0.0.2"));
    util::assert_to_string(std::move(err_shadow1), std::string_view("unexpected character '>' while parsing major version number"));
    const auto err_shadow2 = util::req_err(std::string_view(">== 0.0.2"));
    util::assert_to_string(std::move(err_shadow2), std::string_view("unexpected character '=' while parsing major version number"));
    const auto err_shadow3 = util::req_err(std::string_view("a.0.0"));
    util::assert_to_string(std::move(err_shadow3), std::string_view("unexpected character 'a' while parsing major version number"));
    const auto err_shadow4 = util::req_err(std::string_view("1.0.0-"));
    util::assert_to_string(std::move(err_shadow4), std::string_view("empty identifier segment in pre-release identifier"));
    const auto err_shadow5 = util::req_err(std::string_view(">="));
    util::assert_to_string(std::move(err_shadow5), std::string_view("unexpected end of input while parsing major version number"));
}
...
export void rusty_test_test_basic() {
    test_basic();
}
