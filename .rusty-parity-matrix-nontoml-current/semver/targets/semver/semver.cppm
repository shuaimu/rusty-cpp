...
export constexpr Op Op_Exact();
export constexpr Op Op_Greater();
export constexpr Op Op_GreaterEq();
export constexpr Op Op_Less();
export constexpr Op Op_LessEq();
export constexpr Op Op_Tilde();
export constexpr Op Op_Caret();
export constexpr Op Op_Wildcard();
export Op clone(const Op& self_);
export void assert_receiver_is_total_eq(const Op& self_);
export bool eq(const Op& self_, const Op& other);
template<typename __H>
export void hash(const Op& self_, __H& state);
export struct Prerelease;
export struct Comparator;
export struct VersionReq;
