...
_match_value.emplace(std::move(_mv)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return do_display(formatter); } std::move(_match_value).value(); });
        ...
        auto [pre_pad, post_pad] = rusty::detail::deref_if_pointer_like([&]() { auto&& _m = align; if (_m == Alignment::Left) return std::make_tuple(static_cast<std::remove_cvref_t<decltype((padding / 2))>>(0), std::move(padding));
if (_m == Alignment::Right) return std::make_tuple(std::move(padding), static_cast<std::remove_cvref_t<decltype((((padding + 1)) / 2))>>(0));
if (_m == Alignment::Center) return std::make_tuple(padding / 2, ((padding + 1)) / 2); }());
...
namespace error {
    ...
    inline rusty::fmt::Result rusty_fmt(const Position& self, rusty::fmt::Formatter& formatter) {
        return formatter.write_str([&]() { auto&& _m = self; if (_m == Position::Major) return "major version number";
if (_m == Position::Minor) return "minor version number";
if (_m == Position::Patch) return "patch version number";
if (_m == Position::Pre) return "pre-release identifier";
if (_m == Position::Build) return "build metadata"; }());
    }
...
namespace eval {
    ...
    bool matches_req(const VersionReq& req, const Version& ver) {
        for (auto&& cmp : rusty::for_in(rusty::iter(req.comparators))) {
            if (!matches_impl(rusty::detail::deref_if_pointer_like(cmp), ver)) {
                return false;
            }
        }
        ...
        for (auto&& cmp : rusty::for_in(rusty::iter(req.comparators))) {
            if (pre_is_compatible(rusty::detail::deref_if_pointer_like(cmp), ver)) {
                return true;
            }
        }
        return false;
    ...
    bool matches_impl(const Comparator& cmp, const Version& ver) {
        return [&]() { auto&& _m = cmp.op; if (_m == Op::Exact || _m == Op::Wildcard) return matches_exact(cmp, ver);
if (_m == Op::Greater) return matches_greater(cmp, ver);
if (_m == Op::GreaterEq) return matches_exact(cmp, ver) || matches_greater(cmp, ver);
if (_m == Op::Less) return matches_less(cmp, ver);
if (_m == Op::LessEq) return matches_exact(cmp, ver) || matches_less(cmp, ver);
if (_m == Op::Tilde) return matches_tilde(cmp, ver);
if (_m == Op::Caret) return matches_caret(cmp, ver); }();
    }
...
_match_value.emplace(std::move(_mv)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return true; } std::move(_match_value).value(); });
...
_match_value.emplace(std::move(_mv)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } if (cmp.major > 0) { return ver.minor >= minor; } else { return ver.minor == minor; } } std::move(_match_value).value(); });
        if (cmp.major > 0) {
            if (ver.minor != minor) {
                return ver.minor > minor;
...
namespace identifier {
    Identifier Identifier::new_unchecked(std::string_view string) {
        ...
        return [&]() { auto&& _m = static_cast<uint64_t>(len); if (_m == 0) return Identifier::empty();
if ((_m >= 1 && _m <= 8)) return [&]() -> Identifier { auto bytes = [](auto _seed) { std::array<uint8_t, rusty::mem::size_of<Identifier>()> _repeat{}; _repeat.fill(static_cast<uint8_t>(_seed)); return _repeat; }(static_cast<uint8_t>(0));
// @unsafe
{
    rusty::ptr::copy_nonoverlapping(rusty::as_ptr(string), rusty::as_mut_ptr(bytes), std::move(len));
}
return mem::transmute<std::array<uint8_t, rusty::mem::size_of<Identifier>()>, Identifier>(std::move(bytes)); }();
if ((_m >= 9 && _m <= 72057594037927935)) return [&]() -> Identifier { const auto size = bytes_for_varint(NonZeroUsize::new_unchecked(std::move(len))) + len;
const auto align = 2;
...
return Identifier(ptr_to_repr(std::move(ptr_shadow1)), [](auto _seed) { std::array<uint8_t, rusty::sanitize_array_capacity<TAIL_BYTES>()> _repeat{}; _repeat.fill(static_cast<uint8_t>(_seed)); return _repeat; }(static_cast<uint8_t>(0))); }();
if ((_m >= 72057594037927936 && _m <= 18446744073709551615)) [&]() -> Identifier { {
...
_match_value.emplace(std::move(_mv)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return Ordering::Greater; } std::move(_match_value).value(); });
...
rusty::fmt::Result Comparator::fmt(rusty::fmt::Formatter& formatter) const {
    ...
    using namespace parse;
    using namespace display;
    const auto op_shadow1 = [&]() { auto&& _m = this->op; if (_m == Op::Exact) return std::string_view("=");
if (_m == Op::Greater) return std::string_view(">");
if (_m == Op::GreaterEq) return std::string_view(">=");
if (_m == Op::Less) return std::string_view("<");
if (_m == Op::LessEq) return std::string_view("<=");
if (_m == Op::Tilde) return std::string_view("~");
if (_m == Op::Caret) return std::string_view("^");
if (_m == Op::Wildcard) return std::string_view(""); }();
...
rusty::cmp::Ordering Version::cmp(const Version& other) const {
    ...
    using namespace parse;
    using namespace display;
    return [&]() { auto&& _m = rusty::cmp::cmp(this->major, other.major); if (_m == ::core::cmp::Ordering::Equal) return [&]() { auto&& _m = rusty::cmp::cmp(this->minor, other.minor); if (_m == ::core::cmp::Ordering::Equal) return [&]() { auto&& _m = rusty::cmp::cmp(this->patch, other.patch); if (_m == ::core::cmp::Ordering::Equal) return [&]() { auto&& _m = rusty::cmp::cmp(this->pre, other.pre); if (_m == ::core::cmp::Ordering::Equal) return rusty::cmp::cmp(this->build, other.build);
...
void test_basic() {
    ...
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 3> _slice_ref_tmp = {std::string_view("1.0.0"), std::string_view("1.1.0"), std::string_view("1.0.1")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 5> _slice_ref_tmp = {std::string_view("0.9.9"), std::string_view("0.10.0"), std::string_view("0.1.0"), std::string_view("1.0.0-pre"), std::string_view("1.0.1-pre")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
}
...
void test_exact() {
    const auto& r = util::req(std::string_view("=1.0.0"));
    util::assert_to_string(r, std::string_view("=1.0.0"));
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 1> _slice_ref_tmp = {std::string_view("1.0.0")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 5> _slice_ref_tmp = {std::string_view("1.0.1"), std::string_view("0.9.9"), std::string_view("0.10.0"), std::string_view("0.1.0"), std::string_view("1.0.0-pre")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    const auto& r_shadow1 = util::req(std::string_view("=0.9.0"));
    util::assert_to_string(r_shadow1, std::string_view("=0.9.0"));
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r_shadow1), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 1> _slice_ref_tmp = {std::string_view("0.9.0")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r_shadow1), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 4> _slice_ref_tmp = {std::string_view("0.9.1"), std::string_view("1.9.0"), std::string_view("0.0.9"), std::string_view("0.9.0-pre")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    const auto& r_shadow2 = util::req(std::string_view("=0.0.2"));
    util::assert_to_string(r_shadow2, std::string_view("=0.0.2"));
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r_shadow2), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 1> _slice_ref_tmp = {std::string_view("0.0.2")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r_shadow2), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 3> _slice_ref_tmp = {std::string_view("0.0.1"), std::string_view("0.0.3"), std::string_view("0.0.2-pre")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    const auto& r_shadow3 = util::req(std::string_view("=0.1.0-beta2.a"));
    util::assert_to_string(r_shadow3, std::string_view("=0.1.0-beta2.a"));
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r_shadow3), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 1> _slice_ref_tmp = {std::string_view("0.1.0-beta2.a")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r_shadow3), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 4> _slice_ref_tmp = {std::string_view("0.9.1"), std::string_view("0.1.0"), std::string_view("0.1.1-beta2.a"), std::string_view("0.1.0-beta2")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    const auto& r_shadow4 = util::req(std::string_view("=0.1.0+meta"));
    util::assert_to_string(r_shadow4, std::string_view("=0.1.0"));
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r_shadow4), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 3> _slice_ref_tmp = {std::string_view("0.1.0"), std::string_view("0.1.0+meta"), std::string_view("0.1.0+any")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
}

void test_greater_than() {
    const auto& r = util::req(std::string_view(">= 1.0.0"));
    util::assert_to_string(r, std::string_view(">=1.0.0"));
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 2> _slice_ref_tmp = {std::string_view("1.0.0"), std::string_view("2.0.0")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 4> _slice_ref_tmp = {std::string_view("0.1.0"), std::string_view("0.0.1"), std::string_view("1.0.0-pre"), std::string_view("2.0.0-pre")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    const auto& r_shadow1 = util::req(std::string_view(">= 2.1.0-alpha2"));
    util::assert_to_string(r_shadow1, std::string_view(">=2.1.0-alpha2"));
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r_shadow1), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 4> _slice_ref_tmp = {std::string_view("2.1.0-alpha2"), std::string_view("2.1.0-alpha3"), std::string_view("2.1.0"), std::string_view("3.0.0")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r_shadow1), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 4> _slice_ref_tmp = {std::string_view("2.0.0"), std::string_view("2.1.0-alpha1"), std::string_view("2.0.0-alpha2"), std::string_view("3.0.0-alpha2")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
}

void test_less_than() {
    const auto& r = util::req(std::string_view("< 1.0.0"));
    util::assert_to_string(r, std::string_view("<1.0.0"));
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 2> _slice_ref_tmp = {std::string_view("0.1.0"), std::string_view("0.0.1")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 4> _slice_ref_tmp = {std::string_view("1.0.0"), std::string_view("1.0.0-beta"), std::string_view("1.0.1"), std::string_view("0.9.9-alpha")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    const auto& r_shadow1 = util::req(std::string_view("<= 2.1.0-alpha2"));
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r_shadow1), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 4> _slice_ref_tmp = {std::string_view("2.1.0-alpha2"), std::string_view("2.1.0-alpha1"), std::string_view("2.0.0"), std::string_view("1.0.0")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r_shadow1), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 4> _slice_ref_tmp = {std::string_view("2.1.0"), std::string_view("2.2.0-alpha1"), std::string_view("2.0.0-alpha2"), std::string_view("1.0.0-alpha2")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    const auto& r_shadow2 = util::req(std::string_view(">1.0.0-alpha, <1.0.0"));
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r_shadow2), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 1> _slice_ref_tmp = {std::string_view("1.0.0-beta")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    const auto& r_shadow3 = util::req(std::string_view(">1.0.0-alpha, <1.0"));
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r_shadow3), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 1> _slice_ref_tmp = {std::string_view("1.0.0-beta")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    const auto& r_shadow4 = util::req(std::string_view(">1.0.0-alpha, <1"));
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r_shadow4), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 1> _slice_ref_tmp = {std::string_view("1.0.0-beta")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
}

void test_multiple() {
    const auto& r = util::req(std::string_view("> 0.0.9, <= 2.5.3"));
    util::assert_to_string(r, std::string_view(">0.0.9, <=2.5.3"));
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 3> _slice_ref_tmp = {std::string_view("0.0.10"), std::string_view("1.0.0"), std::string_view("2.5.3")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 2> _slice_ref_tmp = {std::string_view("0.0.8"), std::string_view("2.5.4")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    const auto& r_shadow1 = util::req(std::string_view("0.3.0, 0.4.0"));
    util::assert_to_string(r_shadow1, std::string_view("^0.3.0, ^0.4.0"));
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r_shadow1), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 3> _slice_ref_tmp = {std::string_view("0.0.8"), std::string_view("0.3.0"), std::string_view("0.4.0")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    const auto& r_shadow2 = util::req(std::string_view("<= 0.2.0, >= 0.5.0"));
    util::assert_to_string(r_shadow2, std::string_view("<=0.2.0, >=0.5.0"));
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r_shadow2), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 3> _slice_ref_tmp = {std::string_view("0.0.8"), std::string_view("0.3.0"), std::string_view("0.5.1")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ...
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r_shadow3), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 2> _slice_ref_tmp = {std::string_view("0.1.6"), std::string_view("0.1.9")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r_shadow3), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 3> _slice_ref_tmp = {std::string_view("0.1.0"), std::string_view("0.1.4"), std::string_view("0.2.0")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ...
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r_shadow4), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 5> _slice_ref_tmp = {std::string_view("0.5.1-alpha3"), std::string_view("0.5.1-alpha4"), std::string_view("0.5.1-beta"), std::string_view("0.5.1"), std::string_view("0.5.5")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r_shadow4), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 4> _slice_ref_tmp = {std::string_view("0.5.1-alpha1"), std::string_view("0.5.2-alpha3"), std::string_view("0.5.5-pre"), std::string_view("0.5.0-pre")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r_shadow4), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 2> _slice_ref_tmp = {std::string_view("0.6.0"), std::string_view("0.6.0-pre")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
...
void test_tilde() {
    ...
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 3> _slice_ref_tmp = {std::string_view("1.0.0"), std::string_view("1.0.1"), std::string_view("1.1.1")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 3> _slice_ref_tmp = {std::string_view("0.9.1"), std::string_view("2.9.0"), std::string_view("0.0.9")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    const auto& r_shadow1 = util::req(std::string_view("~1.2"));
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r_shadow1), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 2> _slice_ref_tmp = {std::string_view("1.2.0"), std::string_view("1.2.1")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r_shadow1), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 3> _slice_ref_tmp = {std::string_view("1.1.1"), std::string_view("1.3.0"), std::string_view("0.0.9")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    const auto& r_shadow2 = util::req(std::string_view("~1.2.2"));
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r_shadow2), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 2> _slice_ref_tmp = {std::string_view("1.2.2"), std::string_view("1.2.4")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r_shadow2), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 5> _slice_ref_tmp = {std::string_view("1.2.1"), std::string_view("1.9.0"), std::string_view("1.0.9"), std::string_view("2.0.1"), std::string_view("0.1.3")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    const auto& r_shadow3 = util::req(std::string_view("~1.2.3-beta.2"));
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r_shadow3), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 4> _slice_ref_tmp = {std::string_view("1.2.3"), std::string_view("1.2.4"), std::string_view("1.2.3-beta.2"), std::string_view("1.2.3-beta.4")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r_shadow3), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 4> _slice_ref_tmp = {std::string_view("1.3.3"), std::string_view("1.1.4"), std::string_view("1.2.3-beta.1"), std::string_view("1.2.4-beta.2")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
}

void test_caret() {
    const auto& r = util::req(std::string_view("^1"));
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 4> _slice_ref_tmp = {std::string_view("1.1.2"), std::string_view("1.1.0"), std::string_view("1.2.1"), std::string_view("1.0.1")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 3> _slice_ref_tmp = {std::string_view("0.9.1"), std::string_view("2.9.0"), std::string_view("0.1.4")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 3> _slice_ref_tmp = {std::string_view("1.0.0-beta1"), std::string_view("0.1.0-alpha"), std::string_view("1.0.1-pre")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    const auto& r_shadow1 = util::req(std::string_view("^1.1"));
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r_shadow1), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 3> _slice_ref_tmp = {std::string_view("1.1.2"), std::string_view("1.1.0"), std::string_view("1.2.1")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r_shadow1), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 4> _slice_ref_tmp = {std::string_view("0.9.1"), std::string_view("2.9.0"), std::string_view("1.0.1"), std::string_view("0.1.4")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    const auto& r_shadow2 = util::req(std::string_view("^1.1.2"));
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r_shadow2), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 3> _slice_ref_tmp = {std::string_view("1.1.2"), std::string_view("1.1.4"), std::string_view("1.2.1")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r_shadow2), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 4> _slice_ref_tmp = {std::string_view("0.9.1"), std::string_view("2.9.0"), std::string_view("1.1.1"), std::string_view("0.0.1")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r_shadow2), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 3> _slice_ref_tmp = {std::string_view("1.1.2-alpha1"), std::string_view("1.1.3-alpha1"), std::string_view("2.9.0-alpha1")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    const auto& r_shadow3 = util::req(std::string_view("^0.1.2"));
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r_shadow3), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 2> _slice_ref_tmp = {std::string_view("0.1.2"), std::string_view("0.1.4")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r_shadow3), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 4> _slice_ref_tmp = {std::string_view("0.9.1"), std::string_view("2.9.0"), std::string_view("1.1.1"), std::string_view("0.0.1")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r_shadow3), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 3> _slice_ref_tmp = {std::string_view("0.1.2-beta"), std::string_view("0.1.3-alpha"), std::string_view("0.2.0-pre")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    const auto& r_shadow4 = util::req(std::string_view("^0.5.1-alpha3"));
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r_shadow4), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 5> _slice_ref_tmp = {std::string_view("0.5.1-alpha3"), std::string_view("0.5.1-alpha4"), std::string_view("0.5.1-beta"), std::string_view("0.5.1"), std::string_view("0.5.5")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r_shadow4), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 5> _slice_ref_tmp = {std::string_view("0.5.1-alpha1"), std::string_view("0.5.2-alpha3"), std::string_view("0.5.5-pre"), std::string_view("0.5.0-pre"), std::string_view("0.6.0")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    const auto& r_shadow5 = util::req(std::string_view("^0.0.2"));
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r_shadow5), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 1> _slice_ref_tmp = {std::string_view("0.0.2")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r_shadow5), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 5> _slice_ref_tmp = {std::string_view("0.9.1"), std::string_view("2.9.0"), std::string_view("1.1.1"), std::string_view("0.0.1"), std::string_view("0.1.4")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    const auto& r_shadow6 = util::req(std::string_view("^0.0"));
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r_shadow6), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 2> _slice_ref_tmp = {std::string_view("0.0.2"), std::string_view("0.0.0")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r_shadow6), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 4> _slice_ref_tmp = {std::string_view("0.9.1"), std::string_view("2.9.0"), std::string_view("1.1.1"), std::string_view("0.1.4")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    const auto& r_shadow7 = util::req(std::string_view("^0"));
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r_shadow7), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 3> _slice_ref_tmp = {std::string_view("0.9.1"), std::string_view("0.0.2"), std::string_view("0.0.0")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r_shadow7), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 2> _slice_ref_tmp = {std::string_view("2.9.0"), std::string_view("1.1.1")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    const auto& r_shadow8 = util::req(std::string_view("^1.4.2-beta.5"));
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r_shadow8), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 5> _slice_ref_tmp = {std::string_view("1.4.2"), std::string_view("1.4.3"), std::string_view("1.4.2-beta.5"), std::string_view("1.4.2-beta.6"), std::string_view("1.4.2-c")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r_shadow8), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 5> _slice_ref_tmp = {std::string_view("0.9.9"), std::string_view("2.0.0"), std::string_view("1.4.2-alpha"), std::string_view("1.4.2-beta.4"), std::string_view("1.4.3-beta.5")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
}
...
void test_wildcard() {
    ...
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 5> _slice_ref_tmp = {std::string_view("0.9.1"), std::string_view("2.9.0"), std::string_view("0.0.9"), std::string_view("1.0.1"), std::string_view("1.1.1")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 1> _slice_ref_tmp = {std::string_view("1.0.0-pre")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ...
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r_shadow1), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 4> _slice_ref_tmp = {std::string_view("1.2.0"), std::string_view("1.2.1"), std::string_view("1.1.1"), std::string_view("1.3.0")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r_shadow1), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 2> _slice_ref_tmp = {std::string_view("0.0.9"), std::string_view("1.2.0-pre")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ...
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r_shadow2), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 3> _slice_ref_tmp = {std::string_view("1.2.0"), std::string_view("1.2.2"), std::string_view("1.2.4")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
    ::assert_match_none(rusty::detail::deref_if_pointer_like(r_shadow2), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 5> _slice_ref_tmp = {std::string_view("1.9.0"), std::string_view("1.0.9"), std::string_view("2.0.1"), std::string_view("0.1.3"), std::string_view("1.2.2-pre")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
...
void test_any() {
    ...
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 3> _slice_ref_tmp = {std::string_view("0.0.1"), std::string_view("0.1.0"), std::string_view("1.0.0")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
}

void test_pre() {
    const auto& r = util::req(std::string_view("=2.1.1-really.0"));
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 1> _slice_ref_tmp = {std::string_view("2.1.1-really.0")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
}
...
void test_cargo3202() {
    ...
    ::assert_match_all(rusty::detail::deref_if_pointer_like(r), [&]() -> std::span<const std::string_view> { static const std::array<std::string_view, 1> _slice_ref_tmp = {std::string_view("0.5.0")}; return std::span<const std::string_view>(_slice_ref_tmp); }());
