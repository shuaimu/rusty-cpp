...
template<typename T, typename F>
export void take(T& mut_ref, F closure);
void it_works();
template<typename T, typename F, typename R>
export void take_or_recover(T& mut_ref, R recover, F closure);
