...
// Rust-only libtest metadata const skipped: filter_map (marker: filter_map, should_panic: no)

// Rust-only libtest metadata const skipped: basic (marker: basic, should_panic: no)

void filter_map() {
    const std::span<const rusty::Result<int32_t, std::string_view>> values = [&]() -> std::span<const rusty::Result<int32_t, std::string_view>> { static const std::array<rusty::Result<int32_t, std::string_view>, 4> _slice_ref_tmp = {rusty::Result<int32_t, std::string_view>::Ok(static_cast<int32_t>(3)), rusty::Result<int32_t, std::string_view>::Err([&]() -> const auto& { auto _result_ref_value = (std::string_view("foo")); thread_local std::optional<std::string_view> _result_ref_tmp; _result_ref_tmp.reset(); _result_ref_tmp.emplace(std::move(_result_ref_value)); return *_result_ref_tmp; }()), rusty::Result<int32_t, std::string_view>::Err([&]() -> const auto& { auto _result_ref_value = (std::string_view("bar")); thread_local std::optional<std::string_view> _result_ref_tmp; _result_ref_tmp.reset(); _result_ref_tmp.emplace(std::move(_result_ref_value)); return *_result_ref_tmp; }()), rusty::Result<int32_t, std::string_view>::Ok(static_cast<int32_t>(8))}; return std::span<const rusty::Result<int32_t, std::string_view>>(_slice_ref_tmp); }();
    static_cast<void>(rusty::filter_map(rusty::iter(values), [&](auto&& result) {
return ([&](auto&& __self) -> decltype(auto) { if constexpr (requires { rusty_ext::tap_err(std::forward<decltype(__self)>(__self), [&](auto&& error) {
rusty::io::_print(std::format("Invalid entry: {0}\n", rusty::to_string(error)));
}); }) { return rusty_ext::tap_err(std::forward<decltype(__self)>(__self), [&](auto&& error) {
rusty::io::_print(std::format("Invalid entry: {0}\n", rusty::to_string(error)));
}); } else { return rusty_ext::tap_err(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), [&](auto&& error) {
rusty::io::_print(std::format("Invalid entry: {0}\n", rusty::to_string(error)));
}); } })(result).ok();
}));
}
...
void basic() {
    auto foo = static_cast<int32_t>(5);
    if (([&](auto&& __self) -> decltype(auto) { if constexpr (requires { rusty_ext::tap(std::forward<decltype(__self)>(__self), [&](auto&& v) { return [&]() { static_cast<void>(foo += rusty::deref_mut(v)); return std::make_tuple(); }(); }); }) { return rusty_ext::tap(std::forward<decltype(__self)>(__self), [&](auto&& v) { return [&]() { static_cast<void>(foo += rusty::deref_mut(v)); return std::make_tuple(); }(); }); } else { return rusty_ext::tap(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), [&](auto&& v) { return [&]() { static_cast<void>(foo += rusty::deref_mut(v)); return std::make_tuple(); }(); }); } })(10) > 0) {
        {
            auto _m0 = &foo;
            auto&& _m1_tmp = static_cast<int32_t>(15);
            auto _m1 = &_m1_tmp;
    ...
    static_cast<void>(([&](auto&& __self) -> decltype(auto) { if constexpr (requires { rusty_ext::tap_err(std::forward<decltype(__self)>(__self), [&](auto&& e) { return foo = std::move(rusty::deref_mut(e)); }); }) { return rusty_ext::tap_err(std::forward<decltype(__self)>(__self), [&](auto&& e) { return foo = std::move(rusty::deref_mut(e)); }); } else { return rusty_ext::tap_err(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), [&](auto&& e) { return foo = std::move(rusty::deref_mut(e)); }); } })(rusty::Result<int32_t, int32_t>::Err(static_cast<int32_t>(5))));
    {
        auto _m0 = &foo;
    ...
    static_cast<void>(([&](auto&& __self) -> decltype(auto) { if constexpr (requires { rusty_ext::tap_none(std::forward<decltype(__self)>(__self), [&]() { return foo = static_cast<int32_t>(10); }); }) { return rusty_ext::tap_none(std::forward<decltype(__self)>(__self), [&]() { return foo = static_cast<int32_t>(10); }); } else { return rusty_ext::tap_none(rusty::detail::deref_if_pointer_like(std::forward<decltype(__self)>(__self)), [&]() { return foo = static_cast<int32_t>(10); }); } })(rusty::Option<int32_t>(rusty::None)));
    {
        auto _m0 = &foo;
...
// Rust-only libtest wrapper metadata: marker=filter_map should_panic=no
void rusty_test_filter_map() {
    filter_map();
}
...
int main(int argc, char** argv) {
    if (argc == 3 && std::string(argv[1]) == "--rusty-single-test") {
        ...
        try {
            ...
            if (test_name == "rusty_test_filter_map") { rusty_test_filter_map(); return 0; }
    ...
    rusty::mem::clear_all_forgotten_addresses();
    try { rusty_test_filter_map(); std::cout << "  filter_map PASSED" << std::endl; pass++; }
    catch (const std::exception& e) { std::cerr << "  filter_map FAILED: " << e.what() << std::endl; fail++; }
    catch (...) { std::cerr << "  filter_map FAILED (unknown exception)" << std::endl; fail++; }
    std::cout << std::endl;
