...
#   mkdir -p /tmp/linked_list_port/binary_heap_crate/src
#   cp $RUSTSRC/mod.rs /tmp/linked_list_port/binary_heap_crate/src/lib.rs
#   cp docs/linked_list_port/Cargo.toml.template /tmp/linked_list_port/binary_heap_crate/Cargo.toml
#   bash docs/linked_list_port/prep.sh /tmp/linked_list_port/binary_heap_crate/src/lib.rs
set -euo pipefail
...
sed -i \
  ...
  "$SRC"
echo "[linked_list_port prep] normalized $SRC"
