...
namespace inner {
    ...
    public:
        ...
        virtual rusty::Result<rusty::ptr::NonNull<uint8_t>, rusty::Unit> allocate(rusty::alloc::Layout layout) const = 0;
    ...
    export struct Global {
        ...
        rusty::Result<rusty::ptr::NonNull<uint8_t>, rusty::Unit> allocate(rusty::alloc::Layout layout) const;
