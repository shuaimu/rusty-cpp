...
// Rust-only namespace import skipped for type path: using namespace RustcEntry;
...
struct RustcVacantEntry {
    ...
    V& insert(V value) {
        // @unsafe
        {
            ...
            return ([&](auto&& __t) -> decltype(auto) { if constexpr (requires { __t._1; }) return (std::forward<decltype(__t)>(__t)._1); else return std::get<1>(std::forward<decltype(__t)>(__t)); })(bucket.as_mut());
        }
    }
...
struct RustcEntry : std::variant<RustcEntry_Occupied<K, V, A>, RustcEntry_Vacant<K, V, A>> {
    ...
    rusty::fmt::Result fmt(rusty::fmt::Formatter& f) const {
        return [&]() -> rusty::fmt::Result { auto&& _m = (*this); if (rusty::detail::deref_if_pointer(_m).index() == 1) { const auto& v = std::get<1>(rusty::detail::deref_if_pointer(_m))._0; return f.debug_tuple("Entry").field(v).finish(); } if (rusty::detail::deref_if_pointer(_m).index() == 0) { const auto& o = std::get<0>(rusty::detail::deref_if_pointer(_m))._0; return f.debug_tuple("Entry").field(o).finish(); } return [&]() -> rusty::fmt::Result { rusty::intrinsics::unreachable(); }(); }();
    }
    RustcOccupiedEntry<K, V, A> insert(V value) {
        return [&]() -> RustcOccupiedEntry<K, V, A> { auto&& _m = (*this); if (rusty::detail::deref_if_pointer(_m).index() == 1) { auto&& entry = rusty::detail::deref_if_pointer(std::get<1>(rusty::detail::deref_if_pointer(_m))._0); return entry.insert_entry(std::move(value)); } if (rusty::detail::deref_if_pointer(_m).index() == 0) { auto entry = rusty::detail::deref_if_pointer(std::get<0>(rusty::detail::deref_if_pointer(_m))._0); return [&]() -> RustcOccupiedEntry<K, V, A> { entry.insert(std::move(value));
return entry; }(); } return [&]() -> RustcOccupiedEntry<K, V, A> { rusty::intrinsics::unreachable(); }(); }();
    }
    V& or_insert(V default_) {
        return [&]() -> V& { auto&& _m = (*this); if (rusty::detail::deref_if_pointer(_m).index() == 0) { auto&& entry = rusty::detail::deref_if_pointer(std::get<0>(rusty::detail::deref_if_pointer(_m))._0); return entry.into_mut(); } if (rusty::detail::deref_if_pointer(_m).index() == 1) { auto&& entry = rusty::detail::deref_if_pointer(std::get<1>(rusty::detail::deref_if_pointer(_m))._0); return entry.insert(std::move(default_)); } return [&]() -> V& { rusty::intrinsics::unreachable(); }(); }();
    }
    template<typename F>
    ...
    const K& key() const {
        return [&]() -> const K& { auto&& _m = (*this); if (rusty::detail::deref_if_pointer(_m).index() == 0) { const auto& entry = std::get<0>(rusty::detail::deref_if_pointer(_m))._0; return entry.key(); } if (rusty::detail::deref_if_pointer(_m).index() == 1) { const auto& entry = std::get<1>(rusty::detail::deref_if_pointer(_m))._0; return entry.key(); } return [&]() -> const K& { rusty::intrinsics::unreachable(); }(); }();
    }
    template<typename F>
    RustcEntry<K, V, A> and_modify(F f) {
        return [&]() -> RustcEntry<K, V, A> { auto&& _m = (*this); if (rusty::detail::deref_if_pointer(_m).index() == 0) { auto entry = rusty::detail::deref_if_pointer(std::get<0>(rusty::detail::deref_if_pointer(_m))._0); return [&]() -> RustcEntry<K, V, A> { f(entry.get_mut());
return RustcEntry<K, V, A>{RustcEntry_Occupied<K, V, A>{entry}}; }(); } if (rusty::detail::deref_if_pointer(_m).index() == 1) { auto&& entry = rusty::detail::deref_if_pointer(std::get<1>(rusty::detail::deref_if_pointer(_m))._0); return RustcEntry<K, V, A>{RustcEntry_Vacant<K, V, A>{entry}}; } return [&]() -> RustcEntry<K, V, A> { rusty::intrinsics::unreachable(); }(); }();
    }
    V& or_default() {
        return [&]() -> V& { auto&& _m = (*this); if (rusty::detail::deref_if_pointer(_m).index() == 0) { auto&& entry = rusty::detail::deref_if_pointer(std::get<0>(rusty::detail::deref_if_pointer(_m))._0); return entry.into_mut(); } if (rusty::detail::deref_if_pointer(_m).index() == 1) { auto&& entry = rusty::detail::deref_if_pointer(std::get<1>(rusty::detail::deref_if_pointer(_m))._0); return entry.insert(rusty::default_value<V>()); } return [&]() -> V& { rusty::intrinsics::unreachable(); }(); }();
    }
};
template<typename K, typename V, typename A>
...
// orphan impl: methods for `IterMut` absorbed into the host struct in another file

// orphan impl: methods for `IntoIter` absorbed into the host struct in another file
