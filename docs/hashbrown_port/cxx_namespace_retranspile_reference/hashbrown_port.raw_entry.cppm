...
export module hashbrown_port.raw_entry;
...
export template<typename K, typename V, typename S, typename A = rusty::alloc::Global>
    requires (rusty::alloc::Allocator<A>)
struct RawEntryBuilder {
    const rusty::HashMap<K, V, S, A>& map;

    template<typename Q>
    rusty::Option<std::tuple<const K&, const V&>> from_key(const Q& k) {
        auto hash = make_hash<Q, S>(&this->map.hash_builder, k);
        return this->from_key_hashed_nocheck(std::move(hash), k);
    }
    template<typename Q>
    rusty::Option<std::tuple<const K&, const V&>> from_key_hashed_nocheck(uint64_t hash, const Q& k) {
        return this->from_hash(std::move(hash), equivalent(k));
    }
    template<typename F>
    rusty::Option<std::tuple<const K&, const V&>> search(uint64_t hash, F is_match) {
        return [&]() -> rusty::Option<std::tuple<const K&, const V&>> { auto&& _m = this->map.table.get(std::move(hash), [&](auto&& _destruct_param0) {
auto&& k = rusty::detail::deref_if_pointer(std::get<0>(rusty::detail::deref_if_pointer(_destruct_param0)));
return is_match(std::move(k));
}); if (_m.is_some()) { auto&& _mv0 = _m.unwrap(); auto&& key = rusty::detail::deref_if_pointer(std::get<0>(rusty::detail::deref_if_pointer(_mv0))); auto&& value = rusty::detail::deref_if_pointer(std::get<1>(rusty::detail::deref_if_pointer(_mv0))); return rusty::Option<std::tuple<const K&, const V&>>(std::tuple<const K&, const V&>{key, value}); } if (_m.is_none()) { return rusty::Option<std::tuple<const K&, const V&>>{rusty::None}; } return [&]() -> rusty::Option<std::tuple<const K&, const V&>> { rusty::intrinsics::unreachable(); }(); }();
    }
    template<typename F>
    rusty::Option<std::tuple<const K&, const V&>> from_hash(uint64_t hash, F is_match) {
        return this->search(std::move(hash), std::move(is_match));
    }
    rusty::fmt::Result fmt(rusty::fmt::Formatter& f) const {
        return f.debug_struct("RawEntryBuilder").finish();
    }
};
...
export template<typename K, typename V, typename S, typename A = rusty::alloc::Global>
    requires (rusty::alloc::Allocator<A>)
struct RawEntryBuilderMut {
    rusty::HashMap<K, V, S, A>& map;

    template<typename Q>
    RawEntryMut<K, V, S, A> from_key(const Q& k) {
        auto hash = make_hash<Q, S>(&this->map.hash_builder, k);
        return this->from_key_hashed_nocheck(std::move(hash), k);
    }
    template<typename Q>
    RawEntryMut<K, V, S, A> from_key_hashed_nocheck(uint64_t hash, const Q& k) {
        return this->from_hash(std::move(hash), equivalent(k));
    }
    template<typename F>
    RawEntryMut<K, V, S, A> from_hash(uint64_t hash, F is_match) {
        return this->search(std::move(hash), std::move(is_match));
    }
    template<typename F>
    RawEntryMut<K, V, S, A> search(uint64_t hash, F is_match) {
        return [&]() -> RawEntryMut<K, V, S, A> { auto&& _m = this->map.table.find(std::move(hash), [&](auto&& _destruct_param0) {
auto&& k = rusty::detail::deref_if_pointer(std::get<0>(rusty::detail::deref_if_pointer(_destruct_param0)));
return is_match(std::move(k));
}); if (_m.is_some()) { auto&& _mv0 = _m.unwrap(); auto&& elem = rusty::detail::deref_if_pointer(_mv0); return RawEntryMut<K, V, S, A>{RawEntryMut_Occupied<K, V, S, A>{RawOccupiedEntryMut<K, V, S, A>(std::move(elem), this->map.table, this->map.hash_builder)}}; } if (_m.is_none()) { return RawEntryMut<K, V, S, A>{RawEntryMut_Vacant<K, V, S, A>{RawVacantEntryMut<K, V, S, A>(this->map.table, this->map.hash_builder)}}; } return [&]() -> RawEntryMut<K, V, S, A> { rusty::intrinsics::unreachable(); }(); }();
    }
    rusty::fmt::Result fmt(rusty::fmt::Formatter& f) const {
        return f.debug_struct("RawEntryBuilder").finish();
    }
...
struct RawEntryMut_Occupied {
    RawOccupiedEntryMut<K, V, S, A> _0;
};
export template<typename K, typename V, typename S, typename A>
struct RawEntryMut_Vacant {
    RawVacantEntryMut<K, V, S, A> _0;
};
template<typename K, typename V, typename S, typename A>
RawEntryMut_Occupied<K, V, S, A> Occupied(RawOccupiedEntryMut<K, V, S, A> _0);
template<typename K, typename V, typename S, typename A>
RawEntryMut_Vacant<K, V, S, A> Vacant(RawVacantEntryMut<K, V, S, A> _0);
template<typename K, typename V, typename S, typename A>
struct RawEntryMut : std::variant<RawEntryMut_Occupied<K, V, S, A>, RawEntryMut_Vacant<K, V, S, A>> {
    using variant = std::variant<RawEntryMut_Occupied<K, V, S, A>, RawEntryMut_Vacant<K, V, S, A>>;
    using variant::variant;
    static RawEntryMut<K, V, S, A> Occupied(RawOccupiedEntryMut<K, V, S, A> _0) { return RawEntryMut<K, V, S, A>{RawEntryMut_Occupied<K, V, S, A>{std::forward<decltype(_0)>(_0)}}; }
    static RawEntryMut<K, V, S, A> Vacant(RawVacantEntryMut<K, V, S, A> _0) { return RawEntryMut<K, V, S, A>{RawEntryMut_Vacant<K, V, S, A>{std::forward<decltype(_0)>(_0)}}; }


    RawOccupiedEntryMut<K, V, S, A> insert(K key, V value) {
        return [&]() -> RawOccupiedEntryMut<K, V, S, A> { auto&& _m = (*this); if (rusty::detail::deref_if_pointer(_m).index() == 0) { auto entry = rusty::detail::deref_if_pointer(std::get<0>(rusty::detail::deref_if_pointer(_m))._0); return [&]() -> RawOccupiedEntryMut<K, V, S, A> { entry.insert(std::move(value));
return entry; }(); } if (rusty::detail::deref_if_pointer(_m).index() == 1) { auto&& entry = rusty::detail::deref_if_pointer(std::get<1>(rusty::detail::deref_if_pointer(_m))._0); return entry.insert_entry(std::move(key), std::move(value)); } return [&]() -> RawOccupiedEntryMut<K, V, S, A> { rusty::intrinsics::unreachable(); }(); }();
    }
    std::tuple<K&, V&> or_insert(K default_key, V default_val) {
        return [&]() -> std::tuple<K&, V&> { auto&& _m = (*this); if (rusty::detail::deref_if_pointer(_m).index() == 0) { auto&& entry = rusty::detail::deref_if_pointer(std::get<0>(rusty::detail::deref_if_pointer(_m))._0); return entry.into_key_value(); } if (rusty::detail::deref_if_pointer(_m).index() == 1) { auto&& entry = rusty::detail::deref_if_pointer(std::get<1>(rusty::detail::deref_if_pointer(_m))._0); return entry.insert(std::move(default_key), std::move(default_val)); } return [&]() -> std::tuple<K&, V&> { rusty::intrinsics::unreachable(); }(); }();
    }
    template<typename F>
    std::tuple<K&, V&> or_insert_with(F default_) {
        return [&]() -> std::tuple<K&, V&> { auto&& _m = (*this); if (rusty::detail::deref_if_pointer(_m).index() == 0) { auto&& entry = rusty::detail::deref_if_pointer(std::get<0>(rusty::detail::deref_if_pointer(_m))._0); return entry.into_key_value(); } if (rusty::detail::deref_if_pointer(_m).index() == 1) { auto&& entry = rusty::detail::deref_if_pointer(std::get<1>(rusty::detail::deref_if_pointer(_m))._0); return [&]() -> std::tuple<K&, V&> { auto [k, v] = rusty::detail::deref_if_pointer_like(default_());
return entry.insert(std::move(k), std::move(v)); }(); } return [&]() -> std::tuple<K&, V&> { rusty::intrinsics::unreachable(); }(); }();
    }
    template<typename F>
    RawEntryMut<K, V, S, A> and_modify(F f) {
        return [&]() -> RawEntryMut<K, V, S, A> { auto&& _m = (*this); if (rusty::detail::deref_if_pointer(_m).index() == 0) { auto entry = rusty::detail::deref_if_pointer(std::get<0>(rusty::detail::deref_if_pointer(_m))._0); return [&]() -> RawEntryMut<K, V, S, A> { {
    auto [k, v] = rusty::detail::deref_if_pointer_like(entry.get_key_value_mut());
    f(std::move(k), std::move(v));
}
return RawEntryMut<K, V, S, A>{RawEntryMut_Occupied<K, V, S, A>{entry}}; }(); } if (rusty::detail::deref_if_pointer(_m).index() == 1) { auto&& entry = rusty::detail::deref_if_pointer(std::get<1>(rusty::detail::deref_if_pointer(_m))._0); return RawEntryMut<K, V, S, A>{RawEntryMut_Vacant<K, V, S, A>{entry}}; } return [&]() -> RawEntryMut<K, V, S, A> { rusty::intrinsics::unreachable(); }(); }();
    }
    template<typename F>
    RawEntryMut<K, V, S, A> and_replace_entry_with(F f) {
        return [&]() -> RawEntryMut<K, V, S, A> { auto&& _m = (*this); if (rusty::detail::deref_if_pointer(_m).index() == 0) { auto&& entry = rusty::detail::deref_if_pointer(std::get<0>(rusty::detail::deref_if_pointer(_m))._0); return entry.replace_entry_with(std::move(f)); } if (rusty::detail::deref_if_pointer(_m).index() == 1) { return this->clone(); } return [&]() -> RawEntryMut<K, V, S, A> { rusty::intrinsics::unreachable(); }(); }();
    }
    rusty::fmt::Result fmt(rusty::fmt::Formatter& f) const {
        return [&]() -> rusty::fmt::Result { auto&& _m = (*this); if (rusty::detail::deref_if_pointer(_m).index() == 1) { const auto& v = std::get<1>(rusty::detail::deref_if_pointer(_m))._0; return f.debug_tuple("RawEntry").field(v).finish(); } if (rusty::detail::deref_if_pointer(_m).index() == 0) { const auto& o = std::get<0>(rusty::detail::deref_if_pointer(_m))._0; return f.debug_tuple("RawEntry").field(o).finish(); } return [&]() -> rusty::fmt::Result { rusty::intrinsics::unreachable(); }(); }();
    }
};
template<typename K, typename V, typename S, typename A>
RawEntryMut_Occupied<K, V, S, A> Occupied(RawOccupiedEntryMut<K, V, S, A> _0) { return RawEntryMut_Occupied<K, V, S, A>{std::forward<RawOccupiedEntryMut<K, V, S, A>>(_0)};  }
template<typename K, typename V, typename S, typename A>
RawEntryMut_Vacant<K, V, S, A> Vacant(RawVacantEntryMut<K, V, S, A> _0) { return RawEntryMut_Vacant<K, V, S, A>{std::forward<RawVacantEntryMut<K, V, S, A>>(_0)};  }
...
struct RawOccupiedEntryMut {
    ...
    K& key_mut() {
        // @unsafe
        {
            return ([&](auto&& __t) -> decltype(auto) { if constexpr (requires { __t._0; }) return (std::forward<decltype(__t)>(__t)._0); else return std::get<0>(std::forward<decltype(__t)>(__t)); })(this->elem.as_mut());
        }
    }
    K& into_key() {
        // @unsafe
    ...
    std::tuple<const K&, const V&> get_key_value() const {
        // @unsafe
        {
            auto [key, value] = rusty::detail::deref_if_pointer_like(this->elem.as_ref());
            return std::tuple<const K&, const V&>{key, value};
        }
    }
    std::tuple<K&, V&> get_key_value_mut() {
        // @unsafe
        {
            auto&& _let_pat = this->elem.as_mut();
            auto& key = std::get<0>(rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_let_pat)));
            auto& value = std::get<1>(rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_let_pat)));
            return std::tuple<K&, V&>{key, value};
        }
    }
    std::tuple<K&, V&> into_key_value() {
        // @unsafe
        {
            auto&& _let_pat = this->elem.as_mut();
            auto& key = std::get<0>(rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_let_pat)));
    ...
    K insert_key(K key) {
        return rusty::mem::replace(this->key_mut(), std::move(key));
    }
    V remove() {
    ...
    std::tuple<K, V> remove_entry() {
        // @unsafe
        {
            return ([&](auto&& __t) -> decltype(auto) { if constexpr (requires { __t._0; }) return (std::forward<decltype(__t)>(__t)._0); else return std::get<0>(std::forward<decltype(__t)>(__t)); })(this->table.remove(std::move(this->elem)));
        }
    }
    template<typename F>
    RawEntryMut<K, V, S, A> replace_entry_with(F f) {
        // @unsafe
        {
            const auto tag = this->table.replace_bucket_with(rusty::clone(this->elem), [&](auto&& _destruct_param0) {
...
return f(key, std::move(value)).map([&](auto&& new_value) { return std::make_tuple(std::move(key), std::move(new_value)); });
});
            if (tag.is_none()) {
                return RawEntryMut<K, V, S, A>{RawEntryMut_Occupied<K, V, S, A>{std::move((*this))}};
            } else {
                return RawEntryMut<K, V, S, A>{RawEntryMut_Vacant<K, V, S, A>{RawVacantEntryMut<K, V, S, A>(this->table, this->hash_builder)}};
            }
        }
    }
    rusty::fmt::Result fmt(rusty::fmt::Formatter& f) const {
        return f.debug_struct("RawOccupiedEntryMut").field("key", this->key()).field("value", this->get()).finish();
    }
};
...
struct RawVacantEntryMut {
    ...
    std::tuple<K&, V&> insert(K key, V value) {
        auto hash = make_hash<K, S>(this->hash_builder, key);
        return this->insert_hashed_nocheck(std::move(hash), std::move(key), std::move(value));
    }
    std::tuple<K&, V&> insert_hashed_nocheck(uint64_t hash, K key, V value) {
        auto&& _let_pat = this->table.insert_entry(std::move(hash), std::make_tuple(std::move(key), std::move(value)), make_hasher<auto, V, S>(this->hash_builder));
        auto& k = std::get<0>(rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_let_pat)));
        auto& v = std::get<1>(rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_let_pat)));
        return std::tuple<K&, V&>{k, v};
    }
    template<typename H>
    std::tuple<K&, V&> insert_with_hasher(uint64_t hash, K key, V value, H hasher) {
        auto&& _let_pat = this->table.insert_entry(std::move(hash), std::make_tuple(std::move(key), std::move(value)), [&](auto&& x) { return hasher(([&](auto&& __t) -> decltype(auto) { if constexpr (requires { __t._0; }) return (std::forward<decltype(__t)>(__t)._0); else return std::get<0>(std::forward<decltype(__t)>(__t)); })(x)); });
        auto& k = std::get<0>(rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_let_pat)));
        auto& v = std::get<1>(rusty::detail::deref_if_pointer(rusty::detail::deref_if_pointer(_let_pat)));
        return std::tuple<K&, V&>{k, v};
    }
    RawOccupiedEntryMut<K, V, S, A> insert_entry(K key, V value) {
        auto hash = make_hash<K, S>(this->hash_builder, key);
        auto elem = this->table.insert(std::move(hash), std::make_tuple(std::move(key), std::move(value)), make_hasher<auto, V, S>(this->hash_builder));
        return RawOccupiedEntryMut<K, V, S, A>{.elem = std::move(elem), .table = this->table, .hash_builder = this->hash_builder};
    }
    rusty::fmt::Result fmt(rusty::fmt::Formatter& f) const {
        return f.debug_struct("RawVacantEntryMut").finish();
    }
};

// #[cfg(test)] module omitted

// orphan impl: methods for `HashMap` absorbed into the host struct in another file
