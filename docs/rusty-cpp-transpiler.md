...
21. Next active item is `Leaf 5.1.13` to collapse this post-5.1.12 block-scope template/control-flow family; guardrail check against §11 remains satisfied (shared AST/runtime-surface-aware fixes only, no crate-specific ad-hoc scripts or generated-output text patching).
