...
19. Next active item is `Leaf 5.1.12` to collapse this post-5.1.11 local-declaration/method-path family; guardrail check against §11 remains satisfied (shared AST/runtime-surface-aware fixes only, no crate-specific ad-hoc scripts or generated-output text patching).
