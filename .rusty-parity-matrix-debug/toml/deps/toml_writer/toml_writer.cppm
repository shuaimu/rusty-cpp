...
namespace key {
    ...
    namespace rusty_ext {
        ...
        rusty::fmt::Result write_toml_key(const std::string_view& self_, W& writer) {
            using Self = std::remove_reference_t<decltype(self_)>;
            return ::key::rusty_ext::write_toml_key(::string::TomlKeyBuilder::new_(std::string_view(self_)).as_default(), rusty::detail::deref_if_pointer_like(writer));
        }
...
namespace value {
    ...
    namespace rusty_ext {
        ...
        rusty::fmt::Result write_toml_value(const std::string_view& self_, W& writer) {
            using Self = std::remove_reference_t<decltype(self_)>;
            return ::value::rusty_ext::write_toml_value(::string::TomlStringBuilder::new_(std::string_view(self_)).as_default(), rusty::detail::deref_if_pointer_like(writer));
        }
...
namespace string {
    rusty::Option<TomlString> TomlStringBuilder::as_literal() const {
        if ((this->metrics.escape_codes || (0 < this->metrics.max_seq_single_quotes)) || this->metrics.newline) {
            ...
            return rusty::Option<TomlString>(TomlString(std::string_view(this->decoded), Encoding::LiteralString, this->metrics.newline));
        }
    }
}
...
namespace string {
    rusty::Option<TomlString> TomlStringBuilder::as_ml_literal() const {
        if (this->metrics.escape_codes || (2 < this->metrics.max_seq_single_quotes)) {
            ...
            return rusty::Option<TomlString>(TomlString(std::string_view(this->decoded), Encoding::MlLiteralString, this->metrics.newline));
        }
    }
}
...
namespace string {
    TomlString TomlStringBuilder::as_basic() const {
        return TomlString(std::string_view(this->decoded), Encoding::BasicString, this->metrics.newline);
    }
}

namespace string {
    TomlString TomlStringBuilder::as_ml_basic() const {
        return TomlString(std::string_view(this->decoded), Encoding::MlBasicString, this->metrics.newline);
    }
}
...
namespace string {
    rusty::Option<TomlKey> TomlKeyBuilder::as_literal() const {
        if (this->metrics.escape_codes || this->metrics.single_quotes) {
            ...
            return rusty::Option<TomlKey>(TomlKey(std::string_view(this->decoded), rusty::Option<Encoding>(Encoding::LiteralString)));
        }
    }
}
...
namespace string {
    TomlKey TomlKeyBuilder::as_basic() const {
        return TomlKey(std::string_view(this->decoded), rusty::Option<Encoding>(Encoding::BasicString));
    }
}
...
namespace integer {
    TomlIntegerFormat TomlIntegerFormat::as_hex_upper() {
        this->radix = Radix{Radix_Hexadecimal{.case_ = HexCase::Upper}};
        return std::move((*this));
    }
}
...
namespace integer {
    TomlIntegerFormat TomlIntegerFormat::as_hex_lower() {
        this->radix = Radix{Radix_Hexadecimal{.case_ = HexCase::Lower}};
        return std::move((*this));
    }
}
