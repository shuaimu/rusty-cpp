            ...
            rusty::Result<typename S::Ok, typename S::Error> serialize(const rusty::net::Ipv6Addr& self_, S serializer) {
                ...
                if (serializer.is_human_readable()) {
                    ...
                    }
                    {
                        ...
                        auto writer = ::format::Buf::new_(buffer);
...
namespace private_ {
    ...
    namespace content {
        ...
        struct Content : std::variant<Content_Bool, Content_U8, Content_U16, Content_U32, Content_U64, Content_I8, Content_I16, Content_I32, Content_I64, Content_F32, Content_F64, Content_Char, Content_String, Content_Str, Content_ByteBuf, Content_Bytes, Content_None, Content_Some, Content_Unit, Content_Newtype, Content_Seq, Content_Map> {
            ...
            static Content Bool(bool _0) { return Content{Content_Bool{std::forward<bool>(_0)}}; }
            static Content U8(uint8_t _0) { return Content{Content_U8{std::forward<uint8_t>(_0)}}; }
            static Content U16(uint16_t _0) { return Content{Content_U16{std::forward<uint16_t>(_0)}}; }
            static Content U32(uint32_t _0) { return Content{Content_U32{std::forward<uint32_t>(_0)}}; }
            static Content U64(uint64_t _0) { return Content{Content_U64{std::forward<uint64_t>(_0)}}; }
            static Content I8(int8_t _0) { return Content{Content_I8{std::forward<int8_t>(_0)}}; }
            static Content I16(int16_t _0) { return Content{Content_I16{std::forward<int16_t>(_0)}}; }
            static Content I32(int32_t _0) { return Content{Content_I32{std::forward<int32_t>(_0)}}; }
            static Content I64(int64_t _0) { return Content{Content_I64{std::forward<int64_t>(_0)}}; }
            static Content F32(float _0) { return Content{Content_F32{std::forward<float>(_0)}}; }
            static Content F64(double _0) { return Content{Content_F64{std::forward<double>(_0)}}; }
            static Content Char(char32_t _0) { return Content{Content_Char{std::forward<char32_t>(_0)}}; }
            static Content String(rusty::String _0) { return Content{Content_String{std::forward<rusty::String>(_0)}}; }
            static Content Str(std::string_view _0) { return Content{Content_Str{std::forward<std::string_view>(_0)}}; }
            static Content ByteBuf(rusty::Vec<uint8_t> _0) { return Content{Content_ByteBuf{std::forward<rusty::Vec<uint8_t>>(_0)}}; }
            static Content Bytes(std::span<const uint8_t> _0) { return Content{Content_Bytes{std::forward<std::span<const uint8_t>>(_0)}}; }
            static Content None() { return Content{Content_None{}}; }
            static Content Some(rusty::Box<Content> _0) { return Content{Content_Some{std::forward<rusty::Box<Content>>(_0)}}; }
            static Content Unit() { return Content{Content_Unit{}}; }
            static Content Newtype(rusty::Box<Content> _0) { return Content{Content_Newtype{std::forward<rusty::Box<Content>>(_0)}}; }
            static Content Seq(rusty::Vec<Content> _0) { return Content{Content_Seq{std::forward<rusty::Vec<Content>>(_0)}}; }
            static Content Map(rusty::Vec<std::tuple<Content, Content>> _0) { return Content{Content_Map{std::forward<rusty::Vec<std::tuple<Content, Content>>>(_0)}}; }
...
namespace de {
    ...
    struct Unexpected : std::variant<Unexpected_Bool, Unexpected_Unsigned, Unexpected_Signed, Unexpected_Float, Unexpected_Char, Unexpected_Str, Unexpected_Bytes, Unexpected_Unit, Unexpected_Option, Unexpected_NewtypeStruct, Unexpected_Seq, Unexpected_Map, Unexpected_Enum, Unexpected_UnitVariant, Unexpected_NewtypeVariant, Unexpected_TupleVariant, Unexpected_StructVariant, Unexpected_Other> {
        ...
        using variant::variant;
        static Unexpected Bool(bool _0) { return Unexpected{Unexpected_Bool{std::forward<bool>(_0)}}; }
        static Unexpected Unsigned(uint64_t _0) { return Unexpected{Unexpected_Unsigned{std::forward<uint64_t>(_0)}}; }
        static Unexpected Signed(int64_t _0) { return Unexpected{Unexpected_Signed{std::forward<int64_t>(_0)}}; }
        static Unexpected Float(double _0) { return Unexpected{Unexpected_Float{std::forward<double>(_0)}}; }
        static Unexpected Char(char32_t _0) { return Unexpected{Unexpected_Char{std::forward<char32_t>(_0)}}; }
        static Unexpected Str(std::string_view _0) { return Unexpected{Unexpected_Str{std::forward<std::string_view>(_0)}}; }
        static Unexpected Bytes(std::span<const uint8_t> _0) { return Unexpected{Unexpected_Bytes{std::forward<std::span<const uint8_t>>(_0)}}; }
        ...
        static Unexpected Other(std::string_view _0) { return Unexpected{Unexpected_Other{std::forward<std::string_view>(_0)}}; }
    ...
    namespace value {
        ...
        struct Error {
            ...
            static Error invalid_type(const auto& unexp, const auto& exp);
            static Error invalid_value(const auto& unexp, const auto& exp);
        ...
        struct UnitDeserializer {
            ...
            template<typename V>
            rusty::Result<typename V::Value, E> deserialize_any(V visitor) {
                return visitor.visit_unit();
            }
            template<typename V>
            rusty::Result<typename V::Value, E> deserialize_option(V visitor) {
        ...
        struct U32Deserializer {
            ...
            using Variant = private_::UnitOnly<E>;
            uint32_t value;
            rusty::PhantomData<E> marker;
            ...
            template<typename V>
            rusty::Result<typename V::Value, E> deserialize_enum(std::string_view name, std::span<const std::string_view> variants, V visitor) {
                static_cast<void>(name);
                static_cast<void>(variants);
            ...
            template<typename T>
            rusty::Result<std::tuple<typename T::Value, private_::UnitOnly<E>>, E> variant_seed(T seed) {
        ...
        struct CowStrDeserializer {
            ...
            template<typename V>
            rusty::Result<typename V::Value, E> deserialize_any(V visitor) {
                return [&]() { auto&& _m = this->value; return std::visit(overloaded { [&](rusty::Cow_Borrowed&& _v) -> rusty::Result<typename V::Value, E> { auto&& string = _v._0; return visitor.visit_str(std::move(rusty::to_string_view(string))); }, [&](rusty::Cow_Owned&& _v) -> rusty::Result<typename V::Value, E> { auto&& string = _v._0; return visitor.visit_string(std::move(string)); } }, std::move(_m)); }();
            }
            template<typename V>
            rusty::Result<typename V::Value, E> deserialize_enum(std::string_view name, std::span<const std::string_view> variants, V visitor) {
                static_cast<void>(name);
...
return rusty::Result<typename V::Value, E>::Err(std::move(err)); } std::move(_match_value).value(); });
                ...
                return rusty::Result<typename V::Value, E>::Ok(std::move(v));
            }
            template<typename V, typename T>
            ...
            template<typename V, typename T>
            rusty::Result<rusty::Option<typename V::Value>, E> next_element_seed(V seed) {
                return [&]() -> rusty::Result<rusty::Option<typename V::Value>, E> { auto&& _m = this->iter.next(); if (_m.is_some()) { auto&& _mv0 = _m.unwrap(); auto&& value = _mv0; return [&]() -> rusty::Result<rusty::Option<typename V::Value>, E> { [&]() { static_cast<void>(this->count += 1); return std::make_tuple(); }();
return ::de::rusty_ext::deserialize(seed, ::de::value::rusty_ext::into_deserializer(std::move(value))).map(rusty::Some); }(); } if (_m.is_none()) { return rusty::Result<rusty::Option<typename V::Value>, E>::Ok(rusty::Option<typename V::Value>(rusty::None)); } return [&]() -> rusty::Result<rusty::Option<typename V::Value>, E> { rusty::intrinsics::unreachable(); }(); }();
            }
            template<typename T>
        ...
        struct SeqAccessDeserializer {
            ...
            rusty::fmt::Result fmt(rusty::fmt::Formatter& f) const {
                return rusty::fmt::Formatter::debug_struct_field1_finish(f, "SeqAccessDeserializer", "seq", &this->seq);
            }
        ...
        struct MapDeserializer {
            ...
            decltype(std::declval<I>().fuse()) iter;
            rusty::Option<Second<rusty::detail::associated_item_t<I>>> value;
            size_t count;
            rusty::PhantomData<const std::tuple<>&> lifetime;
            rusty::PhantomData<E> error;

            static MapDeserializer<I, E> new_(I iter) {
                return MapDeserializer<I, E>{.iter = iter.fuse(), .value = rusty::Option<Second<rusty::detail::associated_item_t<I>>>(rusty::None), .count = static_cast<size_t>(0), .lifetime = rusty::PhantomData<const std::tuple<>&>{}, .error = rusty::PhantomData<E>{}};
            }
            rusty::Result<std::tuple<>, E> end() {
                const auto remaining = this->iter.count();
                if (remaining == 0) {
            ...
            auto next_pair() {
                return [&]() -> rusty::Option<std::tuple<First<rusty::detail::associated_item_t<I>>, Second<rusty::detail::associated_item_t<I>>>> { auto&& _m = this->iter.next(); if (_m.is_some()) { auto&& _mv0 = _m.unwrap(); auto&& kv = _mv0; return [&]() -> rusty::Option<std::tuple<First<rusty::detail::associated_item_t<I>>, Second<rusty::detail::associated_item_t<I>>>> { [&]() { static_cast<void>(this->count += 1); return std::make_tuple(); }();
return rusty::Option<std::tuple<First<rusty::detail::associated_item_t<I>>, Second<rusty::detail::associated_item_t<I>>>>((std::move(kv)).split()); }(); } if (_m.is_none()) { return rusty::Option<std::tuple<First<rusty::detail::associated_item_t<I>>, Second<rusty::detail::associated_item_t<I>>>>(rusty::None); } return [&]() -> rusty::Option<std::tuple<First<rusty::detail::associated_item_t<I>>, Second<rusty::detail::associated_item_t<I>>>> { rusty::intrinsics::unreachable(); }(); }();
            }
            template<typename V>
            rusty::Result<typename V::Value, E> deserialize_any(V visitor) {
...
return rusty::Result<typename V::Value, E>::Err(std::move(err)); } std::move(_match_value).value(); });
            ...
            template<typename V>
            rusty::Result<typename V::Value, E> deserialize_seq(V visitor) {
...
return rusty::Result<typename V::Value, E>::Err(std::move(err)); } std::move(_match_value).value(); });
            ...
            template<typename V>
            rusty::Result<typename V::Value, E> deserialize_tuple(size_t len, V visitor) {
                static_cast<void>(std::move(len));
            ...
            template<typename T>
            rusty::Result<rusty::Option<typename T::Value>, E> next_key_seed(T seed) {
                return [&]() -> rusty::Result<rusty::Option<typename T::Value>, E> { auto&& _m = this->next_pair(); if (_m.is_some()) { auto&& _mv0 = _m.unwrap(); auto&& key = std::get<0>(rusty::detail::deref_if_pointer(_mv0)); auto&& value = std::get<1>(rusty::detail::deref_if_pointer(_mv0)); return [&]() -> rusty::Result<rusty::Option<typename T::Value>, E> { this->value = rusty::Option<Second<rusty::detail::associated_item_t<I>>>(std::move(value));
return ::de::rusty_ext::deserialize(seed, ::de::value::rusty_ext::into_deserializer(std::move(key))).map(rusty::Some); }(); } if (_m.is_none()) { return rusty::Result<rusty::Option<typename T::Value>, E>::Ok(rusty::Option<typename T::Value>(rusty::None)); } return [&]() -> rusty::Result<rusty::Option<typename T::Value>, E> { rusty::intrinsics::unreachable(); }(); }();
            }
            template<typename T>
            rusty::Result<typename T::Value, E> next_value_seed(T seed) {
            ...
            rusty::Result<rusty::Option<std::tuple<typename TK::Value, typename TV::Value>>, E> next_entry_seed(TK kseed, TV vseed) {
                return [&]() -> rusty::Result<rusty::Option<std::tuple<typename TK::Value, typename TV::Value>>, E> { auto&& _m = this->next_pair(); if (_m.is_some()) { auto&& _mv0 = _m.unwrap(); auto&& key = std::get<0>(rusty::detail::deref_if_pointer(_mv0)); auto&& value = std::get<1>(rusty::detail::deref_if_pointer(_mv0)); return [&]() -> rusty::Result<rusty::Option<std::tuple<typename TK::Value, typename TV::Value>>, E> { auto key_shadow1 = ({ auto&& _m = ::de::rusty_ext::deserialize(kseed, ::de::value::rusty_ext::into_deserializer(std::move(key))); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
auto&& err = _mv;
return rusty::Result<rusty::Option<std::tuple<typename TK::Value, typename TV::Value>>, E>::Err(std::move(err)); } std::move(_match_value).value(); });
...
auto&& err = _mv;
return rusty::Result<rusty::Option<std::tuple<typename TK::Value, typename TV::Value>>, E>::Err(std::move(err)); } std::move(_match_value).value(); });
return rusty::Result<rusty::Option<std::tuple<typename TK::Value, typename TV::Value>>, E>::Ok(rusty::Option<std::tuple<typename TK::Value, typename TV::Value>>(std::make_tuple(std::move(key_shadow1), std::move(value_shadow1)))); }(); } if (_m.is_none()) { return rusty::Result<rusty::Option<std::tuple<typename TK::Value, typename TV::Value>>, E>::Ok(rusty::Option<std::tuple<typename TK::Value, typename TV::Value>>(rusty::None)); } return [&]() -> rusty::Result<rusty::Option<std::tuple<typename TK::Value, typename TV::Value>>, E> { rusty::intrinsics::unreachable(); }(); }();
            }
            rusty::Option<size_t> size_hint() const {
                return size_hint::from_bounds(this->iter);
            }
            template<typename T>
            rusty::Result<rusty::Option<typename T::Value>, E> next_element_seed(T seed) {
                return [&]() -> rusty::Result<rusty::Option<typename T::Value>, E> { auto&& _m = this->next_pair(); if (_m.is_some()) { auto&& _mv0 = _m.unwrap(); auto&& k = std::get<0>(rusty::detail::deref_if_pointer(_mv0)); auto&& v = std::get<1>(rusty::detail::deref_if_pointer(_mv0)); return [&]() -> rusty::Result<rusty::Option<typename T::Value>, E> { auto de_shadow1 = PairDeserializer(std::move(k), std::move(v), rusty::PhantomData<E>{});
return ::de::rusty_ext::deserialize(seed, std::move(de_shadow1)).map(rusty::Some); }(); } if (_m.is_none()) { return rusty::Result<rusty::Option<typename T::Value>, E>::Ok(rusty::Option<typename T::Value>(rusty::None)); } return [&]() -> rusty::Result<rusty::Option<typename T::Value>, E> { rusty::intrinsics::unreachable(); }(); }();
            }
...
return rusty::Result<typename V::Value, E>::Err(std::move(err)); } std::move(_match_value).value(); });
                if (pair_visitor._1.is_none()) {
                    return rusty::Result<typename V::Value, E>::Ok(std::move(pair));
                } else {
                    const auto remaining = pair_visitor.size_hint().unwrap();
                    return rusty::Result<typename V::Value, E>::Err(E::invalid_length(2, rusty::addr_of_temp(ExpectedInSeq(2 - remaining))));
                }
            }
            template<typename V>
            rusty::Result<typename V::Value, E> deserialize_tuple(size_t len, V visitor) {
                if (len == static_cast<size_t>(2)) {
                    ...
                    return rusty::Result<typename V::Value, E>::Err(E::invalid_length(2, rusty::addr_of_temp(ExpectedInSeq(std::move(len)))));
                }
            }
        };
        ...
        struct PairVisitor {
            ...
            rusty::Result<rusty::Option<typename T::Value>, E> next_element_seed(T seed) {
                if (auto&& _iflet_scrutinee = this->_0.take(); _iflet_scrutinee.is_some()) {
                    ...
                    return rusty::Result<rusty::Option<typename T::Value>, E>::Ok(rusty::Option<typename T::Value>(rusty::None));
                }
            }
            rusty::Option<size_t> size_hint() const {
                if (this->_0.is_some()) {
        ...
        struct MapAccessDeserializer {
            ...
            // Rust-only dependent associated type alias skipped in constrained mode: Error
            using Variant = private_::MapAsEnum<A>;
            A map;
            ...
            rusty::fmt::Result fmt(rusty::fmt::Formatter& f) const {
                return rusty::fmt::Formatter::debug_struct_field1_finish(f, "MapAccessDeserializer", "map", &this->map);
            }
            ...
            // Rust-only dependent associated type alias skipped in constrained mode: Error
            template<typename T>
            rusty::Result<std::tuple<typename T::Value, private_::MapAsEnum<A>>, typename A::Error> variant_seed(T seed) {
                return [&]() -> rusty::Result<std::tuple<typename T::Value, private_::MapAsEnum<A>>, typename A::Error> { auto&& _m = ({ auto&& _m = this->map.next_key_seed(std::move(seed)); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
auto&& err = _mv;
return rusty::Result<std::tuple<typename T::Value, private_::MapAsEnum<A>>, typename A::Error>::Err(std::move(err)); } std::move(_match_value).value(); }); if (_m.is_some()) { auto&& _mv0 = _m.unwrap(); auto&& key = _mv0; return rusty::Result<std::tuple<typename T::Value, private_::MapAsEnum<A>>, typename A::Error>::Ok(std::make_tuple(std::move(key), private_::map_as_enum(std::move(this->map)))); } if (_m.is_none()) { return rusty::Result<std::tuple<typename T::Value, private_::MapAsEnum<A>>, typename A::Error>::Err(A::Error::invalid_type(::de::Unexpected_Map{}, rusty::addr_of_temp("enum"))); } return [&]() -> rusty::Result<std::tuple<typename T::Value, private_::MapAsEnum<A>>, typename A::Error> { rusty::intrinsics::unreachable(); }(); }();
            }
        };
        ...
        struct EnumAccessDeserializer {
            ...
            rusty::fmt::Result fmt(rusty::fmt::Formatter& f) const {
                return rusty::fmt::Formatter::debug_struct_field1_finish(f, "EnumAccessDeserializer", "access", &this->access);
            }
        ...
        namespace private_ {
            ...
            struct UnitOnly {
                ...
                rusty::Result<typename T::Value, E> newtype_variant_seed(T _seed) {
                    return rusty::Result<typename T::Value, E>::Err(E::invalid_type(de::Unexpected_UnitVariant{}, rusty::addr_of_temp("newtype variant")));
                }
                template<typename V>
                rusty::Result<typename V::Value, E> tuple_variant(size_t _len, V _visitor) {
                    return rusty::Result<typename V::Value, E>::Err(E::invalid_type(de::Unexpected_UnitVariant{}, rusty::addr_of_temp("tuple variant")));
                }
                template<typename V>
                rusty::Result<typename V::Value, E> struct_variant(std::span<const std::string_view> _fields, V _visitor) {
                    return rusty::Result<typename V::Value, E>::Err(E::invalid_type(de::Unexpected_UnitVariant{}, rusty::addr_of_temp("struct variant")));
                }
            };
    ...
    Windows
        ...
        struct OptionVisitor {
            ...
            template<typename E>
            rusty::Result<rusty::Option<T>, E> visit_unit() {
                return rusty::Result<rusty::Option<T>, E>::Ok(rusty::None);
            }
            template<typename E>
            rusty::Result<rusty::Option<T>, E> visit_none() {
                return rusty::Result<rusty::Option<T>, E>::Ok(rusty::None);
            }
            template<typename D>
            rusty::Result<rusty::Option<T>, typename D::Error> visit_some(D deserializer) {
                return T::deserialize(std::move(deserializer)).map(rusty::Some);
            }
            template<typename D>
            rusty::Result<rusty::Option<T>, std::tuple<>> __private_visit_untagged_option(D deserializer) {
                return rusty::Result<rusty::Option<T>, std::tuple<>>::Ok(T::deserialize(std::move(deserializer)).ok());
            }
        };
        ...
        struct PhantomDataVisitor {
            ...
            template<typename E>
            rusty::Result<rusty::PhantomData<T>, E> visit_unit() {
                return rusty::Result<rusty::PhantomData<T>, E>::Ok(rusty::PhantomData<T>{});
            }
        };
        ...
        struct ArrayInPlaceVisitor {
            ...
            template<typename T>
            rusty::Result<std::tuple<>, typename A::Error> visit_seq(A seq) {
...
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
auto&& err = _mv;
return rusty::Result<std::tuple<>, typename A::Error>::Err(std::move(err)); } std::move(_match_value).value(); }).is_none()) {
                ...
                if (fail_idx.is_some()) {
                    ...
                    return rusty::Result<std::tuple<>, typename A::Error>::Err(A::Error::invalid_length(std::move(idx), (*this)));
                }
                return rusty::Result<std::tuple<>, typename A::Error>::Ok(std::make_tuple());
            }
        };
    ...
    End
            ...
            struct RangeVisitor {
                ...
                template<typename A>
                rusty::Result<std::tuple<Idx, Idx>, typename A::Error> visit_seq(A seq) {
...
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
auto&& err = _mv;
return rusty::Result<std::tuple<Idx, Idx>, typename A::Error>::Err(std::move(err)); } std::move(_match_value).value(); }); std::optional<Idx> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& value = _mv;
_match_value.emplace(std::move(value)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Result<std::tuple<Idx, Idx>, typename A::Error>::Err(A::Error::invalid_length(0, (*this))); } std::move(_match_value).value(); });
...
return rusty::Result<std::tuple<Idx, Idx>, typename A::Error>::Err(std::move(err)); } std::move(_match_value).value(); }); std::optional<Idx> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& value = _mv;
_match_value.emplace(std::move(value)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Result<std::tuple<Idx, Idx>, typename A::Error>::Err(A::Error::invalid_length(1, (*this))); } std::move(_match_value).value(); });
                    return rusty::Result<std::tuple<Idx, Idx>, typename A::Error>::Ok(std::make_tuple(std::move(start), std::move(end)));
                }
                template<typename A>
                rusty::Result<std::tuple<Idx, Idx>, typename A::Error> visit_map(A map) {
...
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
auto&& err = _mv;
return rusty::Result<std::tuple<Idx, Idx>, typename A::Error>::Err(std::move(err)); } std::move(_match_value).value(); });
                        ...
                        {
                            if (start.is_some()) {
                                return rusty::Result<std::tuple<Idx, Idx>, typename A::Error>::Err(A::Error::duplicate_field("start"));
                            }
...
return rusty::Result<std::tuple<Idx, Idx>, typename A::Error>::Err(std::move(err)); } std::move(_match_value).value(); }));
                        ...
                        {
                            if (end.is_some()) {
                                return rusty::Result<std::tuple<Idx, Idx>, typename A::Error>::Err(A::Error::duplicate_field("end"));
                            }
...
auto&& start = _mv;
_match_value.emplace(std::move(start)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Result<std::tuple<Idx, Idx>, typename A::Error>::Err(A::Error::missing_field("start")); } std::move(_match_value).value(); });
                    auto end_shadow1 = ({ auto&& _m = end; std::optional<Idx> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& end = _mv;
_match_value.emplace(std::move(end)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Result<std::tuple<Idx, Idx>, typename A::Error>::Err(A::Error::missing_field("end")); } std::move(_match_value).value(); });
                    return rusty::Result<std::tuple<Idx, Idx>, typename A::Error>::Ok(std::make_tuple(std::move(start_shadow1), std::move(end_shadow1)));
                }
            };
        ...
        namespace range_from {
            ...
            struct RangeFromVisitor {
                ...
                template<typename A>
                rusty::Result<Idx, typename A::Error> visit_seq(A seq) {
                    Idx start = ({ auto&& _m = ({ auto&& _m = seq.next_element(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
auto&& err = _mv;
return rusty::Result<Idx, typename A::Error>::Err(std::move(err)); } std::move(_match_value).value(); }); std::optional<Idx> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& value = _mv;
_match_value.emplace(std::move(value)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Result<Idx, typename A::Error>::Err(A::Error::invalid_length(0, (*this))); } std::move(_match_value).value(); });
                    return rusty::Result<Idx, typename A::Error>::Ok(std::move(start));
                }
                template<typename A>
                rusty::Result<Idx, typename A::Error> visit_map(A map) {
                    rusty::Option<Idx> start = rusty::Option<Idx>(rusty::None);
                    while (true) {
                        auto&& _whilelet = ({ auto&& _m = map.next_key(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
auto&& err = _mv;
return rusty::Result<Idx, typename A::Error>::Err(std::move(err)); } std::move(_match_value).value(); });
                        if (!(_whilelet.is_some())) { break; }
                        auto key = _whilelet.unwrap();
                        switch (key) {
                        case Field::Start:
                        {
                            if (start.is_some()) {
                                return rusty::Result<Idx, typename A::Error>::Err(A::Error::duplicate_field("start"));
                            }
                            start = rusty::Option<Idx>(({ auto&& _m = map.next_value(); std::optional<Idx> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
...
return rusty::Result<Idx, typename A::Error>::Err(std::move(err)); } std::move(_match_value).value(); }));
                    ...
                    auto start_shadow1 = ({ auto&& _m = start; std::optional<Idx> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& start = _mv;
_match_value.emplace(std::move(start)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Result<Idx, typename A::Error>::Err(A::Error::missing_field("start")); } std::move(_match_value).value(); });
                    return rusty::Result<Idx, typename A::Error>::Ok(std::move(start_shadow1));
                }
            };
...
auto&& value = _mv;
_match_value.emplace(std::move(value)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Result<Idx, typename A::Error>::Err(A::Error::invalid_length(0, (*this))); } std::move(_match_value).value(); });
                    return rusty::Result<Idx, typename A::Error>::Ok(std::move(end));
                }
                template<typename A>
                rusty::Result<Idx, typename A::Error> visit_map(A map) {
                    rusty::Option<Idx> end = rusty::Option<Idx>(rusty::None);
...
return rusty::Result<Idx, typename A::Error>::Err(std::move(err)); } std::move(_match_value).value(); });
                        ...
                        {
                            if (end.is_some()) {
                                return rusty::Result<Idx, typename A::Error>::Err(A::Error::duplicate_field("end"));
                            }
                            end = rusty::Option<Idx>(({ auto&& _m = map.next_value(); std::optional<Idx> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
...
return rusty::Result<Idx, typename A::Error>::Err(std::move(err)); } std::move(_match_value).value(); }));
                    ...
                    auto end_shadow1 = ({ auto&& _m = end; std::optional<Idx> _match_value; if (_m.is_some()) { auto _mv = _m.unwrap();
auto&& end = _mv;
_match_value.emplace(std::move(end)); } else { if (!(_m.is_none())) { rusty::intrinsics::unreachable(); } return rusty::Result<Idx, typename A::Error>::Err(A::Error::missing_field("end")); } std::move(_match_value).value(); });
                    return rusty::Result<Idx, typename A::Error>::Ok(std::move(end_shadow1));
                }
            };
        ...
        struct FromStrVisitor {
            ...
            template<typename E>
            rusty::Result<T, E> visit_str(std::string_view s) {
                return T::from_str(s).map_err([&](auto&& _err) -> E { return (E::custom) (std::forward<decltype(_err)>(_err)); });
            }
        };
...
namespace de::value {
        Error Error::invalid_type(const auto& unexp, const auto& exp) {
            return Error::custom(std::format("invalid type: {0}, expected {1}", rusty::to_string(unexp), rusty::to_string(exp)));
        }
}

namespace de::value {
        Error Error::invalid_value(const auto& unexp, const auto& exp) {
...
namespace de::value {
        Error Error::unknown_variant(std::string_view variant, std::span<const std::string_view> expected) {
            if (rusty::is_empty(expected)) {
                ...
                return Error::custom(std::format("unknown variant `{0}`, expected {1}", rusty::to_string(variant), rusty::to_string(OneOf{.names = expected})));
            }
        }
}
...
namespace de::value {
        Error Error::unknown_field(std::string_view field, std::span<const std::string_view> expected) {
            if (rusty::is_empty(expected)) {
                ...
                return Error::custom(std::format("unknown field `{0}`, expected {1}", rusty::to_string(field), rusty::to_string(OneOf{.names = expected})));
            }
        }
}
...
namespace de::ignored_any {
        ...
        rusty::Result<IgnoredAny, typename D::Error> IgnoredAny::visit_some(D deserializer) {
            return IgnoredAny::deserialize(std::move(deserializer));
        }
}
...
namespace de::ignored_any {
        ...
        auto IgnoredAny::deserialize_in_place(D deserializer, IgnoredAny& place) {
            place = ({ auto&& _m = IgnoredAny::deserialize(std::move(deserializer)); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
auto&& err = _mv;
...
namespace de::impls {
        ...
        rusty::Result<std::tuple<>, E> StringInPlaceVisitor::visit_byte_buf(rusty::Vec<uint8_t> v) {
            return [&]() -> rusty::Result<std::tuple<>, E> { auto&& _m = rusty::String::from_utf8(std::move(v)); if (_m.is_ok()) { auto&& _mv0 = _m.unwrap(); auto&& s = _mv0; return [&]() -> rusty::Result<std::tuple<>, E> { this->_0 = s;
...
namespace de::impls {
        ...
        rusty::Result<rusty::ffi::CString, typename A::Error> CStringVisitor::visit_seq(A seq) {
            ...
            auto values = rusty::Vec<uint8_t>::with_capacity(std::move(capacity));
            while (true) {
                auto&& _whilelet = ({ auto&& _m = seq.next_element(); std::optional<std::remove_cvref_t<decltype(_m.unwrap())>> _match_value; if (_m.is_ok()) { auto _mv = _m.unwrap();
auto&& val = _mv;
_match_value.emplace(std::move(val)); } else { if (!(_m.is_err())) { rusty::intrinsics::unreachable(); } auto _mv = _m.unwrap_err();
...
namespace de::impls {
        ...
        rusty::Result<rusty::path::PathBuf, E> PathBufVisitor::visit_byte_buf(rusty::Vec<uint8_t> v) {
            return rusty::String::from_utf8(std::move(v)).map([&](auto&& _v) -> rusty::path::PathBuf { return rusty::from_into<rusty::path::PathBuf>(std::forward<decltype(_v)>(_v)); }).map_err([&](auto&& _err) -> E { return ([&](auto&& e) { return E::invalid_value(de::Unexpected_Bytes{e.into_bytes()}, (*this)); }) (std::forward<decltype(_err)>(_err)); });
        }
}
