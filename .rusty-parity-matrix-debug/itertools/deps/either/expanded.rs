...
mod iterator {
        ...
        R: Extend<A>,
    {
        ...
        {
            match self {
                crate::Either::Left(inner) => inner.extend(iter),
                crate::Either::Right(inner) => inner.extend(iter),
            }
        }
    }
        ...
        R: Iterator<Item = L::Item>,
    {
        ...
        fn next(&mut self) -> Option<Self::Item> {
            match self {
                crate::Either::Left(inner) => inner.next(),
                crate::Either::Right(inner) => inner.next(),
            }
        }
        fn size_hint(&self) -> (usize, Option<usize>) {
            match self {
                crate::Either::Left(inner) => inner.size_hint(),
                crate::Either::Right(inner) => inner.size_hint(),
            }
        }
        ...
        fn nth(&mut self, n: usize) -> Option<Self::Item> {
            match self {
                crate::Either::Left(inner) => inner.nth(n),
                crate::Either::Right(inner) => inner.nth(n),
            }
        }
        fn collect<B>(self) -> B
        where
        ...
        {
            match self {
                crate::Either::Left(inner) => inner.all(f),
                crate::Either::Right(inner) => inner.all(f),
            }
        }
        ...
        {
            match self {
                crate::Either::Left(inner) => inner.any(f),
                crate::Either::Right(inner) => inner.any(f),
            }
        }
        ...
        {
            match self {
                crate::Either::Left(inner) => inner.find(predicate),
                crate::Either::Right(inner) => inner.find(predicate),
            }
        }
        ...
        {
            match self {
                crate::Either::Left(inner) => inner.find_map(f),
                crate::Either::Right(inner) => inner.find_map(f),
            }
        }
        ...
        {
            match self {
                crate::Either::Left(inner) => inner.position(predicate),
                crate::Either::Right(inner) => inner.position(predicate),
            }
        }
    }
        ...
        R: DoubleEndedIterator<Item = L::Item>,
    {
        fn next_back(&mut self) -> Option<Self::Item> {
            match self {
                crate::Either::Left(inner) => inner.next_back(),
                crate::Either::Right(inner) => inner.next_back(),
            }
        }
        fn nth_back(&mut self, n: usize) -> Option<Self::Item> {
            match self {
                crate::Either::Left(inner) => inner.nth_back(n),
                crate::Either::Right(inner) => inner.nth_back(n),
            }
        }
        ...
        {
            match self {
                crate::Either::Left(inner) => inner.rfind(predicate),
                crate::Either::Right(inner) => inner.rfind(predicate),
            }
        }
    }
        ...
        R: ExactSizeIterator<Item = L::Item>,
    {
        fn len(&self) -> usize {
            match self {
                crate::Either::Left(inner) => inner.len(),
                crate::Either::Right(inner) => inner.len(),
            }
        }
    }
...
impl<L, R> Either<L, R> {
    ...
    {
        match self {
            crate::Either::Left(inner) => inner.into(),
            crate::Either::Right(inner) => inner.into(),
        }
    }
}
    ...
    R: Read,
{
    fn read(&mut self, buf: &mut [u8]) -> io::Result<usize> {
        match self {
            crate::Either::Left(inner) => inner.read(buf),
            crate::Either::Right(inner) => inner.read(buf),
        }
    }
    fn read_exact(&mut self, buf: &mut [u8]) -> io::Result<()> {
        match self {
            crate::Either::Left(inner) => inner.read_exact(buf),
            crate::Either::Right(inner) => inner.read_exact(buf),
        }
    }
    fn read_to_end(&mut self, buf: &mut std::vec::Vec<u8>) -> io::Result<usize> {
        match self {
            crate::Either::Left(inner) => inner.read_to_end(buf),
            crate::Either::Right(inner) => inner.read_to_end(buf),
        }
    }
    fn read_to_string(&mut self, buf: &mut std::string::String) -> io::Result<usize> {
        match self {
            crate::Either::Left(inner) => inner.read_to_string(buf),
            crate::Either::Right(inner) => inner.read_to_string(buf),
        }
    }
}
    ...
    R: Seek,
{
    fn seek(&mut self, pos: SeekFrom) -> io::Result<u64> {
        match self {
            crate::Either::Left(inner) => inner.seek(pos),
            crate::Either::Right(inner) => inner.seek(pos),
        }
    }
}
/// Requires crate feature `"std"`
    ...
    R: BufRead,
{
    fn fill_buf(&mut self) -> io::Result<&[u8]> {
        match self {
            crate::Either::Left(inner) => inner.fill_buf(),
            crate::Either::Right(inner) => inner.fill_buf(),
        }
    }
    fn consume(&mut self, amt: usize) {
        match self {
            crate::Either::Left(inner) => inner.consume(amt),
            crate::Either::Right(inner) => inner.consume(amt),
        }
    }
    fn read_until(
        &mut self,
        ...
        match self {
            crate::Either::Left(inner) => inner.read_until(byte, buf),
            crate::Either::Right(inner) => inner.read_until(byte, buf),
        }
    }
    fn read_line(&mut self, buf: &mut std::string::String) -> io::Result<usize> {
        match self {
            crate::Either::Left(inner) => inner.read_line(buf),
            crate::Either::Right(inner) => inner.read_line(buf),
        }
    }
}
    ...
    R: Write,
{
    fn write(&mut self, buf: &[u8]) -> io::Result<usize> {
        match self {
            crate::Either::Left(inner) => inner.write(buf),
            crate::Either::Right(inner) => inner.write(buf),
        }
    }
    fn write_all(&mut self, buf: &[u8]) -> io::Result<()> {
        match self {
            crate::Either::Left(inner) => inner.write_all(buf),
            crate::Either::Right(inner) => inner.write_all(buf),
        }
    }
    fn write_fmt(&mut self, fmt: fmt::Arguments<'_>) -> io::Result<()> {
        match self {
            crate::Either::Left(inner) => inner.write_fmt(fmt),
            crate::Either::Right(inner) => inner.write_fmt(fmt),
        }
    }
    fn flush(&mut self) -> io::Result<()> {
        match self {
            crate::Either::Left(inner) => inner.flush(),
            crate::Either::Right(inner) => inner.flush(),
        }
    }
}
    ...
    R: AsRef<Target>,
{
    fn as_ref(&self) -> &Target {
        match self {
            crate::Either::Left(inner) => inner.as_ref(),
            crate::Either::Right(inner) => inner.as_ref(),
        }
    }
}
    ...
    R: AsMut<str>,
{
    fn as_mut(&mut self) -> &mut str {
        match self {
            crate::Either::Left(inner) => inner.as_mut(),
            crate::Either::Right(inner) => inner.as_mut(),
        }
    }
}
///Requires crate feature `std`.
    ...
    R: DerefMut<Target = L::Target>,
{
    fn deref_mut(&mut self) -> &mut Self::Target {
        match self {
            crate::Either::Left(inner) => &mut *inner,
            crate::Either::Right(inner) => &mut *inner,
        }
    }
}
    ...
    R: Error,
{
    fn source(&self) -> Option<&(dyn Error + 'static)> {
        match self {
            crate::Either::Left(inner) => inner.source(),
            crate::Either::Right(inner) => inner.source(),
        }
    }
    #[allow(deprecated)]
    fn description(&self) -> &str {
        match self {
            crate::Either::Left(inner) => inner.description(),
            crate::Either::Right(inner) => inner.description(),
        }
    }
    #[allow(deprecated)]
    fn cause(&self) -> Option<&dyn Error> {
        match self {
            crate::Either::Left(inner) => inner.cause(),
            crate::Either::Right(inner) => inner.cause(),
        }
    }
}
    ...
    R: fmt::Display,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            crate::Either::Left(inner) => inner.fmt(f),
            crate::Either::Right(inner) => inner.fmt(f),
        }
    }
}
    ...
    R: fmt::Write,
{
    fn write_str(&mut self, s: &str) -> fmt::Result {
        match self {
            crate::Either::Left(inner) => inner.write_str(s),
            crate::Either::Right(inner) => inner.write_str(s),
        }
    }
    fn write_char(&mut self, c: char) -> fmt::Result {
        match self {
            crate::Either::Left(inner) => inner.write_char(c),
            crate::Either::Right(inner) => inner.write_char(c),
        }
    }
    fn write_fmt(&mut self, args: fmt::Arguments<'_>) -> fmt::Result {
        match self {
            crate::Either::Left(inner) => inner.write_fmt(args),
            crate::Either::Right(inner) => inner.write_fmt(args),
        }
    }
}
