...
namespace encoder {
    ...
    rusty::Result<Value, toml_test_harness::Error> from_decoded_scalar(const toml_test_harness::DecodedScalar& decoded) {
        return [&]() { auto&& _m = decoded; return std::visit(overloaded { [&](const toml_test_harness::DecodedScalar_String& _v) -> rusty::Result<Value, toml_test_harness::Error> { auto&& value = _v._0; return rusty::Result<Value, toml_test_harness::Error>::Ok(Value::String(rusty::clone(value))); }, [&](const toml_test_harness::DecodedScalar_Integer& _v) -> rusty::Result<Value, toml_test_harness::Error> { auto&& value = _v._0; return rusty::str_runtime::parse<int64_t>(value).map_err(toml_test_harness::Error::new_).map(Value::Integer); }, [&](const toml_test_harness::DecodedScalar_Float& _v) -> rusty::Result<Value, toml_test_harness::Error> { auto&& value = _v._0; return double::from_str(rusty::to_string_view(value)).map_err(toml_test_harness::Error::new_).map(Value::Float); }, [&](const toml_test_harness::DecodedScalar_Bool& _v) -> rusty::Result<Value, toml_test_harness::Error> { auto&& value = _v._0; return bool::from_str(rusty::to_string_view(value)).map_err(toml_test_harness::Error::new_).map(Value::Boolean); }, [&](const toml_test_harness::DecodedScalar_Datetime& _v) -> rusty::Result<Value, toml_test_harness::Error> { auto&& value = _v._0; return value::Datetime::from_str(rusty::to_string_view(value)).map_err(toml_test_harness::Error::new_).map(Value::Datetime); }, [&](const toml_test_harness::DecodedScalar_DatetimeLocal& _v) -> rusty::Result<Value, toml_test_harness::Error> { auto&& value = _v._0; return value::Datetime::from_str(rusty::to_string_view(value)).map_err(toml_test_harness::Error::new_).map(Value::Datetime); }, [&](const toml_test_harness::DecodedScalar_DateLocal& _v) -> rusty::Result<Value, toml_test_harness::Error> { auto&& value = _v._0; return value::Datetime::from_str(rusty::to_string_view(value)).map_err(toml_test_harness::Error::new_).map(Value::Datetime); }, [&](const toml_test_harness::DecodedScalar_TimeLocal& _v) -> rusty::Result<Value, toml_test_harness::Error> { auto&& value = _v._0; return value::Datetime::from_str(rusty::to_string_view(value)).map_err(toml_test_harness::Error::new_).map(Value::Datetime); } }, _m); }();
    }
